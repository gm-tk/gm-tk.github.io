...
class BlockScoper {
    ...
    constructor(tagNormaliser) {
        ...
        /** Temporary tables adapter; replaced by BlockScoperTables when that module is extracted. */
        this._tables = {
            ordinalMap: this.ORDINAL_MAP,
            blockTypeKeywords: this._blockTypeKeywords,
            closerTypeMap: this._closerTypeMap,
            hardBoundaryTags: this._hardBoundaryTags,
            blockOpenPrefixStrip: this._blockOpenPrefixStrip
        };
