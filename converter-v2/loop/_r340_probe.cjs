/** _r340_probe.cjs — ROUND 340 in-memory A/B probe. Converts each module exactly as batch_convert.cjs
 ...
 *    LINKVID_OFF=1 STUB_OEMBED=1 node --require ./_deflate_raw_polyfill.cjs ../../outputs/_r340_probe.cjs CODES…   (expect: all identical)
 *    STUB_OEMBED=1 node --require ./_deflate_raw_polyfill.cjs ../../outputs/_r340_probe.cjs CODES…                     (the round's diffs)
