...
**Produced:** 2026-09-19 05:21 NZST by `reference/tests/_diff_miner.py` on the CURRENT corpus (pageforge-site HEAD 93b5897; Claude corpus 416 dirs). **Population:** the skeleton gate's own — 1956 paired pages / 405 modules (compare_exclusions.txt honoured; acks / glossary / references pages excluded); parse errors skipped: 0 (must be 0); modules without a parsed WT: 2. Run time 64.6 s.
...
- differing skeleton lines: 226602 — by direction {'MISSING': 119521, 'SUBSTITUTED': 20527, 'EXTRA': 78849, 'MOVED': 7705}
- by region: {'module-code': 15, 'title': 251, 'header': 5, 'module-menu': 11991, 'phases-nav': 43, 'crumbs': 179, 'footer': 2083, 'acks': 1176, 'activity': 83167, 'body': 126285, 'root': 1407}
- classes: 8071 — CANDIDATE 173, below floor 7656, the rest below consensus / not derivable
...
| 3482 | body | EXTRA | `div#body` | `—` | `div.row` | 1193 | 322 | 0.73 of 1950 | subject+ptype=1-10 Blended Literacy/overview c=1.00 n=29 | structure | — | CANDIDATE |
| 3483 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p` | 857 | 317 | 0.82 of 1950 | subject=1-10 Blended Literacy c=1.00 n=36 | structure | — | CANDIDATE |
| 3484 | body | MISSING | `div#body` | `div.row` | `—` | 1073 | 276 | 0.34 of 1950 | series=CEDO50 c=0.76 n=20 | 0.86 | — | CANDIDATE |
| 3485 | body | MISSING | `div.col-12.col-md-8` | `p` | `—` | 494 | 232 | 0.29 of 1950 | template+ptype=Fundamentals/overview c=0.93 n=31 | 0.82 | — | CANDIDATE |
| 3486 | body | EXTRA | `div.col-12.col-md-8` | `—` | `img.img-fluid` | 437 | 189 | 0.97 of 1950 | template+ptype=Standard/overview c=1.00 n=24 | structure | — | CANDIDATE |
| 3487 | body | EXTRA | `div.col-12.col-md-8` | `—` | `WIDGET` | 291 | 179 | 0.89 of 1950 | subject=NCEA1 c=0.96 n=24 | structure | — | CANDIDATE |
| 3488 | body | MOVED | `div.col-12.col-md-8` | `p` | `p` | 272 | 175 | 0.18 of 1950 | template+ptype=Fundamentals/overview c=0.87 n=33 | structure | — | CANDIDATE |
| 3489 | body | SUBSTITUTED | `div.row` | `div.col-12` | `div.col-12.col-md-8` | 291 | 164 | 0.55 of 1950 | subject+ptype=1-10 Blended Literacy/overview c=0.99 n=64 | structure | — | CANDIDATE |
| 3490 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p>b` | 260 | 158 | 0.95 of 1950 | subject=1-10 Blended Literacy c=1.00 n=37 | structure | — | CANDIDATE |
| 3491 | body | EXTRA | `div.row` | `—` | `div.col-12.col-md-8` | 225 | 153 | 0.86 of 1950 | subject=1-10 Blended Literacy c=0.96 n=31 | structure | — | CANDIDATE |
| 3492 | body | EXTRA | `div.col-12.col-md-8` | `—` | `h3` | 220 | 141 | 0.83 of 1950 | subject=1-10 Blended Literacy c=1.00 n=20 | structure | — | CANDIDATE |
| 3496 | body | EXTRA | `div.col-12.col-md-8` | `—` | `ul` | 237 | 130 | 0.96 of 1950 | subject=1-10 English c=0.99 n=25 | structure | — | CANDIDATE |
| 3500 | body | EXTRA | `div.col-12.col-md-8` | `—` | `a` | 183 | 108 | 0.98 of 1950 | subject=ConnectED c=1.00 n=32 | structure | — | CANDIDATE |
| 3501 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.ratio.ratio-16x9.videoSection` | 178 | 106 | 0.94 of 1950 | subject=1-10 English c=0.97 n=33 | structure | yes | CANDIDATE |
| 3504 | body | EXTRA | `p>b` | `—` | `b` | 158 | 98 | 0.94 of 1950 | subject=1-10 Mathematics c=0.97 n=32 | structure | — | CANDIDATE |
| 3506 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.table-responsive` | 153 | 91 | 0.98 of 1950 | subject+ptype=1-10 English/lesson c=0.99 n=22 | structure | — | CANDIDATE |
| 3508 | body | EXTRA | `a` | `—` | `div.button` | 147 | 84 | 0.97 of 1950 | subject+ptype=NCEA1/lesson c=0.98 n=20 | structure | — | CANDIDATE |
| 3510 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p>a` | 118 | 83 | 0.99 of 1950 | template=Standard c=0.99 n=95 | structure | — | CANDIDATE |
| 3512 | body | EXTRA | `p` | `—` | `b` | 100 | 80 | 0.93 of 1950 | subject=NCEA1 c=0.96 n=20 | structure | — | CANDIDATE |
| 3517 | body | EXTRA | `p>i` | `—` | `i` | 100 | 73 | 0.97 of 1950 | subject=1-10 Blended Literacy c=1.00 n=26 | structure | — | CANDIDATE |
| 3518 | body | EXTRA | `div.table-responsive` | `—` | `table.table.table-bordered` | 117 | 72 | 0.96 of 1950 | template=Standard c=0.97 n=103 | structure | yes | CANDIDATE |
| 3519 | body | SUBSTITUTED | `div.icon.ratio.ratio-16x9.videoSection` | `iframe.embed-responsive-item` | `iframe` | 178 | 68 | 0.21 of 1950 | series=PES10 c=0.68 n=35 | structure | yes | CANDIDATE |
| 3523 | body | EXTRA | `div.col-12.col-md-8` | `—` | `audio.audioPlayer.icon` | 108 | 62 | 0.99 of 1950 | subject+ptype=Leaving to Learn/lesson c=1.00 n=25 | structure | yes | CANDIDATE |
| 3524 | body | EXTRA | `div.row` | `—` | `div.col-12` | 105 | 62 | 0.84 of 1950 | ptype=lesson c=0.86 n=84 | structure | — | CANDIDATE |
| 3525 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p>i` | 86 | 62 | 0.98 of 1950 | subject=NCEA1 c=0.99 n=21 | structure | — | CANDIDATE |
| 3528 | body | EXTRA | `table.table.table-bordered` | `—` | `tr` | 85 | 61 | 0.98 of 1950 | template=Standard c=0.99 n=72 | structure | yes | CANDIDATE |
| 3529 | body | EXTRA | `div.col-12.col-md-8` | `—` | `ol` | 81 | 61 | 0.99 of 1950 | ptype=overview c=0.99 n=22 | structure | — | CANDIDATE |
| 3534 | body | EXTRA | `div.ratio.ratio-16x9.videoSection` | `—` | `iframe` | 76 | 58 | 0.93 of 1950 | subject=1-10 Mathematics c=0.95 n=27 | structure | yes | CANDIDATE |
| 3535 | body | MOVED | `div.col-12.col-md-8` | `h3` | `h3` | 69 | 57 | 0.10 of 1950 | template=Fundamentals c=0.67 n=20 | structure | — | CANDIDATE |
| 3537 | body | SUBSTITUTED | `div#body` | `div.row` | `WIDGET` | 72 | 56 | 0.94 of 1950 | subject=Online Safety (OS9000) c=1.00 n=25 | structure | — | CANDIDATE |
...
| 3545 | body | EXTRA | `p>a` | `—` | `a` | 64 | 50 | 0.99 of 1950 | template=Standard c=1.00 n=50 | structure | — | CANDIDATE |
| 3547 | body | EXTRA | `ul` | `—` | `li` | 61 | 50 | 0.94 of 1950 | template=Standard c=0.96 n=44 | structure | — | CANDIDATE |
| 3551 | body | EXTRA | `div.col-12.col-md-8` | `—` | `h4` | 53 | 46 | 0.96 of 1950 | template=Standard c=0.98 n=27 | structure | — | CANDIDATE |
| 3552 | body | EXTRA | `tr` | `—` | `td` | 52 | 46 | 0.95 of 1950 | template=Standard c=0.95 n=45 | structure | — | CANDIDATE |
| 3556 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `div.activity[number=*]` | 47 | 44 | 0.85 of 1950 | template+ptype=Standard/lesson c=0.85 n=41 | structure | yes | CANDIDATE |
| 3557 | body | EXTRA | `div.fundamentalsPanel` | `—` | `div.row` | 44 | 44 | 0.99 of 1950 | era=Refresh c=0.99 n=44 | structure | — | CANDIDATE |
| 3560 | body | EXTRA | `div.col-12` | `—` | `p` | 64 | 41 | 0.86 of 1950 | template=Standard c=0.88 n=58 | structure | — | CANDIDATE |
| 3561 | body | EXTRA | `div.alert` | `—` | `div.row` | 55 | 41 | 0.91 of 1950 | template=Standard c=0.92 n=40 | structure | — | CANDIDATE |
| 3565 | body | EXTRA | `a` | `—` | `div.externalButton` | 59 | 39 | 0.92 of 1950 | template=Standard c=0.93 n=53 | structure | — | CANDIDATE |
| 3566 | body | EXTRA | `div.row` | `—` | `div.col-12.col-md-6` | 56 | 39 | 0.99 of 1950 | subject=Online Safety (OS9000) c=1.00 n=20 | structure | — | CANDIDATE |
| 3568 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `p` | 52 | 38 | 0.85 of 1950 | template+ptype=Standard/lesson c=0.85 n=38 | structure | — | CANDIDATE |
| 3571 | body | EXTRA | `p` | `—` | `i` | 43 | 37 | 0.97 of 1950 | template=Standard c=0.97 n=39 | structure | — | CANDIDATE |
| 3576 | body | SUBSTITUTED | `div.row` | `div.col-12.col-md-8` | `WIDGET` | 37 | 36 | 0.98 of 1950 | ptype=lesson c=0.99 n=32 | structure | — | CANDIDATE |
| 3578 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.alert` | 49 | 35 | 0.91 of 1950 | template=Standard c=0.92 n=39 | structure | — | CANDIDATE |
| 3579 | body | EXTRA | `div#body` | `—` | `div.row.supervisor` | 45 | 34 | 0.88 of 1950 | ptype=lesson c=0.89 n=40 | structure | yes | CANDIDATE |
| 3586 | body | MISSING | `div#body` | `div.fundamentalsPanel` | `—` | 32 | 32 | 0.02 of 1950 | template+ptype=Fundamentals/overview c=0.87 n=31 | 1.00 | yes | CANDIDATE |
| 3587 | body | EXTRA | `div#body` | `—` | `WIDGET` | 48 | 31 | 0.94 of 1950 | era=Refresh c=0.94 n=48 | structure | — | CANDIDATE |
| 3590 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `WIDGET` | 31 | 30 | 0.85 of 1950 | template+ptype=Standard/lesson c=0.85 n=20 | structure | — | CANDIDATE |
| 3596 | body | EXTRA | `div#body` | `—` | `div.fundamentalsPanel` | 28 | 28 | 0.98 of 1950 | era=Refresh c=0.98 n=28 | structure | yes | CANDIDATE |
...
| 3613 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.flipCardsContainer.row` | 28 | 25 | 0.93 of 1950 | template=Standard c=0.94 n=24 | structure | — | CANDIDATE |
| 3616 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p>span.infoTrigger` | 28 | 24 | 0.97 of 1950 | template=Standard c=0.97 n=23 | structure | — | CANDIDATE |
| 3625 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `img.img-fluid` | 22 | 22 | 0.85 of 1950 | era=Refresh c=0.85 n=22 | structure | — | CANDIDATE |
| 3630 | body | EXTRA | `div.row` | `—` | `div.col-12.col-md-4` | 28 | 21 | 0.95 of 1950 | template=Standard c=0.95 n=24 | structure | — | CANDIDATE |
| 3632 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.clickDropContent` | 25 | 21 | 0.95 of 1950 | template=Standard c=0.95 n=22 | structure | — | CANDIDATE |
| 3635 | body | SUBSTITUTED | `div.row` | `div.col-12.col-md-8` | `div.col-12.col-md-6` | 24 | 21 | 0.98 of 1950 | ptype=lesson c=0.99 n=20 | structure | — | CANDIDATE |
| 3639 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `div.activity.interactive[number=*]` | 21 | 20 | 0.85 of 1950 | era=Refresh c=0.85 n=21 | structure | yes | CANDIDATE |
| 3640 | body | EXTRA | `div#body` | `—` | `div.inquiryPanel` | 20 | 20 | 0.98 of 1950 | era=Refresh c=0.98 n=20 | structure | — | CANDIDATE |
| 3643 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.alert.solid` | 24 | 19 | 0.99 of 1950 | era=Refresh c=0.99 n=24 | structure | yes | CANDIDATE |
| 3644 | body | EXTRA | `div.icon.ratio.ratio-16x9.videoSection` | `—` | `iframe` | 23 | 19 | 0.97 of 1950 | era=Refresh c=0.97 n=23 | structure | yes | CANDIDATE |
| 3645 | body | EXTRA | `div.col-12.col-md-8` | `—` | `h5` | 21 | 19 | 0.99 of 1950 | era=Refresh c=0.99 n=21 | structure | — | CANDIDATE |
| 3651 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `div.alert` | 26 | 18 | 0.85 of 1950 | era=Refresh c=0.85 n=26 | structure | — | CANDIDATE |
| 3655 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `div.activity` | 21 | 18 | 0.85 of 1950 | era=Refresh c=0.85 n=21 | structure | — | CANDIDATE |
| 3673 | body | SUBSTITUTED | `div#body` | `div.row` | `div.table-responsive` | 22 | 16 | 0.94 of 1950 | ptype=lesson c=0.98 n=20 | structure | — | CANDIDATE |
| 3694 | body | MISSING | `div#body` | `div.clickDropContent.noBorder.row` | `—` | 49 | 14 | 0.03 of 1950 | series=XDLS90 c=0.64 n=38 | 0.94 | yes | CANDIDATE |
| 8004 | root | EXTRA | `body.container-fluid` | `—` | `div.row` | 233 | 233 | 0.87 of 1956 | subject+ptype=NCEA1/overview c=0.98 n=41 | structure | — | CANDIDATE |
| 8009 | root | SUBSTITUTED | `#root` | `body` | `body.container-fluid` | 94 | 10 | 0.05 of 1956 | series=CEDO50 c=1.00 n=25 | structure | yes | CANDIDATE |
