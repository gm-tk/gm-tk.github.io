...
**Produced:** 2026-09-19 13:00 NZST by `reference/tests/_diff_miner.py` on the CURRENT corpus (pageforge-site HEAD 9a01a02; Claude corpus 416 dirs). **Population:** the skeleton gate's own — 1956 paired pages / 405 modules (compare_exclusions.txt honoured; acks / glossary / references pages excluded); parse errors skipped: 0 (must be 0); modules without a parsed WT: 2. Run time 68.6 s.
...
- differing skeleton lines: 225617 — by direction {'MISSING': 119114, 'SUBSTITUTED': 20389, 'EXTRA': 78431, 'MOVED': 7683}
- by region: {'module-code': 15, 'title': 251, 'header': 5, 'module-menu': 11990, 'phases-nav': 43, 'crumbs': 179, 'footer': 2075, 'acks': 1176, 'activity': 82944, 'body': 125532, 'root': 1407}
- classes: 8009 — CANDIDATE 169, below floor 7598, the rest below consensus / not derivable
...
| 523 | activity | MISSING | `div.col-12` | `p` | `—` | 626 | 291 | 0.31 of 1950 | subject+ptype=1-10 Blended Literacy/lesson c=0.78 n=99 | 0.80 | — | CANDIDATE |
| 524 | activity | EXTRA | `div.col-12` | `—` | `p` | 505 | 244 | 0.88 of 1950 | series=XDLS90 c=1.00 n=22 | structure | — | CANDIDATE |
| 526 | activity | MISSING | `div.col-12` | `a` | `—` | 397 | 199 | 0.29 of 1950 | series=HIS10 c=0.71 n=40 | 0.64 | — | CANDIDATE |
| 527 | activity | MISSING | `a` | `div.button` | `—` | 513 | 191 | 0.23 of 1950 | series=HIS10 c=0.71 n=35 | 0.63 | yes | CANDIDATE |
| 528 | activity | EXTRA | `div.col-12` | `—` | `WIDGET` | 278 | 163 | 0.82 of 1950 | subject=NCEA1 c=0.97 n=29 | structure | — | CANDIDATE |
| 529 | activity | MISSING | `div.col-12` | `h3` | `—` | 314 | 156 | 0.32 of 1950 | template=Fundamentals c=0.81 n=20 | 0.66 | — | CANDIDATE |
| 530 | activity | MOVED | `div.col-12` | `p` | `p` | 255 | 152 | 0.19 of 1950 | template+ptype=Fundamentals/overview c=0.62 n=22 | structure | — | CANDIDATE |
| 531 | activity | SUBSTITUTED | `div.col-12.col-md-8` | `div.activity.interactive[number=*]` | `div.activity[number=*]` | 224 | 152 | 0.42 of 1950 | subject+ptype=1-10 Blended Literacy/lesson c=0.72 n=53 | structure | yes | CANDIDATE |
| 533 | activity | EXTRA | `div.col-12` | `—` | `img.img-fluid` | 208 | 126 | 0.97 of 1950 | subject=1-10 English c=0.99 n=22 | structure | — | CANDIDATE |
| 534 | activity | EXTRA | `div.row` | `—` | `div.col-12` | 163 | 115 | 0.89 of 1950 | series=XDLS90 c=0.97 n=22 | structure | — | CANDIDATE |
...
| 538 | activity | EXTRA | `div.col-12` | `—` | `p>a` | 119 | 95 | 1.00 of 1950 | subject+ptype=1-10 Blended Literacy/lesson c=1.00 n=33 | structure | — | CANDIDATE |
| 539 | activity | EXTRA | `div.activity[number=*]` | `—` | `div.row` | 133 | 92 | 0.94 of 1950 | template=Standard c=0.96 n=110 | structure | yes | CANDIDATE |
| 540 | activity | EXTRA | `div.activity.interactive[number=*]` | `—` | `div.row` | 116 | 90 | 0.80 of 1950 | subject=NCEA1 c=0.93 n=23 | structure | yes | CANDIDATE |
| 546 | activity | EXTRA | `div.col-12` | `—` | `p>b` | 113 | 75 | 0.97 of 1950 | template=Standard c=0.98 n=85 | structure | — | CANDIDATE |
| 547 | activity | SUBSTITUTED | `div.col-12.col-md-8` | `div.activity[number=*]` | `div.activity[number=*]` | 109 | 75 | 0.48 of 1950 | subject+ptype=1-10 Mathematics/lesson c=0.68 n=24 | structure | yes | CANDIDATE |
...
| 549 | activity | EXTRA | `div.col-12` | `—` | `h3` | 97 | 74 | 0.86 of 1950 | template=Standard c=0.91 n=60 | structure | — | CANDIDATE |
| 550 | activity | EXTRA | `div.col-12` | `—` | `ol` | 118 | 73 | 0.96 of 1950 | subject=1-10 Mathematics c=0.98 n=31 | structure | — | CANDIDATE |
| 553 | activity | EXTRA | `div.col-12` | `—` | `ul` | 94 | 71 | 0.94 of 1950 | template=Standard c=0.96 n=79 | structure | — | CANDIDATE |
| 557 | activity | EXTRA | `p>b` | `—` | `b` | 87 | 65 | 0.93 of 1950 | template=Standard c=0.94 n=57 | structure | — | CANDIDATE |
...
| 561 | activity | EXTRA | `p>a` | `—` | `a` | 67 | 58 | 1.00 of 1950 | subject+ptype=1-10 Blended Literacy/lesson c=1.00 n=27 | structure | — | CANDIDATE |
| 562 | activity | EXTRA | `div.col-12` | `—` | `a` | 95 | 57 | 0.86 of 1950 | template=Standard c=0.87 n=85 | structure | — | CANDIDATE |
| 563 | activity | SUBSTITUTED | `div.col-12` | `WIDGET` | `p` | 72 | 57 | 0.60 of 1950 | subject+ptype=1-10 Mathematics/lesson c=0.78 n=32 | structure | — | CANDIDATE |
| 566 | activity | SUBSTITUTED | `div.col-12.col-md-8` | `div.activity.interactive[number=*]` | `div.activity.interactive[number=*]` | 71 | 54 | 0.42 of 1950 | subject+ptype=1-10 Mathematics/lesson c=0.65 n=21 | structure | yes | CANDIDATE |
| 567 | activity | EXTRA | `div.col-12` | `—` | `h4.goJournal` | 123 | 53 | 0.95 of 1950 | series=HIS10 c=1.00 n=33 | structure | — | CANDIDATE |
| 571 | activity | SUBSTITUTED | `div.col-12` | `a` | `h4.goJournal` | 115 | 51 | 0.57 of 1950 | series=HIS10 c=0.83 n=20 | structure | — | CANDIDATE |
| 572 | activity | SUBSTITUTED | `div.col-12.col-md-8` | `div.activity[number=*]` | `h3` | 75 | 51 | 0.48 of 1950 | subject+ptype=NCEA1/lesson c=0.63 n=35 | structure | yes | CANDIDATE |
| 573 | activity | EXTRA | `div.col-12.col-md-8` | `—` | `div.activity[number=*]` | 60 | 51 | 0.95 of 1950 | template=Standard c=0.98 n=48 | structure | yes | CANDIDATE |
| 574 | activity | EXTRA | `ol` | `—` | `li` | 66 | 50 | 0.95 of 1950 | template=Standard c=0.96 n=51 | structure | — | CANDIDATE |
| 575 | activity | SUBSTITUTED | `div.col-12` | `p` | `WIDGET` | 58 | 49 | 0.76 of 1950 | template+ptype=Standard/lesson c=0.89 n=42 | structure | — | CANDIDATE |
| 577 | activity | SUBSTITUTED | `div.col-12` | `WIDGET` | `div.row` | 50 | 47 | 0.60 of 1950 | ptype=lesson c=0.70 n=41 | structure | — | CANDIDATE |
| 580 | activity | EXTRA | `div.col-12` | `—` | `p>i` | 50 | 44 | 0.97 of 1950 | template=Standard c=0.98 n=43 | structure | — | CANDIDATE |
| 582 | activity | SUBSTITUTED | `div.col-12` | `a` | `p` | 55 | 41 | 0.57 of 1950 | template+ptype=Standard/lesson c=0.68 n=53 | structure | — | CANDIDATE |
...
| 605 | activity | EXTRA | `div.col-12` | `—` | `div.activity.interactive[number=*]` | 33 | 30 | 0.89 of 1950 | era=Refresh c=0.89 n=33 | structure | yes | CANDIDATE |
...
| 613 | activity | SUBSTITUTED | `div.col-12` | `a` | `WIDGET` | 32 | 27 | 0.57 of 1950 | template+ptype=Standard/lesson c=0.68 n=29 | structure | — | CANDIDATE |
| 615 | activity | EXTRA | `ul` | `—` | `li` | 28 | 27 | 0.93 of 1950 | template=Standard c=0.95 n=24 | structure | — | CANDIDATE |
...
| 643 | activity | SUBSTITUTED | `div.row` | `div.col-12` | `div.row` | 21 | 20 | 0.79 of 1950 | era=Refresh c=0.79 n=21 | structure | — | CANDIDATE |
| 645 | activity | EXTRA | `a` | `—` | `div.externalButton` | 27 | 19 | 0.96 of 1950 | template=Standard c=0.97 n=20 | structure | — | CANDIDATE |
...
| 661 | activity | EXTRA | `div.col-12` | `—` | `div.TKmodal` | 20 | 17 | 0.99 of 1950 | era=Refresh c=0.99 n=20 | structure | — | CANDIDATE |
| 694 | activity | SUBSTITUTED | `div.col-12` | `p` | `h4.goJournal` | 22 | 13 | 0.76 of 1950 | template+ptype=Standard/lesson c=0.89 n=21 | structure | — | CANDIDATE |
| 3465 | body | EXTRA | `div#body` | `—` | `div.row` | 1188 | 322 | 0.73 of 1950 | subject+ptype=1-10 Blended Literacy/overview c=1.00 n=29 | structure | — | CANDIDATE |
| 3466 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p` | 856 | 316 | 0.82 of 1950 | subject=1-10 Blended Literacy c=1.00 n=36 | structure | — | CANDIDATE |
| 3467 | body | MISSING | `div#body` | `div.row` | `—` | 1070 | 276 | 0.34 of 1950 | series=CEDO50 c=0.76 n=20 | 0.86 | — | CANDIDATE |
| 3468 | body | MISSING | `div.col-12.col-md-8` | `p` | `—` | 500 | 232 | 0.25 of 1950 | template+ptype=Fundamentals/overview c=0.89 n=31 | 0.82 | — | CANDIDATE |
| 3469 | body | EXTRA | `div.col-12.col-md-8` | `—` | `img.img-fluid` | 436 | 189 | 0.97 of 1950 | template+ptype=Standard/overview c=1.00 n=24 | structure | — | CANDIDATE |
| 3470 | body | EXTRA | `div.col-12.col-md-8` | `—` | `WIDGET` | 289 | 177 | 0.89 of 1950 | subject=NCEA1 c=0.96 n=23 | structure | — | CANDIDATE |
| 3471 | body | MOVED | `div.col-12.col-md-8` | `p` | `p` | 267 | 174 | 0.18 of 1950 | template+ptype=Fundamentals/overview c=0.87 n=33 | structure | — | CANDIDATE |
| 3472 | body | SUBSTITUTED | `div.row` | `div.col-12` | `div.col-12.col-md-8` | 291 | 165 | 0.55 of 1950 | subject+ptype=1-10 Blended Literacy/overview c=0.99 n=64 | structure | — | CANDIDATE |
| 3473 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p>b` | 259 | 158 | 0.95 of 1950 | subject=1-10 Blended Literacy c=1.00 n=37 | structure | — | CANDIDATE |
| 3474 | body | EXTRA | `div.row` | `—` | `div.col-12.col-md-8` | 228 | 154 | 0.86 of 1950 | subject=1-10 Blended Literacy c=0.96 n=31 | structure | — | CANDIDATE |
| 3475 | body | EXTRA | `div.col-12.col-md-8` | `—` | `h3` | 223 | 143 | 0.83 of 1950 | subject=1-10 Blended Literacy c=1.00 n=20 | structure | — | CANDIDATE |
| 3478 | body | EXTRA | `div.col-12.col-md-8` | `—` | `ul` | 239 | 131 | 0.96 of 1950 | subject=1-10 English c=0.99 n=26 | structure | — | CANDIDATE |
| 3483 | body | EXTRA | `div.col-12.col-md-8` | `—` | `a` | 180 | 109 | 0.93 of 1950 | subject=1-10 English c=0.95 n=22 | structure | — | CANDIDATE |
| 3485 | body | EXTRA | `p>b` | `—` | `b` | 158 | 98 | 0.94 of 1950 | subject=1-10 Mathematics c=0.97 n=32 | structure | — | CANDIDATE |
| 3487 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.table-responsive` | 142 | 93 | 0.92 of 1950 | template=Standard c=0.92 n=125 | structure | — | CANDIDATE |
| 3490 | body | EXTRA | `a` | `—` | `div.button` | 151 | 84 | 0.97 of 1950 | subject+ptype=NCEA1/lesson c=0.98 n=20 | structure | — | CANDIDATE |
| 3491 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p>a` | 118 | 84 | 0.99 of 1950 | template=Standard c=0.99 n=96 | structure | — | CANDIDATE |
| 3492 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.ratio.ratio-16x9.videoSection` | 134 | 83 | 0.94 of 1950 | ptype=overview c=0.96 n=23 | structure | yes | CANDIDATE |
| 3495 | body | EXTRA | `p` | `—` | `b` | 101 | 80 | 0.93 of 1950 | subject=NCEA1 c=0.96 n=20 | structure | — | CANDIDATE |
| 3500 | body | EXTRA | `p>i` | `—` | `i` | 102 | 74 | 0.97 of 1950 | subject=1-10 Blended Literacy c=1.00 n=26 | structure | — | CANDIDATE |
| 3501 | body | EXTRA | `div.table-responsive` | `—` | `table.table.table-bordered` | 117 | 73 | 0.96 of 1950 | template=Standard c=0.97 n=103 | structure | yes | CANDIDATE |
| 3502 | body | SUBSTITUTED | `div.icon.ratio.ratio-16x9.videoSection` | `iframe.embed-responsive-item` | `iframe` | 201 | 71 | 0.21 of 1950 | series=PES10 c=0.68 n=35 | structure | yes | CANDIDATE |
| 3506 | body | EXTRA | `div.row` | `—` | `div.col-12` | 107 | 63 | 0.84 of 1950 | ptype=lesson c=0.86 n=86 | structure | — | CANDIDATE |
| 3507 | body | EXTRA | `div.col-12.col-md-8` | `—` | `audio.audioPlayer.icon` | 108 | 62 | 0.99 of 1950 | subject+ptype=Leaving to Learn/lesson c=1.00 n=25 | structure | yes | CANDIDATE |
| 3508 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p>i` | 86 | 62 | 0.98 of 1950 | subject=NCEA1 c=0.99 n=21 | structure | — | CANDIDATE |
| 3509 | body | EXTRA | `table.table.table-bordered` | `—` | `tr` | 86 | 61 | 0.98 of 1950 | template=Standard c=0.99 n=73 | structure | yes | CANDIDATE |
| 3510 | body | EXTRA | `div.col-12.col-md-8` | `—` | `ol` | 81 | 61 | 0.99 of 1950 | ptype=overview c=0.99 n=22 | structure | — | CANDIDATE |
| 3517 | body | SUBSTITUTED | `div#body` | `div.row` | `WIDGET` | 69 | 55 | 0.94 of 1950 | subject=Online Safety (OS9000) c=1.00 n=25 | structure | — | CANDIDATE |
| 3523 | body | MOVED | `div.col-12.col-md-8` | `h3` | `h3` | 65 | 54 | 0.10 of 1950 | template=Fundamentals c=0.67 n=20 | structure | — | CANDIDATE |
| 3524 | body | SUBSTITUTED | `div.row` | `div.col-12.col-md-8` | `div.col-12.col-md-8` | 60 | 52 | 0.98 of 1950 | ptype=lesson c=0.99 n=34 | structure | — | CANDIDATE |
| 3527 | body | EXTRA | `ul` | `—` | `li` | 61 | 50 | 0.93 of 1950 | template=Standard c=0.94 n=44 | structure | — | CANDIDATE |
| 3529 | body | EXTRA | `p>a` | `—` | `a` | 61 | 49 | 0.99 of 1950 | template=Standard c=1.00 n=48 | structure | — | CANDIDATE |
| 3530 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `div.activity[number=*]` | 55 | 49 | 0.85 of 1950 | template+ptype=Standard/lesson c=0.85 n=48 | structure | yes | CANDIDATE |
| 3531 | body | EXTRA | `div.col-12.col-md-8` | `—` | `h4` | 56 | 48 | 0.94 of 1950 | template=Standard c=0.95 n=30 | structure | — | CANDIDATE |
| 3533 | body | EXTRA | `tr` | `—` | `td` | 52 | 46 | 0.95 of 1950 | template=Standard c=0.95 n=45 | structure | — | CANDIDATE |
| 3534 | body | EXTRA | `div.col-12` | `—` | `p` | 79 | 45 | 0.92 of 1950 | template=Standard c=0.94 n=70 | structure | — | CANDIDATE |
| 3539 | body | EXTRA | `div.fundamentalsPanel` | `—` | `div.row` | 44 | 44 | 0.99 of 1950 | era=Refresh c=0.99 n=44 | structure | — | CANDIDATE |
| 3541 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.icon.ratio.ratio-16x9.videoSection` | 60 | 42 | 0.91 of 1950 | template=Standard c=0.93 n=52 | structure | yes | CANDIDATE |
| 3542 | body | EXTRA | `div.alert` | `—` | `div.row` | 55 | 42 | 0.91 of 1950 | template=Standard c=0.92 n=40 | structure | — | CANDIDATE |
| 3545 | body | EXTRA | `div.ratio.ratio-16x9.videoSection` | `—` | `iframe` | 52 | 40 | 0.78 of 1950 | ptype=lesson c=0.81 n=39 | structure | yes | CANDIDATE |
| 3548 | body | EXTRA | `a` | `—` | `div.externalButton` | 59 | 39 | 0.92 of 1950 | template=Standard c=0.93 n=53 | structure | — | CANDIDATE |
| 3549 | body | EXTRA | `div.row` | `—` | `div.col-12.col-md-6` | 57 | 39 | 0.99 of 1950 | subject=Online Safety (OS9000) c=1.00 n=20 | structure | — | CANDIDATE |
| 3550 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `p` | 53 | 39 | 0.85 of 1950 | template+ptype=Standard/lesson c=0.85 n=39 | structure | — | CANDIDATE |
| 3553 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.alert` | 51 | 37 | 0.91 of 1950 | template=Standard c=0.92 n=41 | structure | — | CANDIDATE |
| 3555 | body | EXTRA | `p` | `—` | `i` | 43 | 37 | 0.97 of 1950 | template=Standard c=0.97 n=39 | structure | — | CANDIDATE |
| 3562 | body | SUBSTITUTED | `div.row` | `div.col-12.col-md-8` | `WIDGET` | 36 | 35 | 0.98 of 1950 | ptype=lesson c=0.99 n=31 | structure | — | CANDIDATE |
| 3568 | body | EXTRA | `div#body` | `—` | `div.row.supervisor` | 43 | 33 | 0.88 of 1950 | ptype=lesson c=0.89 n=38 | structure | yes | CANDIDATE |
| 3571 | body | EXTRA | `tr` | `—` | `th` | 35 | 32 | 0.99 of 1950 | template=Standard c=1.00 n=29 | structure | — | CANDIDATE |
| 3572 | body | MISSING | `div#body` | `div.fundamentalsPanel` | `—` | 32 | 32 | 0.02 of 1950 | template+ptype=Fundamentals/overview c=0.87 n=31 | 1.00 | yes | CANDIDATE |
| 3573 | body | EXTRA | `div#body` | `—` | `WIDGET` | 47 | 31 | 0.94 of 1950 | era=Refresh c=0.94 n=47 | structure | — | CANDIDATE |
| 3577 | body | EXTRA | `div.icon.ratio.ratio-16x9.videoSection` | `—` | `iframe` | 36 | 29 | 0.97 of 1950 | ptype=lesson c=0.98 n=30 | structure | yes | CANDIDATE |
| 3579 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `WIDGET` | 30 | 29 | 0.85 of 1950 | template=Standard c=0.85 n=20 | structure | — | CANDIDATE |
| 3582 | body | EXTRA | `div.row` | `—` | `div.col-12.col-md-4.offset-md-0` | 28 | 28 | 0.79 of 1950 | era=Refresh c=0.79 n=28 | structure | — | CANDIDATE |
| 3583 | body | EXTRA | `div#body` | `—` | `div.fundamentalsPanel` | 28 | 28 | 0.98 of 1950 | era=Refresh c=0.98 n=28 | structure | yes | CANDIDATE |
| 3584 | body | EXTRA | `div.col-12.col-md-8` | `—` | `h4.goJournal` | 34 | 27 | 1.00 of 1950 | era=Refresh c=1.00 n=34 | structure | — | CANDIDATE |
| 3585 | body | EXTRA | `div.inquiryPanel` | `—` | `div.row` | 28 | 27 | 0.99 of 1950 | era=Refresh c=0.99 n=28 | structure | — | CANDIDATE |
| 3591 | body | SUBSTITUTED | `div.row` | `div.col-12.col-md-8` | `div.row` | 27 | 26 | 0.98 of 1950 | era=Refresh c=0.98 n=27 | structure | — | CANDIDATE |
| 3592 | body | EXTRA | `div.alert.solid` | `—` | `div.row` | 35 | 25 | 0.99 of 1950 | template=Standard c=0.99 n=30 | structure | yes | CANDIDATE |
| 3595 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p>span.infoTrigger` | 28 | 25 | 0.97 of 1950 | template=Standard c=0.97 n=23 | structure | — | CANDIDATE |
| 3596 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.flipCardsContainer.row` | 28 | 25 | 0.93 of 1950 | template=Standard c=0.94 n=24 | structure | — | CANDIDATE |
| 3606 | body | EXTRA | `div.row` | `—` | `div.col-12.col-md-4` | 29 | 22 | 0.95 of 1950 | template=Standard c=0.95 n=24 | structure | — | CANDIDATE |
| 3610 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `img.img-fluid` | 22 | 22 | 0.85 of 1950 | era=Refresh c=0.85 n=22 | structure | — | CANDIDATE |
| 3615 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.clickDropContent` | 25 | 21 | 0.95 of 1950 | template=Standard c=0.95 n=22 | structure | — | CANDIDATE |
| 3616 | body | SUBSTITUTED | `div.row` | `div.col-12.col-md-8` | `div.col-12.col-md-6` | 24 | 21 | 0.98 of 1950 | ptype=lesson c=0.99 n=20 | structure | — | CANDIDATE |
| 3622 | body | EXTRA | `div#body` | `—` | `div.inquiryPanel` | 20 | 20 | 0.98 of 1950 | era=Refresh c=0.98 n=20 | structure | — | CANDIDATE |
| 3626 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.alert.solid` | 24 | 19 | 0.99 of 1950 | era=Refresh c=0.99 n=24 | structure | yes | CANDIDATE |
| 3629 | body | EXTRA | `div.col-12.col-md-8` | `—` | `h5` | 20 | 19 | 1.00 of 1950 | era=Refresh c=1.00 n=20 | structure | — | CANDIDATE |
| 3630 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `div.activity.interactive[number=*]` | 20 | 19 | 0.85 of 1950 | era=Refresh c=0.85 n=20 | structure | yes | CANDIDATE |
| 3635 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `div.alert` | 25 | 18 | 0.85 of 1950 | era=Refresh c=0.85 n=25 | structure | — | CANDIDATE |
| 3654 | body | SUBSTITUTED | `div#body` | `div.row` | `div.table-responsive` | 22 | 16 | 0.94 of 1950 | ptype=lesson c=0.98 n=20 | structure | — | CANDIDATE |
| 3675 | body | MISSING | `div#body` | `div.clickDropContent.noBorder.row` | `—` | 49 | 14 | 0.03 of 1950 | series=XDLS90 c=0.64 n=38 | 0.94 | yes | CANDIDATE |
| 3691 | body | EXTRA | `div.col-12.col-md-6` | `—` | `p` | 20 | 13 | 1.00 of 1950 | era=Refresh c=1.00 n=20 | structure | — | CANDIDATE |
| 7942 | root | EXTRA | `body.container-fluid` | `—` | `div.row` | 233 | 233 | 0.87 of 1956 | subject+ptype=NCEA1/overview c=0.98 n=41 | structure | — | CANDIDATE |
| 7947 | root | SUBSTITUTED | `#root` | `body` | `body.container-fluid` | 94 | 10 | 0.05 of 1956 | series=CEDO50 c=1.00 n=25 | structure | yes | CANDIDATE |
