...
is pre-intake. Current (each cell carries the round that last changed it — r470, 24 September 2026; the history since the 22 Sept Round 0d: the 12 XOTP modules and the 38 pre-intake never-converted modules are IN; r426 folded 45 over-split pages into 8 single pages; r427 changed chip text only; r440 (D13-6) built MXFUN01 / BLL240 / CEDT207 as one page each and re-paired the five dual-build golds — 2,699 → 2,666 pages, 2,491 → 2,470 pairs; r442 paired six more lesson pages → 2,476):
