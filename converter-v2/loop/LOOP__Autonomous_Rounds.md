...
| Claude pages | 2,109 | **2,676** (r453, 24 Sept: +10 — the TRR table-cell title bar keeps the overview and TRR116's lessons 1–4) |
| gold dirs | 454 | **552** |
| Writers Template / Media List docx | 619 | **762** |
| skeleton paired pages | 1,956 | **2,487** (r453, 24 Sept: +10 — the restored TRR pages; r447: +1 — PWY1002_2_2_0 pairs by content once its journal heading is the gold's own) |
