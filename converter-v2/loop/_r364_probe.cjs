/** _r364_probe.cjs — ROUND 364 in-memory A/B probe (the r362 probe, unchanged mechanics; toggle IDHEAD_OFF). Converts each module exactly as batch_convert.cjs
 ...
 *    IDHEAD_OFF=1 STUB_OEMBED=1 node --require ./_deflate_raw_polyfill.cjs ../../outputs/_r364_probe.cjs CODES…   (expect: all identical)
 *    STUB_OEMBED=1 node --require ./_deflate_raw_polyfill.cjs ../../outputs/_r364_probe.cjs CODES…                     (the round's diffs)
