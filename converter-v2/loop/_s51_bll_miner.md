...
**Produced:** 2026-09-26 13:06 NZST by `reference/tests/_diff_miner.py` on the CURRENT corpus (pageforge-site HEAD 6ad6098; Claude corpus 545 dirs). **Population:** the skeleton gate's own — 298 paired pages / 109 modules (compare_exclusions.txt honoured; acks / glossary / references pages excluded); parse errors skipped: 0 (must be 0); modules without a parsed WT: 0. Run time 13.6 s.
...
- differing skeleton lines: 29299 — by direction {'SUBSTITUTED': 3938, 'MISSING': 16950, 'EXTRA': 7635, 'MOVED': 776}
- by region: {'module-code': 2, 'title': 14, 'header': 2, 'module-menu': 764, 'footer': 408, 'acks': 305, 'activity': 21173, 'body': 6369, 'root': 262}
- classes: 1806 — CANDIDATE 37, below floor 1734, the rest below consensus / not derivable
...
| F11 | EXTRA | `header:chip=lesson-number(00)` | 1 | 1 | 0.00 | 1.00 | — | BELOW FLOOR |
| F12 | MISSING | `header:chip` | 1 | 1 | 0.98 | 0.98 | — | BELOW FLOOR |
...
| F27 | MISSING | `footer:link=other` | 1 | 1 | 0.00 | 0.00 | — | BELOW FLOOR |
| F28 | MISSING | `footer:links=other,home-nav` | 1 | 1 | 0.00 | 0.00 | — | BELOW FLOOR |
...
| 9 | module-menu | MISSING | `ul` | `li` | `—` | 21 | 21 | 0.21 of 298 | — | 0.94 | — | BELOW CONSENSUS (no group ≥ 0.60 at the floor) |
...
| 16 | module-menu | MISSING | `div.col-12.col-md-6.paddingR` | `h5>span` | `—` | 10 | 10 | 0.21 of 298 | — | 1.00 | yes | BELOW CONSENSUS (no group ≥ 0.60 at the floor) |
| 17 | module-menu | MISSING | `h5>span` | `span` | `—` | 10 | 10 | 0.26 of 298 | ptype=overview c=0.70 n=10 | 1.00 | — | CANDIDATE |
...
| 22 | module-menu | EXTRA | `div.col-12.col-md-6.paddingR` | `—` | `h5>span` | 5 | 5 | 0.79 of 298 | — | structure | yes | BELOW FLOOR |
| 23 | module-menu | EXTRA | `div.col-12.col-md-6.paddingR` | `—` | `h5` | 5 | 5 | 1.00 of 298 | — | structure | yes | BELOW FLOOR |
| 24 | module-menu | MISSING | `p` | `br` | `—` | 5 | 5 | 0.03 of 298 | — | structure | — | BELOW FLOOR |
| 25 | module-menu | MISSING | `div.row` | `div.col-12.col-md-6.paddingR` | `—` | 5 | 5 | 0.27 of 298 | — | 1.00 | yes | BELOW FLOOR |
...
| 32 | module-menu | MISSING | `div.col-12.col-md-6` | `h4>span` | `—` | 4 | 4 | 0.02 of 298 | — | 1.00 | yes | BELOW FLOOR |
| 33 | module-menu | MISSING | `li` | `ul` | `—` | 4 | 4 | 0.03 of 298 | — | 1.00 | — | BELOW FLOOR |
...
| 40 | module-menu | SUBSTITUTED | `div.col-12.col-md-6.paddingR` | `ul` | `p` | 3 | 3 | 0.27 of 298 | — | structure | yes | BELOW FLOOR |
| 41 | module-menu | SUBSTITUTED | `ul` | `p` | `li` | 3 | 3 | 0.01 of 298 | — | structure | — | BELOW FLOOR |
...
| 58 | module-menu | SUBSTITUTED | `div.col-12.col-md-6.paddingR` | `p` | `h5>span` | 1 | 1 | 0.27 of 298 | — | structure | yes | BELOW FLOOR |
| 59 | module-menu | SUBSTITUTED | `p` | `br` | `b` | 1 | 1 | 0.03 of 298 | — | structure | — | BELOW FLOOR |
| 60 | module-menu | SUBSTITUTED | `div.row` | `div.col-12.col-md-6` | `div.col-12.col-md-12.paddingR` | 1 | 1 | 0.03 of 298 | — | structure | yes | BELOW FLOOR |
| 61 | module-menu | SUBSTITUTED | `ul` | `p` | `li>b` | 1 | 1 | 0.01 of 298 | — | structure | — | BELOW FLOOR |
...
| 78 | footer | MISSING | `ul.footer-nav.inquiry-nav` | `li>a#next-lesson` | `—` | 3 | 3 | 0.64 of 298 | — | structure | yes | BELOW FLOOR |
| 79 | footer | MISSING | `div.row` | `div#footer` | `—` | 3 | 3 | 0.01 of 298 | — | structure | yes | BELOW FLOOR |
| 80 | footer | MISSING | `li>a.home-nav` | `a.home-nav` | `—` | 3 | 3 | 1.00 of 298 | — | structure | yes | BELOW FLOOR |
| 81 | footer | MISSING | `ul.footer-nav.inquiry-nav` | `li>a#prev-lesson` | `—` | 3 | 3 | 0.59 of 298 | — | structure | yes | BELOW FLOOR |
...
| 83 | footer | EXTRA | `li>a#next-lesson` | `—` | `a#next-lesson` | 2 | 2 | 0.26 of 298 | — | structure | yes | BELOW FLOOR |
| 84 | footer | EXTRA | `ul.footer-nav.inquiry-nav` | `—` | `li>a#prev-lesson` | 2 | 2 | 0.41 of 298 | — | structure | yes | BELOW FLOOR |
...
| 99 | acks | SUBSTITUTED | `div.col-12.col-md-8` | `div.acks` | `p` | 1 | 1 | 0.31 of 298 | — | structure | yes | BELOW FLOOR |
| 100 | acks | SUBSTITUTED | `div.acks` | `WIDGET` | `div#footer` | 1 | 1 | 0.31 of 298 | — | structure | yes | BELOW FLOOR |
| 103 | activity | EXTRA | `div.col-12` | `—` | `p` | 101 | 76 | 0.83 of 298 | template=Standard c=0.87 n=89 | structure | — | CANDIDATE |
...
| 130 | activity | SUBSTITUTED | `div.col-12` | `p` | `p` | 22 | 20 | 0.65 of 298 | era=Refresh c=0.65 n=22 | structure | — | CANDIDATE |
...
| 1373 | body | EXTRA | `div#body` | `—` | `div.row` | 138 | 82 | 0.87 of 298 | ptype=overview c=1.00 n=31 | structure | — | CANDIDATE |
| 1374 | body | SUBSTITUTED | `div.row` | `div.col-12` | `div.col-12.col-md-8` | 107 | 78 | 0.55 of 298 | template+ptype=Standard/overview c=1.00 n=66 | structure | — | CANDIDATE |
| 1376 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p` | 50 | 47 | 0.97 of 298 | ptype=lesson c=1.00 n=20 | structure | — | CANDIDATE |
| 1379 | body | EXTRA | `div.row` | `—` | `div.col-12.col-md-8` | 35 | 34 | 0.95 of 298 | template=Standard c=0.99 n=24 | structure | — | CANDIDATE |
| 1380 | body | EXTRA | `div.col-12.col-md-8` | `—` | `audio.audioPlayer.icon` | 27 | 27 | 1.00 of 298 | era=Refresh c=1.00 n=27 | structure | yes | CANDIDATE |
| 1381 | body | EXTRA | `p>i` | `—` | `i` | 26 | 26 | 0.98 of 298 | era=Refresh c=0.98 n=26 | structure | — | CANDIDATE |
| 1382 | body | EXTRA | `div.col-12.col-md-8` | `—` | `h3` | 25 | 25 | 1.00 of 298 | template=Standard c=1.00 n=25 | structure | — | CANDIDATE |
...
| 1798 | root | EXTRA | `body.container-fluid` | `—` | `div.row` | 68 | 68 | 0.74 of 298 | ptype=overview c=0.75 n=68 | structure | — | CANDIDATE |

## Details — in the companion file `CONVERTER_V2/outputs/_s51_bll_miner_details.md`
...
- **BLL122** BLL122_0_0.html ↔ BLL122-01.html (structure, derivable=True)
  - gold: `—`
...
### #17 · module-menu · MISSING · `h5>span` › gold `span` vs Claude `—` — CANDIDATE
...
- **BLL241** BLL241_0_0.html ↔ BLL241-0.0.html (content, derivable=True)
  ...
  - Claude: `—`
  - WT: `🔴[RED TEXT] [H2] [/RED TEXT]🔴 **Practices:**`
- **BLL242** BLL242_0_0.html ↔ BLL242_0.0.html (content, derivable=True)
  - gold: `span  «Practices:»`
  - Claude: `—`
  - WT: `🔴[RED TEXT] [H2] [/RED TEXT]🔴 **Practices:**`
...
- pages 101 / modules 76 / lines 370; consensus (all) 0.83 of 298 gold pages with the region; derivable structure-only (0 lines with no WT source)
- by template: Standard 64m/89p c=0.87; Inquiry 12m/12p c=0.00
- by subject: 1-10 Blended Literacy 76m/101p c=0.83
- by era: Refresh 76m/101p c=0.83
- authority (§1b): 3 — the module's own gold (group consensus ≥ 0.60)
- **BLL110** BLL110_0_0.html ↔ BLL110.html (structure, derivable=True)
  - gold: `—`
...
- **BLL111** BLL111_2_0.html ↔ BLL111-03.html (structure, derivable=True)
  - gold: `—`
  - Claude: `p  «After you have read the story, discuss these questions with your supervisor. You may want to go back and look at the pag»`
- **BLL113** BLL113_1_0.html ↔ BLL113-02.html (structure, derivable=True)
  - gold: `—`
  - Claude: `p  «Heart word - on»`
...
- pages 70 / modules 59 / lines 107; consensus (all) 0.51 of 298 gold pages with the region; derivable structure-only (0 lines with no WT source)
...
- **BLL111** BLL111_1_0.html ↔ BLL111-02.html (structure, derivable=True)
  - gold: `div.activity.interactive[number=1C]  «Decoding words»`
  - Claude: `div.activity[number=1C]  «Decoding words»`
- **BLL115** BLL115_1_0.html ↔ BLL115-02.html (structure, derivable=True)
  - gold: `div.activity.interactive[number=1D]  «Watch and practise»`
  - Claude: `div.activity[number=1E]  «Writing the words»`
...
- pages 58 / modules 46 / lines 98; consensus (all) 0.79 of 298 gold pages with the region; derivable structure-only (0 lines with no WT source)
...
- **BLL113** BLL113_1_0.html ↔ BLL113-02.html (structure, derivable=True)
  - gold: `—`
  - Claude: `div.col-12  «This activity is important to help your child hear the sounds in the words. By replacing one sound with another helps th»`
...
- **BLL111** BLL111_2_0.html ↔ BLL111-03.html (structure, derivable=True)
  - gold: `—`
  - Claude: `p  «https://speldsa.org.au»`
- **BLL112** BLL112_1_0.html ↔ BLL112-02.html (structure, derivable=True)
  - gold: `—`
  - Claude: `p  «https://speldsa.org.au»`
- **BLL114** BLL114_1_0.html ↔ BLL114-02.html (structure, derivable=True)
  - gold: `—`
  - Claude: `p  «https://www.istockphoto.com/vector/applause-icon-clapping-hands-gm1133905331-301119719?searchscope=image%2Cfilm»`
...
- **BLL116** BLL116_1_0.html ↔ BLL116-02.html (structure, derivable=True)
  - gold: `—`
  - Claude: `img.img-fluid`
- **BLL117** BLL117_2_0.html ↔ BLL117-03.html (structure, derivable=True)
  - gold: `—`
  - Claude: `img.img-fluid`
...
### #130 · activity · SUBSTITUTED · `div.col-12` › gold `p` vs Claude `p` — CANDIDATE
...
- authority (§1b): 3 — the module's own gold (group consensus ≥ 0.60)
- **BLL145** BLL145_1_1.html ↔ BLL145-2.0.html (structure, derivable=True)
  - gold: `p  «This is a chance for the ākonga to practice their story writing. They can incorporate words they have already learned, a»`
  - Claude: `p  «This is a chance for the ākonga to practice their story writing. They can incorporate words they have already learned, a»`
- **BLL152** BLL152_1_0.html ↔ BLL152-1.0.html (structure, derivable=True)
  - gold: `p  «Here is a fun quiz about the text that you have just read. Click on the correct answer below:»`
  - Claude: `p  «Here is a fun quiz about the text that you have just read. Click on the correct answer below:»`
- **BLL177** BLL177_2_0.html ↔ BLL177-2.0.html (structure, derivable=True)
  - gold: `p  «Repeat this process with the rest of the words.»`
  - Claude: `p  «On your white board or paper write the first word down, then:»`
