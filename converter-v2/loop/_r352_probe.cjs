/** _r352_probe.cjs — ROUND 352 in-memory A/B probe (the r351 probe, unchanged mechanics; toggles CARHEADEND_OFF + CARMEMBERS_OFF). Converts each module exactly as batch_convert.cjs
 ...
 *    CARHEADEND_OFF=1 CARMEMBERS_OFF=1 STUB_OEMBED=1 node --require ./_deflate_raw_polyfill.cjs ../../outputs/_r352_probe.cjs CODES…   (expect: all identical)
 *    STUB_OEMBED=1 node --require ./_deflate_raw_polyfill.cjs ../../outputs/_r352_probe.cjs CODES…                     (the round's diffs)
