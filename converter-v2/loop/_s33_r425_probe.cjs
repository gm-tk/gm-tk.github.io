/** _s33_r425_probe.cjs — ROUND 425 in-memory A/B probe (OFF = ACTTABLEADAPT_OFF=1; ON = the live data); a verbatim copy of _s28_t3_probe.cjs. Converts each module exactly as batch_convert.cjs
