...
**Produced:** 2026-09-20 17:24 NZST by `reference/tests/_diff_miner.py` on the CURRENT corpus (pageforge-site HEAD a1a73cc; Claude corpus 494 dirs). **Population:** the skeleton gate's own — 2349 paired pages / 483 modules (compare_exclusions.txt honoured; acks / glossary / references pages excluded); parse errors skipped: 0 (must be 0); modules without a parsed WT: 2. Run time 84.1 s.
...
- differing skeleton lines: 266176 — by direction {'MISSING': 140916, 'SUBSTITUTED': 23775, 'EXTRA': 92777, 'MOVED': 8708}
- by region: {'module-code': 15, 'title': 352, 'header': 5, 'module-menu': 13322, 'phases-nav': 108, 'crumbs': 202, 'footer': 2410, 'acks': 1310, 'activity': 95760, 'body': 151099, 'root': 1593}
- classes: 8855 — CANDIDATE 182, below floor 8390, the rest below consensus / not derivable
...
| 579 | activity | MISSING | `div.col-12` | `p` | `—` | 727 | 348 | 0.29 of 2342 | template+ptype=Inquiry/overview c=0.73 n=24 | 0.80 | — | CANDIDATE |
| 580 | activity | EXTRA | `div.col-12` | `—` | `p` | 568 | 280 | 0.88 of 2342 | series=XDLS90 c=1.00 n=22 | structure | — | CANDIDATE |
| 583 | activity | MISSING | `div.col-12` | `a` | `—` | 429 | 217 | 0.29 of 2342 | series=HIS10 c=0.71 n=40 | 0.62 | — | CANDIDATE |
| 584 | activity | MISSING | `div.col-12` | `h3` | `—` | 390 | 194 | 0.31 of 2342 | template+ptype=Fundamentals/overview c=0.85 n=32 | 0.69 | — | CANDIDATE |
| 585 | activity | EXTRA | `div.col-12` | `—` | `WIDGET` | 320 | 193 | 0.82 of 2342 | subject=NCEA1 c=0.94 n=32 | structure | — | CANDIDATE |
...
| 589 | activity | MISSING | `div.activity.interactive[number=*]` | `div.row` | `—` | 268 | 154 | 0.12 of 2342 | template+ptype=Fundamentals/overview c=0.65 n=34 | 0.92 | yes | CANDIDATE |
| 590 | activity | EXTRA | `div.col-12` | `—` | `img.img-fluid` | 229 | 141 | 0.97 of 2342 | subject+ptype=1-10 English/lesson c=0.99 n=22 | structure | — | CANDIDATE |
...
| 596 | activity | EXTRA | `div.col-12` | `—` | `p>a` | 125 | 101 | 1.00 of 2342 | subject+ptype=1-10 Blended Literacy/lesson c=1.00 n=33 | structure | — | CANDIDATE |
...
| 604 | activity | EXTRA | `div.col-12` | `—` | `p>b` | 124 | 84 | 0.97 of 2342 | template=Standard c=0.98 n=94 | structure | — | CANDIDATE |
| 605 | activity | SUBSTITUTED | `div.col-12` | `p` | `p` | 110 | 84 | 0.75 of 2342 | template+ptype=Standard/lesson c=0.88 n=71 | structure | — | CANDIDATE |
...
| 617 | activity | SUBSTITUTED | `div.col-12.col-md-8` | `div.activity.interactive[number=*]` | `div.activity.interactive[number=*]` | 94 | 67 | 0.42 of 2342 | subject+ptype=1-10 Mathematics/lesson c=0.65 n=21 | structure | yes | CANDIDATE |
| 618 | activity | SUBSTITUTED | `div.col-12` | `WIDGET` | `p` | 82 | 67 | 0.60 of 2342 | subject+ptype=1-10 Mathematics/lesson c=0.78 n=31 | structure | — | CANDIDATE |
...
| 627 | activity | SUBSTITUTED | `div.col-12` | `p` | `WIDGET` | 68 | 57 | 0.75 of 2342 | template+ptype=Standard/lesson c=0.88 n=49 | structure | — | CANDIDATE |
| 629 | activity | EXTRA | `div.col-12` | `—` | `h4.goJournal` | 129 | 55 | 0.95 of 2342 | series=HIS10 c=1.00 n=33 | structure | — | CANDIDATE |
| 631 | activity | EXTRA | `div.col-12.col-md-8` | `—` | `div.activity[number=*]` | 64 | 54 | 0.95 of 2342 | template=Standard c=0.98 n=51 | structure | yes | CANDIDATE |
...
| 634 | activity | EXTRA | `ol` | `—` | `li` | 69 | 53 | 0.96 of 2342 | template=Standard c=0.96 n=53 | structure | — | CANDIDATE |
...
| 639 | activity | EXTRA | `div.col-12` | `—` | `p>i` | 54 | 48 | 0.98 of 2342 | template=Standard c=0.98 n=45 | structure | — | CANDIDATE |
| 647 | activity | EXTRA | `p>i` | `—` | `i` | 48 | 40 | 0.89 of 2342 | template=Standard c=0.90 n=44 | structure | — | CANDIDATE |
| 651 | activity | EXTRA | `a` | `—` | `div.externalButton` | 49 | 38 | 0.91 of 2342 | template=Standard c=0.91 n=35 | structure | — | CANDIDATE |
| 661 | activity | EXTRA | `div.col-12.col-md-8` | `—` | `div.activity.interactive[number=*]` | 36 | 34 | 0.89 of 2342 | template=Standard c=0.92 n=28 | structure | yes | CANDIDATE |
...
| 664 | activity | SUBSTITUTED | `div.col-12` | `a` | `WIDGET` | 39 | 33 | 0.56 of 2342 | template+ptype=Standard/lesson c=0.66 n=35 | structure | — | CANDIDATE |
...
| 676 | activity | SUBSTITUTED | `div.row` | `div.col-12` | `div.col-12.col-md-8` | 34 | 30 | 0.79 of 2342 | template+ptype=Standard/lesson c=0.92 n=22 | structure | — | CANDIDATE |
...
| 680 | activity | EXTRA | `ul` | `—` | `li` | 30 | 29 | 0.93 of 2342 | template=Standard c=0.95 n=25 | structure | — | CANDIDATE |
| 684 | activity | EXTRA | `div.col-12` | `—` | `div.ratio.ratio-16x9.videoSection` | 48 | 26 | 0.99 of 2342 | template=Standard c=0.99 n=39 | structure | yes | CANDIDATE |
| 688 | activity | SUBSTITUTED | `div.row` | `div.col-12` | `WIDGET` | 27 | 26 | 0.79 of 2342 | ptype=lesson c=0.92 n=21 | structure | — | CANDIDATE |
...
| 696 | activity | EXTRA | `div.col-12` | `—` | `h5` | 28 | 24 | 0.99 of 2342 | template=Standard c=0.99 n=23 | structure | — | CANDIDATE |
| 697 | activity | SUBSTITUTED | `div.activity.interactive[number=*]` | `div.row` | `WIDGET` | 27 | 24 | 0.55 of 2342 | ptype=lesson c=0.63 n=23 | structure | yes | CANDIDATE |
| 698 | activity | SUBSTITUTED | `div.col-12` | `WIDGET` | `ol` | 26 | 24 | 0.60 of 2342 | ptype=lesson c=0.69 n=22 | structure | — | CANDIDATE |
| 699 | activity | SUBSTITUTED | `div.row` | `div.col-12` | `div.row` | 25 | 24 | 0.79 of 2342 | ptype=lesson c=0.92 n=20 | structure | — | CANDIDATE |
| 714 | activity | SUBSTITUTED | `div.col-12` | `p` | `p>b` | 26 | 20 | 0.75 of 2342 | ptype=lesson c=0.88 n=21 | structure | — | CANDIDATE |
| 719 | activity | EXTRA | `div.col-12` | `—` | `div.button` | 30 | 19 | 1.00 of 2342 | template=Standard c=1.00 n=26 | structure | yes | CANDIDATE |
| 724 | activity | EXTRA | `div.ratio.ratio-16x9.videoSection` | `—` | `iframe` | 26 | 18 | 0.99 of 2342 | ptype=lesson c=0.99 n=24 | structure | yes | CANDIDATE |
| 725 | activity | SUBSTITUTED | `div.col-12` | `h3` | `h3` | 26 | 18 | 0.76 of 2342 | template+ptype=Standard/lesson c=0.89 n=20 | structure | — | CANDIDATE |
...
| 3683 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p` | 1056 | 386 | 0.82 of 2342 | subject+ptype=NCEA1/overview c=1.00 n=29 | structure | — | CANDIDATE |
| 3684 | body | EXTRA | `div#body` | `—` | `div.row` | 1400 | 374 | 0.73 of 2342 | subject+ptype=1-10 Blended Literacy/overview c=1.00 n=29 | structure | — | CANDIDATE |
| 3685 | body | MISSING | `div#body` | `div.row` | `—` | 1294 | 323 | 0.34 of 2342 | series=CEDO50 c=0.76 n=20 | 0.86 | — | CANDIDATE |
| 3686 | body | MISSING | `div.col-12.col-md-8` | `p` | `—` | 593 | 275 | 0.25 of 2342 | template+ptype=Fundamentals/overview c=0.91 n=44 | 0.81 | — | CANDIDATE |
| 3687 | body | EXTRA | `div.col-12.col-md-8` | `—` | `img.img-fluid` | 539 | 243 | 0.96 of 2342 | template+ptype=Standard/overview c=1.00 n=25 | structure | — | CANDIDATE |
| 3688 | body | EXTRA | `div.col-12.col-md-8` | `—` | `WIDGET` | 359 | 225 | 0.93 of 2342 | subject+ptype=NCEA1/lesson c=0.99 n=51 | structure | — | CANDIDATE |
| 3689 | body | MOVED | `div.col-12.col-md-8` | `p` | `p` | 321 | 204 | 0.18 of 2342 | template+ptype=Fundamentals/overview c=0.84 n=40 | structure | — | CANDIDATE |
| 3690 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p>b` | 320 | 193 | 0.97 of 2342 | subject=1-10 Blended Literacy c=1.00 n=41 | structure | — | CANDIDATE |
| 3691 | body | EXTRA | `div.row` | `—` | `div.col-12.col-md-8` | 283 | 193 | 0.85 of 2342 | subject+ptype=1-10 Blended Literacy/lesson c=0.96 n=22 | structure | — | CANDIDATE |
| 3692 | body | SUBSTITUTED | `div.row` | `div.col-12` | `div.col-12.col-md-8` | 316 | 181 | 0.55 of 2342 | subject+ptype=1-10 Blended Literacy/overview c=0.96 n=64 | structure | — | CANDIDATE |
| 3693 | body | EXTRA | `div.col-12.col-md-8` | `—` | `h3` | 291 | 180 | 0.89 of 2342 | template+ptype=Standard/overview c=1.00 n=33 | structure | — | CANDIDATE |
| 3694 | body | EXTRA | `div.col-12.col-md-8` | `—` | `ul` | 294 | 171 | 0.95 of 2342 | subject=1-10 Mathematics c=0.98 n=21 | structure | — | CANDIDATE |
| 3695 | body | MISSING | `div.col-12.col-md-8` | `WIDGET` | `—` | 260 | 169 | 0.19 of 2342 | template+ptype=Fundamentals/overview c=0.65 n=31 | structure | — | CANDIDATE |
| 3696 | body | MISSING | `div.row` | `div.col-12.col-md-8` | `—` | 308 | 166 | 0.29 of 2342 | template+ptype=Fundamentals/overview c=0.94 n=20 | 0.95 | — | CANDIDATE |
| 3699 | body | EXTRA | `div.col-12.col-md-8` | `—` | `a` | 223 | 146 | 0.98 of 2342 | subject=ConnectED c=1.00 n=28 | structure | — | CANDIDATE |
| 3700 | body | MISSING | `div.col-12.col-md-8` | `h3` | `—` | 224 | 145 | 0.18 of 2342 | template+ptype=Fundamentals/overview c=0.75 n=21 | 0.89 | — | CANDIDATE |
| 3703 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.table-responsive` | 166 | 114 | 0.92 of 2342 | subject=NCEA1 c=0.92 n=41 | structure | — | CANDIDATE |
| 3704 | body | EXTRA | `p>b` | `—` | `b` | 181 | 113 | 0.94 of 2342 | subject=1-10 Mathematics c=0.97 n=32 | structure | — | CANDIDATE |
| 3706 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.ratio.ratio-16x9.videoSection` | 170 | 110 | 0.94 of 2342 | subject=NCEA1 c=0.98 n=23 | structure | yes | CANDIDATE |
| 3710 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p>a` | 162 | 108 | 0.99 of 2342 | subject=1-10 English c=1.00 n=20 | structure | — | CANDIDATE |
| 3711 | body | EXTRA | `a` | `—` | `div.button` | 172 | 104 | 0.99 of 2342 | subject=NCEA1 c=1.00 n=36 | structure | — | CANDIDATE |
| 3716 | body | EXTRA | `p` | `—` | `b` | 116 | 91 | 0.93 of 2342 | subject=NCEA1 c=0.96 n=29 | structure | — | CANDIDATE |
| 3717 | body | EXTRA | `div.table-responsive` | `—` | `table.table.table-bordered` | 136 | 89 | 0.96 of 2342 | subject=NCEA1 c=0.97 n=28 | structure | yes | CANDIDATE |
| 3720 | body | SUBSTITUTED | `div.icon.ratio.ratio-16x9.videoSection` | `iframe.embed-responsive-item` | `iframe` | 212 | 81 | 0.20 of 2342 | series=PES10 c=0.68 n=35 | structure | yes | CANDIDATE |
| 3721 | body | EXTRA | `p>i` | `—` | `i` | 107 | 80 | 0.97 of 2342 | subject+ptype=1-10 Blended Literacy/overview c=1.00 n=26 | structure | — | CANDIDATE |
| 3725 | body | EXTRA | `div.col-12.col-md-8` | `—` | `ol` | 105 | 78 | 0.99 of 2342 | template=Standard c=0.99 n=86 | structure | — | CANDIDATE |
| 3726 | body | EXTRA | `p>a` | `—` | `a` | 99 | 73 | 0.99 of 2342 | template=Standard c=1.00 n=78 | structure | — | CANDIDATE |
| 3727 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p>i` | 100 | 72 | 0.98 of 2342 | subject=NCEA1 c=0.99 n=26 | structure | — | CANDIDATE |
| 3731 | body | EXTRA | `div.row` | `—` | `div.col-12` | 124 | 70 | 0.71 of 2342 | subject=ANZH c=0.74 n=21 | structure | — | CANDIDATE |
| 3732 | body | EXTRA | `div.col-12.col-md-8` | `—` | `audio.audioPlayer.icon` | 125 | 69 | 1.00 of 2342 | subject=Leaving to Learn c=1.00 n=34 | structure | yes | CANDIDATE |
| 3737 | body | MOVED | `div.col-12.col-md-8` | `h3` | `h3` | 82 | 68 | 0.11 of 2342 | template+ptype=Fundamentals/overview c=0.67 n=24 | structure | — | CANDIDATE |
| 3738 | body | SUBSTITUTED | `div#body` | `div.row` | `WIDGET` | 112 | 67 | 0.94 of 2342 | subject=Online Safety (OS9000) c=1.00 n=25 | structure | — | CANDIDATE |
| 3741 | body | EXTRA | `div.fundamentalsPanel` | `—` | `div.row` | 67 | 67 | 0.98 of 2342 | era=Refresh c=0.98 n=67 | structure | — | CANDIDATE |
| 3742 | body | EXTRA | `table.table.table-bordered` | `—` | `tr` | 91 | 65 | 0.98 of 2342 | template=Standard c=0.98 n=78 | structure | yes | CANDIDATE |
| 3748 | body | EXTRA | `a` | `—` | `div.externalButton` | 86 | 60 | 0.92 of 2342 | template=Standard c=0.92 n=74 | structure | — | CANDIDATE |
| 3752 | body | EXTRA | `ul` | `—` | `li` | 72 | 59 | 0.94 of 2342 | template=Standard c=0.95 n=55 | structure | — | CANDIDATE |
...
| 3754 | body | EXTRA | `div.col-12.col-md-8` | `—` | `h4` | 66 | 58 | 0.97 of 2342 | template=Standard c=0.98 n=31 | structure | — | CANDIDATE |
| 3757 | body | EXTRA | `div.ratio.ratio-16x9.videoSection` | `—` | `iframe` | 74 | 56 | 0.92 of 2342 | template=Standard c=0.93 n=53 | structure | yes | CANDIDATE |
| 3759 | body | EXTRA | `div.col-12` | `—` | `p` | 87 | 51 | 0.93 of 2342 | template=Standard c=0.94 n=75 | structure | — | CANDIDATE |
| 3760 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `div.activity[number=*]` | 58 | 51 | 0.85 of 2342 | template+ptype=Standard/lesson c=0.86 n=50 | structure | yes | CANDIDATE |
| 3761 | body | EXTRA | `div.alert` | `—` | `div.row` | 64 | 50 | 0.91 of 2342 | template=Standard c=0.92 n=46 | structure | — | CANDIDATE |
| 3762 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `p` | 64 | 50 | 0.85 of 2342 | template+ptype=Standard/lesson c=0.86 n=45 | structure | — | CANDIDATE |
| 3765 | body | EXTRA | `tr` | `—` | `td` | 55 | 47 | 0.94 of 2342 | template=Standard c=0.95 n=51 | structure | — | CANDIDATE |
...
| 3772 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.icon.ratio.ratio-16x9.videoSection` | 62 | 44 | 0.92 of 2342 | template=Standard c=0.93 n=54 | structure | yes | CANDIDATE |
| 3780 | body | EXTRA | `div#body` | `—` | `WIDGET` | 77 | 41 | 0.93 of 2342 | era=Refresh c=0.93 n=77 | structure | — | CANDIDATE |
| 3782 | body | SUBSTITUTED | `div.row` | `div.col-12.col-md-8` | `WIDGET` | 44 | 41 | 0.98 of 2342 | ptype=lesson c=0.99 n=37 | structure | — | CANDIDATE |
| 3783 | body | MISSING | `div#body` | `div.fundamentalsPanel` | `—` | 48 | 40 | 0.02 of 2342 | template+ptype=Fundamentals/overview c=0.60 n=39 | 0.98 | yes | CANDIDATE |
| 3786 | body | EXTRA | `p` | `—` | `i` | 44 | 38 | 0.96 of 2342 | template=Standard c=0.97 n=40 | structure | — | CANDIDATE |
| 3787 | body | EXTRA | `tr` | `—` | `th` | 41 | 38 | 0.99 of 2342 | template=Standard c=1.00 n=34 | structure | — | CANDIDATE |
| 3794 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `WIDGET` | 36 | 35 | 0.85 of 2342 | template+ptype=Standard/lesson c=0.86 n=23 | structure | — | CANDIDATE |
| 3796 | body | SUBSTITUTED | `div.row` | `div.col-12.col-md-8` | `div.row` | 35 | 34 | 0.98 of 2342 | ptype=lesson c=0.99 n=20 | structure | — | CANDIDATE |
| 3797 | body | EXTRA | `div#body` | `—` | `div.row.supervisor` | 43 | 33 | 0.90 of 2342 | ptype=lesson c=0.91 n=38 | structure | yes | CANDIDATE |
| 3798 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p>span.infoTrigger` | 37 | 33 | 0.86 of 2342 | template=Standard c=0.87 n=31 | structure | — | CANDIDATE |
| 3800 | body | EXTRA | `div.row` | `—` | `div.col-12.col-md-4.offset-md-0` | 33 | 33 | 0.80 of 2342 | template=Standard c=0.80 n=21 | structure | — | CANDIDATE |
| 3806 | body | EXTRA | `div.col-12.col-md-8` | `—` | `h5` | 40 | 31 | 0.98 of 2342 | subject=NCEA1 c=0.99 n=21 | structure | — | CANDIDATE |
| 3807 | body | EXTRA | `div.col-12.col-md-8` | `—` | `h4.goJournal` | 39 | 30 | 1.00 of 2342 | era=Refresh c=1.00 n=39 | structure | — | CANDIDATE |
| 3812 | body | EXTRA | `div#body` | `—` | `div.fundamentalsPanel` | 30 | 30 | 0.98 of 2342 | era=Refresh c=0.98 n=30 | structure | yes | CANDIDATE |
| 3813 | body | EXTRA | `div.alert.solid` | `—` | `div.row` | 41 | 29 | 0.99 of 2342 | template=Standard c=0.99 n=36 | structure | yes | CANDIDATE |
| 3815 | body | EXTRA | `div.icon.ratio.ratio-16x9.videoSection` | `—` | `iframe` | 36 | 29 | 0.97 of 2342 | ptype=lesson c=0.98 n=30 | structure | yes | CANDIDATE |
| 3819 | body | EXTRA | `div.inquiryPanel` | `—` | `div.row` | 30 | 28 | 0.99 of 2342 | era=Refresh c=0.99 n=30 | structure | — | CANDIDATE |
| 3820 | body | EXTRA | `div.introduction` | `—` | `div.row` | 28 | 28 | 0.99 of 2342 | era=Refresh c=0.99 n=28 | structure | — | CANDIDATE |
| 3823 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.flipCardsContainer.row` | 30 | 27 | 0.94 of 2342 | template=Standard c=0.95 n=24 | structure | — | CANDIDATE |
| 3831 | body | EXTRA | `div.row` | `—` | `div.col-12.col-md-4` | 32 | 25 | 0.95 of 2342 | template=Standard c=0.95 n=26 | structure | — | CANDIDATE |
| 3836 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `img.img-fluid` | 26 | 25 | 0.85 of 2342 | era=Refresh c=0.85 n=26 | structure | — | CANDIDATE |
| 3843 | body | SUBSTITUTED | `div.row` | `div.col-12.col-md-8` | `div.col-12.col-md-6` | 27 | 24 | 0.98 of 2342 | ptype=lesson c=0.99 n=23 | structure | — | CANDIDATE |
| 3847 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.alert.solid` | 29 | 23 | 0.99 of 2342 | era=Refresh c=0.99 n=29 | structure | yes | CANDIDATE |
| 3850 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.clickDropContent` | 26 | 22 | 0.95 of 2342 | template=Standard c=0.95 n=23 | structure | — | CANDIDATE |
...
| 3859 | body | EXTRA | `p>span.infoTrigger` | `—` | `span.infoTrigger` | 21 | 21 | 0.84 of 2342 | era=Refresh c=0.84 n=21 | structure | — | CANDIDATE |
| 3861 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `div.alert` | 27 | 20 | 0.85 of 2342 | era=Refresh c=0.85 n=27 | structure | — | CANDIDATE |
| 3879 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `h3` | 20 | 19 | 0.85 of 2342 | era=Refresh c=0.85 n=20 | structure | — | CANDIDATE |
| 3891 | body | SUBSTITUTED | `div#body` | `div.row` | `div.table-responsive` | 23 | 17 | 0.94 of 2342 | ptype=lesson c=0.98 n=21 | structure | — | CANDIDATE |
...
| 3916 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p.captionText` | 21 | 15 | 1.00 of 2342 | era=Refresh c=1.00 n=21 | structure | — | CANDIDATE |
| 3924 | body | EXTRA | `div.col-12.col-md-6` | `—` | `p` | 23 | 14 | 1.00 of 2342 | ptype=lesson c=1.00 n=21 | structure | — | CANDIDATE |
...
| 8780 | root | EXTRA | `body.container-fluid` | `—` | `div.row` | 261 | 261 | 0.88 of 2349 | subject+ptype=1-10 Mathematics/overview c=0.97 n=33 | structure | — | CANDIDATE |
| 8784 | root | SUBSTITUTED | `#root` | `body` | `body.container-fluid` | 138 | 15 | 0.06 of 2349 | series=PWY10 c=1.00 n=44 | structure | yes | CANDIDATE |
