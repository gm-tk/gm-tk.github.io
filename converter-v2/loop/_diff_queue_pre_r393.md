...
**Produced:** 2026-09-19 02:46 NZST by `reference/tests/_diff_miner.py` on the CURRENT corpus (pageforge-site HEAD 687cb8c; Claude corpus 416 dirs). **Population:** the skeleton gate's own — 1956 paired pages / 405 modules (compare_exclusions.txt honoured; acks / glossary / references pages excluded); parse errors skipped: 0 (must be 0); modules without a parsed WT: 2. Run time 64.1 s.
...
- differing skeleton lines: 227362 — by direction {'MISSING': 119563, 'SUBSTITUTED': 20808, 'EXTRA': 79191, 'MOVED': 7800}
- by region: {'module-code': 15, 'title': 251, 'header': 5, 'module-menu': 11995, 'phases-nav': 43, 'crumbs': 179, 'footer': 2081, 'acks': 1175, 'activity': 83485, 'body': 126726, 'root': 1407}
- classes: 8142 — CANDIDATE 177, below floor 7716, the rest below consensus / not derivable
...
| 3520 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p` | 857 | 319 | 0.82 of 1950 | subject=1-10 Blended Literacy c=1.00 n=36 | structure | — | CANDIDATE |
| 3521 | body | MISSING | `div#body` | `div.row` | `—` | 1071 | 276 | 0.34 of 1950 | series=CEDO50 c=0.76 n=20 | 0.86 | — | CANDIDATE |
| 3522 | body | MISSING | `div.col-12.col-md-8` | `p` | `—` | 499 | 236 | 0.25 of 1950 | template+ptype=Fundamentals/overview c=0.89 n=33 | 0.82 | — | CANDIDATE |
...
| 3524 | body | MOVED | `div.col-12.col-md-8` | `p` | `p` | 271 | 176 | 0.18 of 1950 | template+ptype=Fundamentals/overview c=0.87 n=33 | structure | — | CANDIDATE |
...
| 3528 | body | EXTRA | `div.row` | `—` | `div.col-12.col-md-8` | 226 | 154 | 0.86 of 1950 | subject=1-10 Blended Literacy c=0.96 n=30 | structure | — | CANDIDATE |
...
| 3532 | body | EXTRA | `div.col-12.col-md-8` | `—` | `ul` | 235 | 129 | 0.96 of 1950 | subject=1-10 English c=0.99 n=24 | structure | — | CANDIDATE |
| 3537 | body | EXTRA | `div.col-12.col-md-8` | `—` | `a` | 183 | 108 | 0.98 of 1950 | subject=ConnectED c=1.00 n=31 | structure | — | CANDIDATE |
| 3538 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.ratio.ratio-16x9.videoSection` | 181 | 108 | 0.94 of 1950 | subject=1-10 English c=0.97 n=33 | structure | yes | CANDIDATE |
...
| 3572 | body | MOVED | `div.col-12.col-md-8` | `h3` | `h3` | 70 | 58 | 0.10 of 1950 | template+ptype=Fundamentals/overview c=0.74 n=20 | structure | — | CANDIDATE |
...
| 3684 | body | EXTRA | `div.icon.ratio.ratio-16x9.videoSection` | `—` | `iframe` | 23 | 19 | 0.97 of 1950 | era=Refresh c=0.97 n=23 | structure | yes | CANDIDATE |
| 3685 | body | EXTRA | `div.clickDropContent` | `—` | `p` | 21 | 19 | 0.96 of 1950 | era=Refresh c=0.96 n=21 | structure | — | CANDIDATE |
...
| 8075 | root | EXTRA | `body.container-fluid` | `—` | `div.row` | 233 | 233 | 0.87 of 1956 | subject+ptype=NCEA1/overview c=0.98 n=41 | structure | — | CANDIDATE |
| 8080 | root | SUBSTITUTED | `#root` | `body` | `body.container-fluid` | 94 | 10 | 0.05 of 1956 | series=CEDO50 c=1.00 n=25 | structure | yes | CANDIDATE |
