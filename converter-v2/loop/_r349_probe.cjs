/** _r349_probe.cjs — ROUND 349 in-memory A/B probe (the r342 probe, unchanged mechanics; toggle MENULABEL_OFF). Converts each module exactly as batch_convert.cjs
 ...
 *    MENULABEL_OFF=1 STUB_OEMBED=1 node --require ./_deflate_raw_polyfill.cjs ../../outputs/_r349_probe.cjs CODES…   (expect: all identical)
 *    STUB_OEMBED=1 node --require ./_deflate_raw_polyfill.cjs ../../outputs/_r349_probe.cjs CODES…                     (the round's diffs)
