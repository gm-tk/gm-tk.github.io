#!/usr/bin/env python3
"""r403 skeleton delta: r402 -> r403 (_sk_final.json), movers named, bucket crossings, outside-affected check."""
import json
a = json.load(open('_s27_r402_sk_final.json')); b = json.load(open('_s27_r403_sk_final.json'))
aff = set(l.strip() for l in open('_s27_r403_affected.txt') if l.strip())
