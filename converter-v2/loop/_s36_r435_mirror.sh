#!/usr/bin/env bash
# SESSION 36 ROUND 3 (engine r435 — the lesson menu ends at the writer's [Body]) — the loop mirror: README row + the round's artefacts
...
n=0
for f in $(cd $O && ls _s36_r435_* _s36_r3_* _affected_r435.txt 2>/dev/null); do
