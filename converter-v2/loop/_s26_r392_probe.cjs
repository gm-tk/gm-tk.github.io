/** _s26_r392_probe.cjs — ROUND 392 in-memory A/B probe (unchanged mechanics; toggle ULMERGE_OFF). Converts each module exactly as batch_convert.cjs
 ...
 *    ULMERGE_OFF=1 STUB_OEMBED=1 node --require ./_deflate_raw_polyfill.cjs ../../outputs/_s26_r392_probe.cjs CODES…   (expect: all identical)
 *    STUB_OEMBED=1 node --require ./_deflate_raw_polyfill.cjs ../../outputs/_s26_r392_probe.cjs CODES…                     (the round's diffs)
