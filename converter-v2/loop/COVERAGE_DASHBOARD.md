...
_Generated 2026-09-17 12:41 · corpus 443 modules / 2103 pages_
...
**Interactive coverage — 50.5%** (2504 of 4956 writer-tagged widgets actually build).
The other 2452 ship as a hand-off box. This is what a tester sees when they say the conversion looks unfinished, and it is invisible to the protected gates by design.

**Page scaffold match — 52.0% mean** (1093 of 1955 pages at 50%+, 160 at 75%+).
...
| 2 | content lost vs the human (advisory) | 180 | 405 | 405 | — | — | The human page carries 3+ body blocks ours does not, without tripping the over-capture rule — content is going missing by some other route. |
...
| 4 | un-built flipCard | 121 | 168 | 215 | 179 | 222 (51% skipped) | Writers tagged 484 flipCard widgets; 215 ship as a hand-off box instead of a built widget. |
| 5 | un-built accordion | 109 | 178 | 250 | 214 | 212 (53% skipped) | Writers tagged 705 accordion widgets; 250 ship as a hand-off box instead of a built widget. |
...
| TWHK901 | TWHK901_0_0.html | 5.8% | 24 content blocks missing; widget over-capture |
