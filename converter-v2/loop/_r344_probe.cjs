/** _r344_probe.cjs — ROUND 344 in-memory A/B probe (the r342 probe, unchanged mechanics). Converts each module exactly as batch_convert.cjs
 ...
 *    DEDUPC47_OFF=1 TITLEMARK_OFF=1 STUB_OEMBED=1 node --require ./_deflate_raw_polyfill.cjs ../../outputs/_r342_probe.cjs CODES…   (expect: all identical)
 *    STUB_OEMBED=1 node --require ./_deflate_raw_polyfill.cjs ../../outputs/_r342_probe.cjs CODES…                     (the round's diffs)
