#!/usr/bin/env python3
"""r405 queue delta: CANDIDATE rows of the pre-r392 DIFF_QUEUE vs the re-mined one, keyed (region, dir, parent, gold, claude)."""
import re, sys
def rows(p):
    out = {}
    ...
    return out
a = rows("_diff_queue_pre_r405.md"); b = rows("../../DIFF_QUEUE.md")
