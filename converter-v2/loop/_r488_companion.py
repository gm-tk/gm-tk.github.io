...
roles, depth ignored, gold ∩ Claude) and the count of quote-form lines, OLD (disk) vs NEW (outputs/_r488_on). WSL, from outputs/:
...
for arg in sys.argv[1:]:
    ...
    n, _ = dm.page_lines(os.path.join(OUT, "_r488_on", code, page))
