/** _r342_probe.cjs — ROUND 342 in-memory A/B probe. Converts each module exactly as batch_convert.cjs
 ...
 *    HYPERTAG_OFF=1 STUB_OEMBED=1 node --require ./_deflate_raw_polyfill.cjs ../../outputs/_r342_probe.cjs CODES…   (expect: all identical)
