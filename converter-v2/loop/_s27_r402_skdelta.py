#!/usr/bin/env python3
"""r402 skeleton delta: r401 -> r402 (_sk_final.json), movers named, bucket crossings, outside-affected check."""
import json
a = json.load(open('_s27_r401_sk_final.json')); b = json.load(open('_s27_r402_sk_final.json'))
aff = set(l.strip() for l in open('_s27_r402_affected.txt') if l.strip())
