...
**Produced:** 2026-09-19 15:40 NZST by `reference/tests/_diff_miner.py` on the CURRENT corpus (pageforge-site HEAD 1b333ca; Claude corpus 416 dirs). **Population:** the skeleton gate's own — 1956 paired pages / 405 modules (compare_exclusions.txt honoured; acks / glossary / references pages excluded); parse errors skipped: 0 (must be 0); modules without a parsed WT: 2. Run time 69.4 s.
...
- differing skeleton lines: 225413 — by direction {'MISSING': 119098, 'SUBSTITUTED': 20378, 'EXTRA': 78271, 'MOVED': 7666}
- by region: {'module-code': 15, 'title': 251, 'header': 5, 'module-menu': 11990, 'phases-nav': 43, 'crumbs': 179, 'footer': 2075, 'acks': 1176, 'activity': 82882, 'body': 125390, 'root': 1407}
- classes: 7998 — CANDIDATE 169, below floor 7587, the rest below consensus / not derivable
...
| 522 | activity | MISSING | `div.col-12` | `p` | `—` | 624 | 291 | 0.31 of 1950 | subject+ptype=1-10 Blended Literacy/lesson c=0.78 n=98 | 0.80 | — | CANDIDATE |
| 523 | activity | EXTRA | `div.col-12` | `—` | `p` | 505 | 243 | 0.88 of 1950 | series=XDLS90 c=1.00 n=22 | structure | — | CANDIDATE |
...
| 528 | activity | MISSING | `div.col-12` | `h3` | `—` | 312 | 156 | 0.32 of 1950 | template=Fundamentals c=0.81 n=20 | 0.66 | — | CANDIDATE |
| 529 | activity | MOVED | `div.col-12` | `p` | `p` | 254 | 152 | 0.19 of 1950 | template+ptype=Fundamentals/overview c=0.62 n=22 | structure | — | CANDIDATE |
| 530 | activity | SUBSTITUTED | `div.col-12.col-md-8` | `div.activity.interactive[number=*]` | `div.activity[number=*]` | 224 | 152 | 0.42 of 1950 | subject+ptype=1-10 Blended Literacy/lesson c=0.72 n=53 | structure | yes | CANDIDATE |
| 532 | activity | EXTRA | `div.col-12` | `—` | `img.img-fluid` | 210 | 126 | 0.97 of 1950 | subject=1-10 English c=0.99 n=22 | structure | — | CANDIDATE |
| 533 | activity | EXTRA | `div.row` | `—` | `div.col-12` | 161 | 114 | 0.89 of 1950 | series=XDLS90 c=0.97 n=21 | structure | — | CANDIDATE |
...
| 538 | activity | EXTRA | `div.activity[number=*]` | `—` | `div.row` | 133 | 92 | 0.94 of 1950 | template=Standard c=0.96 n=109 | structure | yes | CANDIDATE |
...
| 547 | activity | SUBSTITUTED | `div.col-12.col-md-8` | `div.activity[number=*]` | `div.activity.interactive[number=*]` | 102 | 74 | 0.48 of 1950 | subject+ptype=1-10 Blended Literacy/lesson c=0.86 n=23 | structure | yes | CANDIDATE |
| 548 | activity | EXTRA | `div.col-12` | `—` | `h3` | 98 | 74 | 0.86 of 1950 | template=Standard c=0.91 n=60 | structure | — | CANDIDATE |
| 549 | activity | EXTRA | `div.col-12` | `—` | `ol` | 119 | 73 | 0.96 of 1950 | subject=1-10 Mathematics c=0.98 n=31 | structure | — | CANDIDATE |
| 551 | activity | EXTRA | `div.col-12` | `—` | `ul` | 93 | 71 | 0.94 of 1950 | template=Standard c=0.96 n=78 | structure | — | CANDIDATE |
...
| 565 | activity | SUBSTITUTED | `div.col-12.col-md-8` | `div.activity.interactive[number=*]` | `div.activity.interactive[number=*]` | 71 | 54 | 0.42 of 1950 | subject+ptype=1-10 Mathematics/lesson c=0.65 n=21 | structure | yes | CANDIDATE |
...
| 571 | activity | SUBSTITUTED | `div.col-12` | `a` | `h4.goJournal` | 115 | 51 | 0.57 of 1950 | series=HIS10 c=0.83 n=20 | structure | — | CANDIDATE |
...
| 594 | activity | EXTRA | `a` | `—` | `div.externalButton` | 44 | 35 | 0.96 of 1950 | template=Standard c=0.97 n=30 | structure | — | CANDIDATE |
...
| 626 | activity | SUBSTITUTED | `div.col-12` | `WIDGET` | `div.col-12.col-md-8` | 26 | 25 | 0.60 of 1950 | ptype=lesson c=0.70 n=20 | structure | — | CANDIDATE |
| 627 | activity | EXTRA | `div.col-12` | `—` | `div.ratio.ratio-16x9.videoSection` | 46 | 24 | 0.99 of 1950 | template=Standard c=0.99 n=37 | structure | yes | CANDIDATE |
...
| 632 | activity | EXTRA | `div.col-12` | `—` | `h5` | 26 | 22 | 0.98 of 1950 | template=Standard c=0.99 n=21 | structure | — | CANDIDATE |
| 634 | activity | SUBSTITUTED | `div.row` | `div.col-12` | `div.col-12.col-md-8` | 25 | 22 | 0.79 of 1950 | era=Refresh c=0.79 n=25 | structure | — | CANDIDATE |
...
| 660 | activity | EXTRA | `div.ratio.ratio-16x9.videoSection` | `—` | `iframe` | 25 | 17 | 0.98 of 1950 | ptype=lesson c=0.99 n=23 | structure | yes | CANDIDATE |
...
| 3462 | body | EXTRA | `div#body` | `—` | `div.row` | 1185 | 322 | 0.73 of 1950 | subject+ptype=1-10 Blended Literacy/overview c=1.00 n=29 | structure | — | CANDIDATE |
| 3463 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p` | 855 | 315 | 0.82 of 1950 | subject=1-10 Blended Literacy c=1.00 n=36 | structure | — | CANDIDATE |
| 3464 | body | MISSING | `div#body` | `div.row` | `—` | 1071 | 276 | 0.34 of 1950 | series=CEDO50 c=0.76 n=20 | 0.86 | — | CANDIDATE |
| 3465 | body | MISSING | `div.col-12.col-md-8` | `p` | `—` | 499 | 232 | 0.25 of 1950 | template+ptype=Fundamentals/overview c=0.89 n=31 | 0.82 | — | CANDIDATE |
| 3466 | body | EXTRA | `div.col-12.col-md-8` | `—` | `img.img-fluid` | 437 | 189 | 0.97 of 1950 | template+ptype=Standard/overview c=1.00 n=24 | structure | — | CANDIDATE |
| 3467 | body | EXTRA | `div.col-12.col-md-8` | `—` | `WIDGET` | 289 | 177 | 0.89 of 1950 | subject=NCEA1 c=0.96 n=23 | structure | — | CANDIDATE |
| 3468 | body | MOVED | `div.col-12.col-md-8` | `p` | `p` | 267 | 174 | 0.18 of 1950 | template+ptype=Fundamentals/overview c=0.87 n=33 | structure | — | CANDIDATE |
| 3469 | body | SUBSTITUTED | `div.row` | `div.col-12` | `div.col-12.col-md-8` | 291 | 165 | 0.55 of 1950 | subject+ptype=1-10 Blended Literacy/overview c=0.99 n=64 | structure | — | CANDIDATE |
| 3470 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p>b` | 258 | 158 | 0.95 of 1950 | subject=1-10 Blended Literacy c=1.00 n=37 | structure | — | CANDIDATE |
| 3471 | body | EXTRA | `div.row` | `—` | `div.col-12.col-md-8` | 228 | 155 | 0.86 of 1950 | subject+ptype=1-10 Blended Literacy/lesson c=0.99 n=21 | structure | — | CANDIDATE |
| 3472 | body | EXTRA | `div.col-12.col-md-8` | `—` | `h3` | 224 | 144 | 0.83 of 1950 | subject=1-10 Blended Literacy c=1.00 n=20 | structure | — | CANDIDATE |
| 3475 | body | EXTRA | `div.col-12.col-md-8` | `—` | `ul` | 240 | 131 | 0.96 of 1950 | subject=1-10 English c=0.99 n=26 | structure | — | CANDIDATE |
| 3479 | body | EXTRA | `div.col-12.col-md-8` | `—` | `a` | 187 | 115 | 0.93 of 1950 | subject=1-10 English c=0.95 n=23 | structure | — | CANDIDATE |
| 3482 | body | EXTRA | `p>b` | `—` | `b` | 159 | 99 | 0.94 of 1950 | subject=1-10 Mathematics c=0.97 n=32 | structure | — | CANDIDATE |
| 3484 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.table-responsive` | 144 | 94 | 0.92 of 1950 | template=Standard c=0.92 n=127 | structure | — | CANDIDATE |
| 3487 | body | EXTRA | `a` | `—` | `div.button` | 150 | 84 | 0.97 of 1950 | subject+ptype=NCEA1/lesson c=0.98 n=20 | structure | — | CANDIDATE |
| 3488 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p>a` | 118 | 84 | 0.99 of 1950 | template=Standard c=0.99 n=96 | structure | — | CANDIDATE |
| 3489 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.ratio.ratio-16x9.videoSection` | 134 | 83 | 0.94 of 1950 | ptype=overview c=0.96 n=23 | structure | yes | CANDIDATE |
| 3492 | body | EXTRA | `p` | `—` | `b` | 101 | 80 | 0.93 of 1950 | subject=NCEA1 c=0.96 n=20 | structure | — | CANDIDATE |
| 3497 | body | EXTRA | `p>i` | `—` | `i` | 102 | 74 | 0.97 of 1950 | subject=1-10 Blended Literacy c=1.00 n=26 | structure | — | CANDIDATE |
| 3498 | body | EXTRA | `div.table-responsive` | `—` | `table.table.table-bordered` | 116 | 73 | 0.96 of 1950 | template=Standard c=0.97 n=102 | structure | yes | CANDIDATE |
| 3499 | body | SUBSTITUTED | `div.icon.ratio.ratio-16x9.videoSection` | `iframe.embed-responsive-item` | `iframe` | 201 | 71 | 0.21 of 1950 | series=PES10 c=0.68 n=35 | structure | yes | CANDIDATE |
| 3503 | body | EXTRA | `div.row` | `—` | `div.col-12` | 106 | 63 | 0.84 of 1950 | ptype=lesson c=0.86 n=85 | structure | — | CANDIDATE |
| 3504 | body | EXTRA | `div.col-12.col-md-8` | `—` | `audio.audioPlayer.icon` | 108 | 62 | 0.99 of 1950 | subject+ptype=Leaving to Learn/lesson c=1.00 n=25 | structure | yes | CANDIDATE |
| 3505 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p>i` | 87 | 62 | 0.98 of 1950 | subject=NCEA1 c=0.99 n=22 | structure | — | CANDIDATE |
| 3506 | body | EXTRA | `div.col-12.col-md-8` | `—` | `ol` | 82 | 62 | 0.99 of 1950 | ptype=overview c=0.99 n=22 | structure | — | CANDIDATE |
| 3508 | body | EXTRA | `table.table.table-bordered` | `—` | `tr` | 86 | 61 | 0.98 of 1950 | template=Standard c=0.99 n=73 | structure | yes | CANDIDATE |
| 3514 | body | SUBSTITUTED | `div#body` | `div.row` | `WIDGET` | 69 | 55 | 0.94 of 1950 | subject=Online Safety (OS9000) c=1.00 n=25 | structure | — | CANDIDATE |
| 3520 | body | MOVED | `div.col-12.col-md-8` | `h3` | `h3` | 65 | 54 | 0.10 of 1950 | template=Fundamentals c=0.67 n=20 | structure | — | CANDIDATE |
| 3521 | body | SUBSTITUTED | `div.row` | `div.col-12.col-md-8` | `div.col-12.col-md-8` | 60 | 52 | 0.98 of 1950 | ptype=lesson c=0.99 n=34 | structure | — | CANDIDATE |
| 3524 | body | EXTRA | `ul` | `—` | `li` | 61 | 50 | 0.93 of 1950 | template=Standard c=0.94 n=44 | structure | — | CANDIDATE |
| 3526 | body | EXTRA | `a` | `—` | `div.externalButton` | 73 | 49 | 0.92 of 1950 | template=Standard c=0.93 n=64 | structure | — | CANDIDATE |
| 3527 | body | EXTRA | `p>a` | `—` | `a` | 61 | 49 | 0.99 of 1950 | template=Standard c=1.00 n=48 | structure | — | CANDIDATE |
| 3528 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `div.activity[number=*]` | 55 | 49 | 0.85 of 1950 | template+ptype=Standard/lesson c=0.85 n=48 | structure | yes | CANDIDATE |
| 3530 | body | EXTRA | `div.col-12.col-md-8` | `—` | `h4` | 56 | 48 | 0.94 of 1950 | template=Standard c=0.95 n=30 | structure | — | CANDIDATE |
| 3531 | body | EXTRA | `div.col-12` | `—` | `p` | 78 | 45 | 0.92 of 1950 | template=Standard c=0.94 n=69 | structure | — | CANDIDATE |
| 3535 | body | EXTRA | `tr` | `—` | `td` | 51 | 45 | 0.95 of 1950 | template=Standard c=0.95 n=44 | structure | — | CANDIDATE |
| 3537 | body | EXTRA | `div.fundamentalsPanel` | `—` | `div.row` | 44 | 44 | 0.99 of 1950 | era=Refresh c=0.99 n=44 | structure | — | CANDIDATE |
| 3539 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.icon.ratio.ratio-16x9.videoSection` | 60 | 42 | 0.91 of 1950 | template=Standard c=0.93 n=52 | structure | yes | CANDIDATE |
| 3540 | body | EXTRA | `div.alert` | `—` | `div.row` | 55 | 42 | 0.91 of 1950 | template=Standard c=0.92 n=40 | structure | — | CANDIDATE |
| 3543 | body | EXTRA | `div.ratio.ratio-16x9.videoSection` | `—` | `iframe` | 52 | 40 | 0.78 of 1950 | ptype=lesson c=0.81 n=39 | structure | yes | CANDIDATE |
| 3546 | body | EXTRA | `div.row` | `—` | `div.col-12.col-md-6` | 57 | 39 | 0.99 of 1950 | subject=Online Safety (OS9000) c=1.00 n=20 | structure | — | CANDIDATE |
| 3547 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `p` | 53 | 39 | 0.85 of 1950 | template+ptype=Standard/lesson c=0.85 n=39 | structure | — | CANDIDATE |
| 3550 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.alert` | 51 | 37 | 0.91 of 1950 | template=Standard c=0.92 n=41 | structure | — | CANDIDATE |
| 3552 | body | EXTRA | `p` | `—` | `i` | 43 | 37 | 0.97 of 1950 | template=Standard c=0.97 n=39 | structure | — | CANDIDATE |
| 3559 | body | SUBSTITUTED | `div.row` | `div.col-12.col-md-8` | `WIDGET` | 36 | 35 | 0.98 of 1950 | ptype=lesson c=0.99 n=31 | structure | — | CANDIDATE |
| 3565 | body | EXTRA | `div#body` | `—` | `div.row.supervisor` | 43 | 33 | 0.88 of 1950 | ptype=lesson c=0.89 n=38 | structure | yes | CANDIDATE |
| 3568 | body | EXTRA | `tr` | `—` | `th` | 35 | 32 | 0.99 of 1950 | template=Standard c=1.00 n=29 | structure | — | CANDIDATE |
| 3569 | body | MISSING | `div#body` | `div.fundamentalsPanel` | `—` | 32 | 32 | 0.02 of 1950 | template+ptype=Fundamentals/overview c=0.87 n=31 | 1.00 | yes | CANDIDATE |
| 3570 | body | EXTRA | `div#body` | `—` | `WIDGET` | 47 | 31 | 0.94 of 1950 | era=Refresh c=0.94 n=47 | structure | — | CANDIDATE |
| 3574 | body | EXTRA | `div.icon.ratio.ratio-16x9.videoSection` | `—` | `iframe` | 36 | 29 | 0.97 of 1950 | ptype=lesson c=0.98 n=30 | structure | yes | CANDIDATE |
| 3576 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `WIDGET` | 30 | 29 | 0.85 of 1950 | template=Standard c=0.85 n=20 | structure | — | CANDIDATE |
| 3579 | body | EXTRA | `div.col-12.col-md-8` | `—` | `h4.goJournal` | 35 | 28 | 1.00 of 1950 | era=Refresh c=1.00 n=35 | structure | — | CANDIDATE |
| 3580 | body | EXTRA | `div.row` | `—` | `div.col-12.col-md-4.offset-md-0` | 28 | 28 | 0.79 of 1950 | era=Refresh c=0.79 n=28 | structure | — | CANDIDATE |
| 3581 | body | EXTRA | `div#body` | `—` | `div.fundamentalsPanel` | 28 | 28 | 0.98 of 1950 | era=Refresh c=0.98 n=28 | structure | yes | CANDIDATE |
| 3582 | body | EXTRA | `div.inquiryPanel` | `—` | `div.row` | 28 | 27 | 0.99 of 1950 | era=Refresh c=0.99 n=28 | structure | — | CANDIDATE |
| 3587 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p>span.infoTrigger` | 29 | 26 | 0.86 of 1950 | template=Standard c=0.87 n=24 | structure | — | CANDIDATE |
| 3589 | body | SUBSTITUTED | `div.row` | `div.col-12.col-md-8` | `div.row` | 27 | 26 | 0.98 of 1950 | era=Refresh c=0.98 n=27 | structure | — | CANDIDATE |
| 3591 | body | EXTRA | `div.alert.solid` | `—` | `div.row` | 35 | 25 | 0.99 of 1950 | template=Standard c=0.99 n=30 | structure | yes | CANDIDATE |
| 3594 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.flipCardsContainer.row` | 28 | 25 | 0.93 of 1950 | template=Standard c=0.94 n=24 | structure | — | CANDIDATE |
| 3603 | body | EXTRA | `div.row` | `—` | `div.col-12.col-md-4` | 29 | 22 | 0.95 of 1950 | template=Standard c=0.95 n=24 | structure | — | CANDIDATE |
| 3607 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `img.img-fluid` | 22 | 22 | 0.85 of 1950 | era=Refresh c=0.85 n=22 | structure | — | CANDIDATE |
| 3612 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.clickDropContent` | 25 | 21 | 0.95 of 1950 | template=Standard c=0.95 n=22 | structure | — | CANDIDATE |
| 3613 | body | SUBSTITUTED | `div.row` | `div.col-12.col-md-8` | `div.col-12.col-md-6` | 24 | 21 | 0.98 of 1950 | ptype=lesson c=0.99 n=20 | structure | — | CANDIDATE |
| 3619 | body | EXTRA | `div#body` | `—` | `div.inquiryPanel` | 20 | 20 | 0.98 of 1950 | era=Refresh c=0.98 n=20 | structure | — | CANDIDATE |
| 3625 | body | EXTRA | `div.col-12.col-md-8` | `—` | `h5` | 20 | 19 | 1.00 of 1950 | era=Refresh c=1.00 n=20 | structure | — | CANDIDATE |
| 3626 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `div.activity.interactive[number=*]` | 20 | 19 | 0.85 of 1950 | era=Refresh c=0.85 n=20 | structure | yes | CANDIDATE |
| 3631 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `div.alert` | 25 | 18 | 0.85 of 1950 | era=Refresh c=0.85 n=25 | structure | — | CANDIDATE |
| 3632 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.alert.solid` | 23 | 18 | 0.99 of 1950 | era=Refresh c=0.99 n=23 | structure | yes | CANDIDATE |
| 3650 | body | SUBSTITUTED | `div#body` | `div.row` | `div.table-responsive` | 22 | 16 | 0.94 of 1950 | ptype=lesson c=0.98 n=20 | structure | — | CANDIDATE |
| 3671 | body | MISSING | `div#body` | `div.clickDropContent.noBorder.row` | `—` | 49 | 14 | 0.03 of 1950 | series=XDLS90 c=0.64 n=38 | 0.94 | yes | CANDIDATE |
| 3687 | body | EXTRA | `div.col-12.col-md-6` | `—` | `p` | 20 | 13 | 1.00 of 1950 | era=Refresh c=1.00 n=20 | structure | — | CANDIDATE |
| 4056 | body | SUBSTITUTED | `div.col-12.col-md-8` | `div.alert` | `div.activity.clickDropContent.dropbox[number=*]` | 20 | 4 | 0.30 of 1950 | series=XDLS90 c=0.80 n=20 | structure | yes | CANDIDATE |
| 7931 | root | EXTRA | `body.container-fluid` | `—` | `div.row` | 233 | 233 | 0.87 of 1956 | subject+ptype=NCEA1/overview c=0.98 n=41 | structure | — | CANDIDATE |
| 7936 | root | SUBSTITUTED | `#root` | `body` | `body.container-fluid` | 94 | 10 | 0.05 of 1956 | series=CEDO50 c=1.00 n=25 | structure | yes | CANDIDATE |
