#!/usr/bin/env python3
"""r401 skeleton delta: r400 -> r401 (_sk_final.json), movers named, bucket crossings, outside-affected check."""
import json
a = json.load(open('_s27_r400_sk_final.json')); b = json.load(open('_s27_r401_sk_final.json'))
aff = set(l.strip() for l in open('_s27_r401_affected.txt') if l.strip())
