/** _s26_r395_probe.cjs — ROUND 395 in-memory A/B probe (unchanged mechanics; toggle FLIPCOL_OFF). Converts each module exactly as batch_convert.cjs
 ...
 *    FLIPCOL_OFF=1 STUB_OEMBED=1 node --require ./_deflate_raw_polyfill.cjs ../../outputs/_s26_r395_probe.cjs CODES…   (expect: all identical)
 *    STUB_OEMBED=1 node --require ./_deflate_raw_polyfill.cjs ../../outputs/_s26_r395_probe.cjs CODES…                     (the round's diffs)
