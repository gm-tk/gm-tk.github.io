...
inner row's own class and its first child's class, Claude vs gold, corpus-wide (live body). python3 _s26_r394_colrow.py"""
import os, sys, re
...
def col8(cls): t = set(cls.split()); return "col-md-8" in t and "col-12" in t and len(t) == 2
def scan(s):
    st = []; out = []
...
print("==== a div.row DIRECTLY inside the col-md-8 text column: (inner row's class, its first child) ====")
