...
Generated 2026-09-26 16:24 by `outputs/_placement_census.py` over 533 modules / 2487 paired pages (`_corpus.gate_mods()`; the skeleton gate's pairing) in 82 s. A block = one h1–h6 / p / li / td / th / figcaption / dt / dd with ≥ 20 characters or ≥ 4 words; the module menu's nav labels are not blocks.
...
| 6 | `body:activity` | `body:free` | 2855 | 614 | 321 | FRFUN (0.37, 38, 3) | Standard 1821, Bilingual 697, Fundamentals 274 | floor ok |
...
| 9 | `body:activity` | `ABSENT-inWT` | 2340 | 728 | 324 | PWY (0.50, 137, 5) | Standard 1779, Fundamentals 324, Bilingual 162 | floor ok |
| 10 | `body:free` | `ABSENT-inWT` | 2335 | 652 | 293 | OSOH (0.23, 110, 5) | Standard 1835, Fundamentals 418, Inquiry 52 | floor ok |
...
| 16 | `acks` | `ABSENT-inWT` | 1246 | 251 | 237 | PWY (0.29, 74, 5) | Standard 928, Inquiry 210, Fundamentals 100 | acks gate |
| 17 | `body:widget:accordion` | `ABSENT-inWT` | 1193 | 208 | 128 | XMES (0.53, 116, 3) | Standard 960, Fundamentals 218, Inquiry 13 | floor ok |
| 18 | `body:widget:accordion` | `body:free` | 1109 | 136 | 80 | TEFUN (0.74, 64, 4) | Standard 833, Fundamentals 145, Inquiry 116 | CANDIDATE |
| 19 | `body:alert` | `body:free` | 1081 | 328 | 166 | ENGC (0.50, 50, 7) | Standard 882, Fundamentals 103, Bilingual 89 | floor ok |
| 20 | `body:free` | `body:activity` | 1053 | 295 | 157 | TRR (0.15, 226, 10) | Standard 739, Bilingual 230, Fundamentals 81 | floor ok |
...
| 30 | `body:widget:tabs` | `body:free` | 646 | 70 | 57 | TEFUN (0.80, 116, 5) | Standard 496, Fundamentals 144, Inquiry 6 | CANDIDATE |
| 31 | `body:widget:carousel` | `ABSENT-inWT` | 634 | 136 | 107 | BLL (0.49, 99, 13) | Standard 550, Fundamentals 74, Inquiry 5 | floor ok |
...
| 44 | `body:widget:carousel` | `body:widget:cv2-interactive` | 477 | 85 | 68 | BLLR (0.37, 23, 3) | Standard 348, Fundamentals 97, Bilingual 29 | un-built widget (A1) |
...
| 50 | `body:panel:activity` | `body:panel:free` | 402 | 44 | 42 | CEDK (0.20, 44, 3) | Inquiry 392, Standard 10 | floor ok |
...
| 72 | `body:panel:free` | `ABSENT-inWT` | 209 | 41 | 38 | CEDO (0.11, 24, 4) | Inquiry 178, Standard 31 | floor ok |
...
| 75 | `body:widget:speechBubble` | `body:widget:cv2-interactive` | 200 | 92 | 60 | XDLS (0.26, 47, 5) | Standard 173, Fundamentals 20, Bilingual 4 | un-built widget (A1) |
...
| 78 | `body:widget:speechBubble` | `ABSENT-notWT` | 188 | 70 | 51 | XOTPB (1.00, 6, 6) | Standard 113, Fundamentals 44, Bilingual 19 | not derivable |
| 79 | `body:widget:typing` | `ABSENT-inWT` | 182 | 51 | 39 | MXEO (0.23, 20, 4) | Standard 154, Fundamentals 28 | floor ok |
| 80 | `body:free` | `body:alert` | 181 | 77 | 42 | HIS (0.02, 28, 4) | Standard 165, Fundamentals 15, Inquiry 1 | floor ok |
| 81 | `body:alert:side` | `body:alert` | 181 | 90 | 53 | ENGJ (0.40, 6, 3) | Standard 157, Fundamentals 18, Inquiry 6 | floor ok |
| 82 | `body:alert:side` | `ABSENT-notWT` | 173 | 90 | 59 | MXEX (0.50, 9, 3) | Standard 126, Fundamentals 29, Bilingual 17 | not derivable |
| 83 | `body:activity` | `body:alert` | 170 | 53 | 34 | ANZH (0.08, 49, 3) | Standard 164, Fundamentals 3, Bilingual 2 | floor ok |
| 84 | `header:other` | `OTHER-PAGE` | 169 | 140 | 46 | ANZH (0.22, 22, 4) | Standard 158, Bilingual 9, Inquiry 2 | floor ok |
| 85 | `menu:Information` | `menu:Overview` | 168 | 16 | 16 | MXDI (0.33, 28, 3) | Standard 151, Bilingual 17 | floor ok |
| 86 | `body:free` | `body:widget:carousel` | 167 | 39 | 36 | AGH (0.02, 23, 3) | Standard 132, Fundamentals 35 | floor ok |
...
| 89 | `menu:Overview` | `ABSENT-inWT` | 162 | 81 | 66 | GEO (0.11, 7, 3) | Standard 136, Fundamentals 16, Bilingual 6 | floor ok |
| 90 | `body:widget:speechBubble` | `body:free` | 159 | 86 | 53 | TEFUN (0.23, 12, 4) | Standard 114, Fundamentals 30, Bilingual 8 | floor ok |
| 91 | `body:widget:accordion` | `body:widget:carousel` | 158 | 18 | 12 |  | Standard 158 | below floor |
| 92 | `menu:Information` | `ABSENT-inWT` | 157 | 80 | 68 | OSGM (0.29, 6, 3) | Standard 151, Bilingual 4, Inquiry 2 | floor ok |
| 93 | `body:alert` | `OTHER-PAGE` | 155 | 58 | 33 | TRR (0.25, 62, 4) | Standard 93, Bilingual 62 | floor ok |
...
| 100 | `body:panel:free` | `body:panel:activity` | 130 | 27 | 27 | BLL (0.23, 28, 8) | Inquiry 130 | floor ok |
| 101 | `body:widget:hintSlider` | `body:widget:cv2-interactive` | 127 | 20 | 17 | ENFUN (0.21, 15, 3) | Standard 102, Fundamentals 25 | un-built widget (A1) |
| 102 | `body:panel:widget:accordion` | `body:panel:widget:cv2-interactive` | 127 | 11 | 11 |  | Inquiry 125, Standard 2 | un-built widget (A1) |
| 103 | `body:alert` | `body:activity` | 124 | 45 | 34 | ENGJ (0.26, 32, 4) | Standard 91, Bilingual 29, Fundamentals 4 | floor ok |
...
| 108 | `body:alert:side` | `ABSENT-inWT` | 118 | 61 | 46 | MXFU (0.50, 22, 3) | Standard 102, Fundamentals 11, Bilingual 5 | floor ok |
| 109 | `body:widget:accordion` | `body:alert` | 118 | 25 | 16 | XDLS (0.01, 8, 5) | Standard 117, Inquiry 1 | floor ok |
...
| 131 | `body:alert:side` | `body:free` | 87 | 42 | 34 | ENGI (0.17, 5, 3) | Standard 63, Fundamentals 18, Bilingual 6 | floor ok |
...
| 135 | `body:widget:multiChoiceQuiz` | `OTHER-PAGE` | 84 | 12 | 10 |  | Standard 64, Bilingual 20 | below floor |
...
| 137 | `body:alert:side` | `body:activity` | 79 | 36 | 20 | TRR (0.48, 29, 3) | Standard 49, Bilingual 29, Fundamentals 1 | floor ok |
| 138 | `body:free:side` | `ABSENT-inWT` | 78 | 30 | 29 |  | Standard 75, Fundamentals 2, Inquiry 1 | floor ok |
| 139 | `menu:Standards` | `ABSENT-inWT` | 78 | 53 | 46 | XDLS (0.34, 20, 8) | Standard 68, Inquiry 10 | floor ok |
| 140 | `body:alert` | `body:alert:side` | 78 | 42 | 28 | BLL (0.13, 4, 4) | Standard 63, Fundamentals 15 | floor ok |
| 141 | `body:panel:widget:carousel` | `ABSENT-inWT` | 76 | 12 | 12 | BLL (0.86, 42, 3) | Inquiry 71, Standard 5 | below floor |
| 142 | `body:widget:hintSlider` | `ABSENT-notWT` | 75 | 16 | 14 |  | Standard 56, Fundamentals 19 | not derivable |
| 143 | `body:widget:wordSelect` | `body:activity` | 75 | 21 | 20 | WJFUN (0.61, 33, 5) | Fundamentals 36, Standard 35, Bilingual 4 | CANDIDATE |
| 144 | `body:widget:dropQuiz` | `body:free` | 74 | 10 | 10 |  | Fundamentals 41, Standard 23, Bilingual 10 | below floor |
| 145 | `body:panel:widget:flipCard` | `ABSENT-inWT` | 73 | 7 | 7 | TWHA (0.16, 33, 4) | Inquiry 73 | below floor |
...
| `body:activity` | `body:free` | 325 | 197 | 133 | AGH1001 AGH1001_3_0.html <h3>→<h3> “Self Check: True or False”; AGH1004 AGH1004_1_0.html <h3>→<h3> “Knowledge self-check”; AGH1004 AGH1004_2_0.html <h3>→<h3> “Reflective questions” |
...
| `body:free` | `ABSENT-inWT` | 294 | 184 | 132 | AGH1001 AGH1001_0_0.html <h3>→<—> “An introduction to agricultural and horticultural ”; AGH1002 AGH1002_3_0.html <h4>→<—> “C = carbon, H = Hydrogen, O = Oxygen”; AGH1005 AGH1005_6_0.html <h4>→<—> “Mycorrhizal associations” |
...
| `body:widget:accordion` | `body:free` | 129 | 53 | 39 | AGH1004 AGH1004_2_0.html <h4>→<h4> “Semi-intensive Farming”; AGH1004 AGH1004_2_0.html <h4>→<h4> “Semi-extensive Farming”; AGH1006 AGH1006_6_0.html <h4>→<h3> “Integrated weed management” |
...
| `body:alert` | `body:free` | 89 | 72 | 49 | AGH1003 AGH1003_5_0.html <h4>→<p> “Why is it important to add lime before fertiliser ”; AGH1009 AGH1009_4_0.html <h4>→<p> “A note on sprays”; ANZH103 ANZH103_1_0.html <h3>→<h3> “What happened after the Treaty was signed on 6 Feb” |
...
| `body:widget:tabs` | `body:free` | 34 | 15 | 15 | AGH1001 AGH1001_2_0.html <h5>→<p> “Farm Advisor – Ash Phillips, Wairoa New Zealand”; ANZH203 ANZH203_6_0.html <h4>→<p> “Thomas Brunner: Surveyor and Explorer”; ENGC403 ENGC403_12_0.html <h4>→<h5> “Oral presentation part” |
...
| `body:widget:carousel` | `body:widget:flipCard` | 18 | 2 | 2 | CEDR501 CEDR501_3_0.html <h4>→<h4> “To summarise information”; CEDR501 CEDR501_3_0.html <h4>→<h4> “To record new information”; CEDR501 CEDR501_3_0.html <h4>→<h4> “To revise information” |
...
|---|---:|---:|---:|---:|
| `body:free` | 24036 | 20229 | 3807 | 0.842 |
| `body:activity` | 18254 | 12247 | 6007 | 0.671 |
...
| `body:panel:alert` | 165 | 103 | 62 | 0.624 |
...
|---|---:|---:|---:|---:|---:|
| `body:free` | 24036 | 863 | 0.036 | 372 | 213 |
| `body:activity` | 18254 | 811 | 0.044 | 339 | 184 |
...
| `body:alert` | 3630 | 186 | 0.051 | 119 | 77 |
...
| `body:panel:free` | 3050 | 133 | 0.044 | 29 | 26 |
...
|---|---:|---:|---|---|
| `h4:go to your journal` | 42 | 83 | XGF 24, CEDK 20, CEDR 16, HES 16 | ANZH301 ANZH301_1_0.html: “Go to your journal” before “Māori involvement in the war effort also had anoth” |
...
### `body:activity` → `body:free` — 2855 blocks / 614 pages / 321 modules
families: TRR 556, XGF 239, BLL 150, XDLS 137, TEDC 130, PMT 121, HIS 119, WJFUN 62
...
### `body:activity` → `ABSENT-inWT` — 2340 blocks / 728 pages / 324 modules
families: TEDC 221, ENGS 138, PWY 137, BLL 117, WJFUN 91, TRR 83, XDLS 83, XMES 81
...
### `body:free` → `ABSENT-inWT` — 2335 blocks / 652 pages / 293 modules
...
### `body:widget:accordion` → `body:free` — 1109 blocks / 136 pages / 80 modules
families: XGF 128, ENGFUN 89, MXFL 86, TEFUN 64, XDLS 57, ENGJ 48, AGH 46, PES 41
...
### `body:alert` → `body:free` — 1081 blocks / 328 pages / 166 modules
families: HIS 79, TRR 79, XGF 77, CEDO 74, ANZH 59, ENFUN 51, ENGC 50, MXFL 44
