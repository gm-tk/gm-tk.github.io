...
**Produced:** 2026-09-19 03:27 NZST by `reference/tests/_diff_miner.py` on the CURRENT corpus (pageforge-site HEAD 5a32ece; Claude corpus 416 dirs). **Population:** the skeleton gate's own — 1956 paired pages / 405 modules (compare_exclusions.txt honoured; acks / glossary / references pages excluded); parse errors skipped: 0 (must be 0); modules without a parsed WT: 2. Run time 64.1 s.
...
- differing skeleton lines: 227160 — by direction {'MISSING': 119547, 'SUBSTITUTED': 20810, 'EXTRA': 79005, 'MOVED': 7798}
- by region: {'module-code': 15, 'title': 251, 'header': 5, 'module-menu': 11990, 'phases-nav': 43, 'crumbs': 179, 'footer': 2082, 'acks': 1176, 'activity': 83383, 'body': 126629, 'root': 1407}
- classes: 8138 — CANDIDATE 178, below floor 7710, the rest below consensus / not derivable
...
| 526 | activity | MISSING | `div.col-12` | `p` | `—` | 630 | 291 | 0.31 of 1950 | subject+ptype=1-10 Blended Literacy/lesson c=0.78 n=99 | 0.80 | — | CANDIDATE |
| 527 | activity | EXTRA | `div.col-12` | `—` | `p` | 505 | 243 | 0.88 of 1950 | series=XDLS90 c=1.00 n=23 | structure | — | CANDIDATE |
...
| 533 | activity | MOVED | `div.col-12` | `p` | `p` | 252 | 151 | 0.19 of 1950 | template+ptype=Fundamentals/overview c=0.62 n=22 | structure | — | CANDIDATE |
...
| 544 | activity | EXTRA | `div.activity[number=*]` | `—` | `div.row` | 107 | 86 | 0.94 of 1950 | template=Standard c=0.96 n=84 | structure | yes | CANDIDATE |
...
| 588 | activity | SUBSTITUTED | `div.col-12` | `a` | `p` | 54 | 40 | 0.57 of 1950 | template+ptype=Standard/lesson c=0.68 n=52 | structure | — | CANDIDATE |
| 590 | activity | EXTRA | `div.col-12.col-md-8` | `—` | `div.activity[number=*]` | 41 | 39 | 0.95 of 1950 | template=Standard c=0.98 n=29 | structure | yes | CANDIDATE |
...
| 612 | activity | EXTRA | `div.activity` | `—` | `div.row` | 45 | 29 | 1.00 of 1950 | era=Refresh c=1.00 n=45 | structure | yes | CANDIDATE |
...
| 635 | activity | EXTRA | `div.col-12` | `—` | `div.icon.ratio.ratio-16x9.videoSection` | 37 | 23 | 0.97 of 1950 | template=Standard c=0.98 n=30 | structure | yes | CANDIDATE |
...
| 654 | activity | EXTRA | `div.col-12.col-md-8` | `—` | `div.activity` | 24 | 19 | 1.00 of 1950 | era=Refresh c=1.00 n=24 | structure | yes | CANDIDATE |
| 660 | activity | SUBSTITUTED | `div.row` | `div.col-12` | `div.row` | 20 | 19 | 0.79 of 1950 | era=Refresh c=0.79 n=20 | structure | — | CANDIDATE |
...
| 3519 | body | EXTRA | `div#body` | `—` | `div.row` | 1193 | 322 | 0.73 of 1950 | subject+ptype=1-10 Blended Literacy/overview c=1.00 n=29 | structure | — | CANDIDATE |
...
| 3522 | body | MISSING | `div.col-12.col-md-8` | `p` | `—` | 499 | 235 | 0.29 of 1950 | template+ptype=Fundamentals/overview c=0.93 n=32 | 0.82 | — | CANDIDATE |
| 3523 | body | EXTRA | `div.col-12.col-md-8` | `—` | `img.img-fluid` | 438 | 190 | 0.97 of 1950 | template+ptype=Standard/overview c=1.00 n=24 | structure | — | CANDIDATE |
| 3524 | body | EXTRA | `div.col-12.col-md-8` | `—` | `WIDGET` | 271 | 176 | 0.89 of 1950 | subject=NCEA1 c=0.96 n=23 | structure | — | CANDIDATE |
| 3525 | body | MOVED | `div.col-12.col-md-8` | `p` | `p` | 270 | 175 | 0.18 of 1950 | template+ptype=Fundamentals/overview c=0.87 n=33 | structure | — | CANDIDATE |
| 3526 | body | SUBSTITUTED | `div.row` | `div.col-12` | `div.col-12.col-md-8` | 290 | 163 | 0.55 of 1950 | subject+ptype=1-10 Blended Literacy/overview c=0.99 n=64 | structure | — | CANDIDATE |
| 3527 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p>b` | 257 | 156 | 0.95 of 1950 | subject=1-10 Blended Literacy c=1.00 n=37 | structure | — | CANDIDATE |
...
| 3532 | body | EXTRA | `div.col-12.col-md-8` | `—` | `ul` | 236 | 129 | 0.96 of 1950 | subject=1-10 English c=0.99 n=24 | structure | — | CANDIDATE |
| 3537 | body | EXTRA | `div.col-12.col-md-8` | `—` | `a` | 184 | 108 | 0.98 of 1950 | subject=ConnectED c=1.00 n=32 | structure | — | CANDIDATE |
| 3538 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.ratio.ratio-16x9.videoSection` | 179 | 106 | 0.94 of 1950 | subject=1-10 English c=0.97 n=33 | structure | yes | CANDIDATE |
...
| 3546 | body | EXTRA | `a` | `—` | `div.button` | 147 | 84 | 0.97 of 1950 | subject+ptype=NCEA1/lesson c=0.98 n=20 | structure | — | CANDIDATE |
| 3547 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p>a` | 117 | 83 | 0.99 of 1950 | template=Standard c=0.99 n=94 | structure | — | CANDIDATE |
...
| 3566 | body | EXTRA | `table.table.table-bordered` | `—` | `tr` | 85 | 61 | 0.98 of 1950 | template=Standard c=0.99 n=72 | structure | yes | CANDIDATE |
| 3567 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p>i` | 85 | 61 | 0.98 of 1950 | subject=NCEA1 c=0.99 n=21 | structure | — | CANDIDATE |
| 3568 | body | EXTRA | `div.col-12.col-md-8` | `—` | `ol` | 80 | 61 | 0.99 of 1950 | ptype=overview c=0.99 n=22 | structure | — | CANDIDATE |
| 3571 | body | EXTRA | `div.ratio.ratio-16x9.videoSection` | `—` | `iframe` | 77 | 58 | 0.93 of 1950 | subject=1-10 Mathematics c=0.95 n=28 | structure | yes | CANDIDATE |
| 3572 | body | MOVED | `div.col-12.col-md-8` | `h3` | `h3` | 69 | 57 | 0.10 of 1950 | template=Fundamentals c=0.67 n=20 | structure | — | CANDIDATE |
| 3578 | body | EXTRA | `ul` | `—` | `li` | 65 | 54 | 0.94 of 1950 | template=Standard c=0.96 n=48 | structure | — | CANDIDATE |
| 3580 | body | SUBSTITUTED | `div#body` | `div.row` | `WIDGET` | 65 | 52 | 0.94 of 1950 | template+ptype=Standard/lesson c=0.98 n=57 | structure | — | CANDIDATE |
| 3581 | body | SUBSTITUTED | `div.row` | `div.col-12.col-md-8` | `div.col-12.col-md-8` | 59 | 52 | 0.98 of 1950 | ptype=lesson c=0.99 n=32 | structure | — | CANDIDATE |
| 3582 | body | EXTRA | `p>a` | `—` | `a` | 65 | 51 | 0.99 of 1950 | template=Standard c=1.00 n=51 | structure | — | CANDIDATE |
| 3588 | body | EXTRA | `div.col-12.col-md-8` | `—` | `h4` | 53 | 47 | 0.96 of 1950 | template=Standard c=0.98 n=26 | structure | — | CANDIDATE |
| 3589 | body | EXTRA | `tr` | `—` | `td` | 52 | 46 | 0.95 of 1950 | template=Standard c=0.95 n=45 | structure | — | CANDIDATE |
...
| 3600 | body | EXTRA | `a` | `—` | `div.externalButton` | 59 | 39 | 0.92 of 1950 | template=Standard c=0.93 n=53 | structure | — | CANDIDATE |
| 3601 | body | EXTRA | `div.row` | `—` | `div.col-12.col-md-6` | 56 | 39 | 0.99 of 1950 | subject=Online Safety (OS9000) c=1.00 n=20 | structure | — | CANDIDATE |
| 3602 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `p` | 54 | 39 | 0.85 of 1950 | template+ptype=Standard/lesson c=0.85 n=38 | structure | — | CANDIDATE |
| 3603 | body | EXTRA | `div.alert` | `—` | `div.row` | 53 | 39 | 0.91 of 1950 | template=Standard c=0.92 n=38 | structure | — | CANDIDATE |
| 3608 | body | EXTRA | `div#body` | `—` | `div.row.supervisor` | 48 | 37 | 0.88 of 1950 | ptype=lesson c=0.89 n=43 | structure | yes | CANDIDATE |
| 3609 | body | EXTRA | `p` | `—` | `i` | 43 | 37 | 0.97 of 1950 | template=Standard c=0.97 n=39 | structure | — | CANDIDATE |
| 3614 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.alert` | 49 | 35 | 0.91 of 1950 | template=Standard c=0.92 n=39 | structure | — | CANDIDATE |
| 3620 | body | SUBSTITUTED | `div.row` | `div.col-12.col-md-8` | `WIDGET` | 34 | 33 | 0.98 of 1950 | ptype=lesson c=0.99 n=28 | structure | — | CANDIDATE |
| 3624 | body | MISSING | `div#body` | `div.fundamentalsPanel` | `—` | 32 | 32 | 0.02 of 1950 | template+ptype=Fundamentals/overview c=0.87 n=31 | 1.00 | yes | CANDIDATE |
| 3625 | body | EXTRA | `div#body` | `—` | `WIDGET` | 48 | 31 | 0.94 of 1950 | era=Refresh c=0.94 n=48 | structure | — | CANDIDATE |
...
| 3635 | body | SUBSTITUTED | `div.row` | `div.col-12.col-md-8` | `div.row` | 29 | 27 | 0.98 of 1950 | era=Refresh c=0.98 n=29 | structure | — | CANDIDATE |
| 3636 | body | EXTRA | `div.inquiryPanel` | `—` | `div.row` | 28 | 27 | 0.99 of 1950 | era=Refresh c=0.99 n=28 | structure | — | CANDIDATE |
| 3637 | body | EXTRA | `div#body` | `—` | `div.fundamentalsPanel` | 27 | 27 | 0.98 of 1950 | era=Refresh c=0.98 n=27 | structure | yes | CANDIDATE |
| 3640 | body | EXTRA | `div.alert.solid` | `—` | `div.row` | 35 | 26 | 0.99 of 1950 | template=Standard c=0.99 n=30 | structure | yes | CANDIDATE |
| 3644 | body | EXTRA | `tr` | `—` | `th` | 28 | 26 | 0.99 of 1950 | template=Standard c=1.00 n=23 | structure | — | CANDIDATE |
| 3645 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `WIDGET` | 27 | 26 | 0.85 of 1950 | era=Refresh c=0.85 n=27 | structure | — | CANDIDATE |
| 3646 | body | EXTRA | `div.row` | `—` | `div.col-12.col-md-4.offset-md-0` | 26 | 26 | 0.79 of 1950 | era=Refresh c=0.79 n=26 | structure | — | CANDIDATE |
| 3649 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p>span.infoTrigger` | 29 | 25 | 0.86 of 1950 | template=Standard c=0.87 n=24 | structure | — | CANDIDATE |
| 3654 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.flipCardsContainer.row` | 29 | 24 | 0.93 of 1950 | template=Standard c=0.94 n=26 | structure | — | CANDIDATE |
| 3664 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `img.img-fluid` | 22 | 22 | 0.85 of 1950 | era=Refresh c=0.85 n=22 | structure | — | CANDIDATE |
| 3668 | body | EXTRA | `div.row` | `—` | `div.col-12.col-md-4` | 28 | 21 | 0.95 of 1950 | template=Standard c=0.95 n=24 | structure | — | CANDIDATE |
...
| 3677 | body | EXTRA | `div.icon.ratio.ratio-16x9.videoSection` | `—` | `iframe` | 24 | 20 | 0.97 of 1950 | era=Refresh c=0.97 n=24 | structure | yes | CANDIDATE |
| 3678 | body | EXTRA | `div.col-12.col-md-8` | `—` | `h5` | 22 | 20 | 1.00 of 1950 | era=Refresh c=1.00 n=22 | structure | — | CANDIDATE |
...
| 3684 | body | EXTRA | `div.clickDropContent` | `—` | `p` | 21 | 19 | 0.96 of 1950 | era=Refresh c=0.96 n=21 | structure | — | CANDIDATE |
| 3686 | body | EXTRA | `div.flipCardsContainer.row` | `—` | `div.col-12.col-md-4.paddingLR` | 20 | 19 | 0.97 of 1950 | era=Refresh c=0.97 n=20 | structure | — | CANDIDATE |
| 3687 | body | EXTRA | `div.row` | `—` | `div.clickDropContent` | 20 | 19 | 1.00 of 1950 | era=Refresh c=1.00 n=20 | structure | — | CANDIDATE |
...
| 3699 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.row` | 20 | 18 | 0.75 of 1950 | era=Refresh c=0.75 n=20 | structure | — | CANDIDATE |
| 3716 | body | SUBSTITUTED | `div#body` | `div.row` | `div.table-responsive` | 22 | 16 | 0.94 of 1950 | ptype=lesson c=0.98 n=20 | structure | — | CANDIDATE |
| 3725 | body | EXTRA | `th>b` | `—` | `b` | 20 | 15 | 1.00 of 1950 | era=Refresh c=1.00 n=20 | structure | — | CANDIDATE |
| 3735 | body | MISSING | `div#body` | `div.clickDropContent.noBorder.row` | `—` | 49 | 14 | 0.03 of 1950 | series=XDLS90 c=0.64 n=38 | 0.94 | yes | CANDIDATE |
| 8071 | root | EXTRA | `body.container-fluid` | `—` | `div.row` | 233 | 233 | 0.87 of 1956 | subject+ptype=NCEA1/overview c=0.98 n=41 | structure | — | CANDIDATE |
| 8076 | root | SUBSTITUTED | `#root` | `body` | `body.container-fluid` | 94 | 10 | 0.05 of 1956 | series=CEDO50 c=1.00 n=25 | structure | yes | CANDIDATE |
