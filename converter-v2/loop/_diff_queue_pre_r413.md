...
**Produced:** 2026-09-20 16:11 NZST by `reference/tests/_diff_miner.py` on the CURRENT corpus (pageforge-site HEAD a49966a; Claude corpus 494 dirs). **Population:** the skeleton gate's own — 2349 paired pages / 483 modules (compare_exclusions.txt honoured; acks / glossary / references pages excluded); parse errors skipped: 0 (must be 0); modules without a parsed WT: 2. Run time 82.5 s.
...
- differing skeleton lines: 266327 — by direction {'MISSING': 140940, 'SUBSTITUTED': 23765, 'EXTRA': 92905, 'MOVED': 8717}
- by region: {'module-code': 15, 'title': 352, 'header': 5, 'module-menu': 13322, 'phases-nav': 108, 'crumbs': 202, 'footer': 2410, 'acks': 1310, 'activity': 95786, 'body': 151224, 'root': 1593}
- classes: 8856 — CANDIDATE 182, below floor 8391, the rest below consensus / not derivable
...
| 584 | activity | MISSING | `div.col-12` | `h3` | `—` | 391 | 194 | 0.31 of 2342 | template+ptype=Fundamentals/overview c=0.85 n=32 | 0.69 | — | CANDIDATE |
| 585 | activity | EXTRA | `div.col-12` | `—` | `WIDGET` | 319 | 193 | 0.82 of 2342 | subject=NCEA1 c=0.94 n=32 | structure | — | CANDIDATE |
...
| 589 | activity | MISSING | `div.activity.interactive[number=*]` | `div.row` | `—` | 267 | 154 | 0.12 of 2342 | template+ptype=Fundamentals/overview c=0.65 n=34 | 0.92 | yes | CANDIDATE |
...
| 603 | activity | SUBSTITUTED | `div.col-12` | `p` | `p` | 111 | 85 | 0.75 of 2342 | template+ptype=Standard/lesson c=0.88 n=72 | structure | — | CANDIDATE |
...
| 627 | activity | SUBSTITUTED | `div.col-12` | `p` | `WIDGET` | 67 | 57 | 0.75 of 2342 | template+ptype=Standard/lesson c=0.88 n=48 | structure | — | CANDIDATE |
...
| 676 | activity | EXTRA | `div.col-12` | `—` | `div.activity.interactive[number=*]` | 33 | 30 | 0.89 of 2342 | era=Refresh c=0.89 n=33 | structure | yes | CANDIDATE |
| 677 | activity | EXTRA | `div.col-12` | `—` | `audio.audioPlayer.icon` | 44 | 29 | 1.00 of 2342 | subject=1-10 Blended Literacy c=1.00 n=21 | structure | yes | CANDIDATE |
| 679 | activity | SUBSTITUTED | `div.row` | `div.col-12` | `div.col-12.col-md-8` | 33 | 29 | 0.79 of 2342 | template+ptype=Standard/lesson c=0.92 n=21 | structure | — | CANDIDATE |
...
| 3682 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p` | 1054 | 386 | 0.82 of 2342 | subject+ptype=NCEA1/overview c=1.00 n=29 | structure | — | CANDIDATE |
| 3683 | body | EXTRA | `div#body` | `—` | `div.row` | 1400 | 374 | 0.73 of 2342 | subject+ptype=1-10 Blended Literacy/overview c=1.00 n=29 | structure | — | CANDIDATE |
| 3684 | body | MISSING | `div#body` | `div.row` | `—` | 1294 | 323 | 0.34 of 2342 | series=CEDO50 c=0.76 n=20 | 0.86 | — | CANDIDATE |
| 3685 | body | MISSING | `div.col-12.col-md-8` | `p` | `—` | 593 | 275 | 0.25 of 2342 | template+ptype=Fundamentals/overview c=0.91 n=44 | 0.81 | — | CANDIDATE |
| 3686 | body | EXTRA | `div.col-12.col-md-8` | `—` | `img.img-fluid` | 538 | 243 | 0.96 of 2342 | template+ptype=Standard/overview c=1.00 n=25 | structure | — | CANDIDATE |
| 3687 | body | EXTRA | `div.col-12.col-md-8` | `—` | `WIDGET` | 357 | 225 | 0.93 of 2342 | subject+ptype=NCEA1/lesson c=0.99 n=51 | structure | — | CANDIDATE |
...
| 3689 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p>b` | 321 | 193 | 0.97 of 2342 | subject=1-10 Blended Literacy c=1.00 n=41 | structure | — | CANDIDATE |
| 3690 | body | EXTRA | `div.row` | `—` | `div.col-12.col-md-8` | 282 | 193 | 0.85 of 2342 | subject+ptype=1-10 Blended Literacy/lesson c=0.96 n=22 | structure | — | CANDIDATE |
| 3691 | body | SUBSTITUTED | `div.row` | `div.col-12` | `div.col-12.col-md-8` | 316 | 181 | 0.55 of 2342 | subject+ptype=1-10 Blended Literacy/overview c=0.96 n=64 | structure | — | CANDIDATE |
| 3692 | body | EXTRA | `div.col-12.col-md-8` | `—` | `h3` | 291 | 180 | 0.89 of 2342 | template+ptype=Standard/overview c=1.00 n=33 | structure | — | CANDIDATE |
| 3693 | body | EXTRA | `div.col-12.col-md-8` | `—` | `ul` | 295 | 171 | 0.95 of 2342 | subject=1-10 Mathematics c=0.98 n=21 | structure | — | CANDIDATE |
...
| 3695 | body | MISSING | `div.row` | `div.col-12.col-md-8` | `—` | 308 | 166 | 0.29 of 2342 | template+ptype=Fundamentals/overview c=0.94 n=20 | 0.95 | — | CANDIDATE |
| 3698 | body | MISSING | `div.col-12.col-md-8` | `h3` | `—` | 224 | 145 | 0.18 of 2342 | template+ptype=Fundamentals/overview c=0.75 n=21 | 0.89 | — | CANDIDATE |
| 3699 | body | EXTRA | `div.col-12.col-md-8` | `—` | `a` | 222 | 145 | 0.98 of 2342 | subject=ConnectED c=1.00 n=28 | structure | — | CANDIDATE |
| 3702 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.table-responsive` | 165 | 115 | 0.92 of 2342 | ptype=overview c=0.95 n=20 | structure | — | CANDIDATE |
| 3703 | body | EXTRA | `p>b` | `—` | `b` | 181 | 113 | 0.94 of 2342 | subject=1-10 Mathematics c=0.97 n=32 | structure | — | CANDIDATE |
| 3705 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.ratio.ratio-16x9.videoSection` | 170 | 110 | 0.94 of 2342 | subject=NCEA1 c=0.98 n=23 | structure | yes | CANDIDATE |
| 3709 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p>a` | 162 | 108 | 0.99 of 2342 | subject=1-10 English c=1.00 n=20 | structure | — | CANDIDATE |
| 3710 | body | EXTRA | `a` | `—` | `div.button` | 172 | 104 | 0.99 of 2342 | subject=NCEA1 c=1.00 n=36 | structure | — | CANDIDATE |
| 3715 | body | EXTRA | `p` | `—` | `b` | 116 | 91 | 0.93 of 2342 | subject=NCEA1 c=0.96 n=29 | structure | — | CANDIDATE |
...
| 3719 | body | SUBSTITUTED | `div.icon.ratio.ratio-16x9.videoSection` | `iframe.embed-responsive-item` | `iframe` | 212 | 81 | 0.20 of 2342 | series=PES10 c=0.68 n=35 | structure | yes | CANDIDATE |
...
| 3726 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p>i` | 100 | 72 | 0.98 of 2342 | subject=NCEA1 c=0.99 n=26 | structure | — | CANDIDATE |
| 3730 | body | EXTRA | `div.row` | `—` | `div.col-12` | 124 | 70 | 0.71 of 2342 | subject=ANZH c=0.74 n=21 | structure | — | CANDIDATE |
| 3731 | body | EXTRA | `div.col-12.col-md-8` | `—` | `audio.audioPlayer.icon` | 125 | 69 | 1.00 of 2342 | subject=Leaving to Learn c=1.00 n=34 | structure | yes | CANDIDATE |
| 3735 | body | MOVED | `div.col-12.col-md-8` | `h3` | `h3` | 83 | 68 | 0.11 of 2342 | template+ptype=Fundamentals/overview c=0.67 n=24 | structure | — | CANDIDATE |
| 3736 | body | SUBSTITUTED | `div#body` | `div.row` | `WIDGET` | 112 | 67 | 0.94 of 2342 | subject=Online Safety (OS9000) c=1.00 n=25 | structure | — | CANDIDATE |
| 3739 | body | EXTRA | `div.fundamentalsPanel` | `—` | `div.row` | 67 | 67 | 0.98 of 2342 | era=Refresh c=0.98 n=67 | structure | — | CANDIDATE |
| 3741 | body | EXTRA | `table.table.table-bordered` | `—` | `tr` | 91 | 65 | 0.98 of 2342 | template=Standard c=0.98 n=78 | structure | yes | CANDIDATE |
| 3747 | body | EXTRA | `a` | `—` | `div.externalButton` | 86 | 60 | 0.92 of 2342 | template=Standard c=0.92 n=74 | structure | — | CANDIDATE |
| 3751 | body | EXTRA | `ul` | `—` | `li` | 72 | 59 | 0.94 of 2342 | template=Standard c=0.95 n=55 | structure | — | CANDIDATE |
| 3752 | body | SUBSTITUTED | `div.row` | `div.col-12.col-md-8` | `div.col-12.col-md-8` | 67 | 58 | 0.98 of 2342 | ptype=lesson c=0.99 n=38 | structure | — | CANDIDATE |
| 3753 | body | EXTRA | `div.col-12.col-md-8` | `—` | `h4` | 66 | 58 | 0.97 of 2342 | template=Standard c=0.98 n=31 | structure | — | CANDIDATE |
...
| 3759 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `div.activity[number=*]` | 58 | 51 | 0.85 of 2342 | template+ptype=Standard/lesson c=0.86 n=50 | structure | yes | CANDIDATE |
| 3760 | body | EXTRA | `div.alert` | `—` | `div.row` | 64 | 50 | 0.91 of 2342 | template=Standard c=0.92 n=46 | structure | — | CANDIDATE |
| 3761 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `p` | 64 | 50 | 0.85 of 2342 | template+ptype=Standard/lesson c=0.86 n=45 | structure | — | CANDIDATE |
| 3765 | body | EXTRA | `tr` | `—` | `td` | 55 | 47 | 0.94 of 2342 | template=Standard c=0.95 n=51 | structure | — | CANDIDATE |
| 3766 | body | EXTRA | `div.row` | `—` | `div.col-12.col-md-6` | 64 | 45 | 0.99 of 2342 | subject=Online Safety (OS9000) c=1.00 n=21 | structure | — | CANDIDATE |
| 3768 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.alert` | 60 | 45 | 0.91 of 2342 | template=Standard c=0.92 n=46 | structure | — | CANDIDATE |
...
| 3785 | body | EXTRA | `p` | `—` | `i` | 44 | 38 | 0.96 of 2342 | template=Standard c=0.97 n=40 | structure | — | CANDIDATE |
| 3786 | body | EXTRA | `tr` | `—` | `th` | 41 | 38 | 0.99 of 2342 | template=Standard c=1.00 n=34 | structure | — | CANDIDATE |
...
| 3805 | body | EXTRA | `div.col-12.col-md-8` | `—` | `h5` | 40 | 31 | 0.98 of 2342 | subject=NCEA1 c=0.99 n=21 | structure | — | CANDIDATE |
| 3806 | body | EXTRA | `div.col-12.col-md-8` | `—` | `h4.goJournal` | 39 | 30 | 1.00 of 2342 | era=Refresh c=1.00 n=39 | structure | — | CANDIDATE |
| 3811 | body | EXTRA | `div#body` | `—` | `div.fundamentalsPanel` | 30 | 30 | 0.98 of 2342 | era=Refresh c=0.98 n=30 | structure | yes | CANDIDATE |
| 3812 | body | EXTRA | `div.alert.solid` | `—` | `div.row` | 41 | 29 | 0.99 of 2342 | template=Standard c=0.99 n=36 | structure | yes | CANDIDATE |
| 3814 | body | EXTRA | `div.icon.ratio.ratio-16x9.videoSection` | `—` | `iframe` | 36 | 29 | 0.97 of 2342 | ptype=lesson c=0.98 n=30 | structure | yes | CANDIDATE |
| 3818 | body | EXTRA | `div.inquiryPanel` | `—` | `div.row` | 30 | 28 | 0.99 of 2342 | era=Refresh c=0.99 n=30 | structure | — | CANDIDATE |
...
| 3830 | body | EXTRA | `div.row` | `—` | `div.col-12.col-md-4` | 32 | 25 | 0.95 of 2342 | template=Standard c=0.95 n=26 | structure | — | CANDIDATE |
| 3835 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `img.img-fluid` | 26 | 25 | 0.85 of 2342 | era=Refresh c=0.85 n=26 | structure | — | CANDIDATE |
...
| 3851 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `div.activity.interactive[number=*]` | 24 | 22 | 0.85 of 2342 | template+ptype=Standard/lesson c=0.86 n=22 | structure | yes | CANDIDATE |
| 3852 | body | SUBSTITUTED | `div.row` | `div.col-12.col-md-8` | `p` | 23 | 22 | 0.98 of 2342 | era=Refresh c=0.98 n=23 | structure | — | CANDIDATE |
| 3853 | body | EXTRA | `div#body` | `—` | `div.inquiryPanel` | 29 | 21 | 0.98 of 2342 | era=Refresh c=0.98 n=29 | structure | — | CANDIDATE |
...
| 3923 | body | EXTRA | `div.col-12.col-md-6` | `—` | `p` | 23 | 14 | 1.00 of 2342 | ptype=lesson c=1.00 n=21 | structure | — | CANDIDATE |
| 4373 | body | SUBSTITUTED | `div.col-12.col-md-8` | `div.alert` | `div.activity.clickDropContent.dropbox[number=*]` | 20 | 4 | 0.31 of 2342 | series=XDLS90 c=0.80 n=20 | structure | yes | CANDIDATE |
| 8781 | root | EXTRA | `body.container-fluid` | `—` | `div.row` | 261 | 261 | 0.88 of 2349 | subject+ptype=1-10 Mathematics/overview c=0.97 n=33 | structure | — | CANDIDATE |
| 8785 | root | SUBSTITUTED | `#root` | `body` | `body.container-fluid` | 138 | 15 | 0.06 of 2349 | series=PWY10 c=1.00 n=44 | structure | yes | CANDIDATE |
