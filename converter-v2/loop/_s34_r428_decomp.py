#!/usr/bin/env python3
"""r428 — per-module decomposition of the scoped-ship delta (compare_structure matched / exact / EXTRA / missing and the skeleton
per page) for the affected set: the fast-loop baseline (outputs/_fastloop_baseline, the r427 state) vs the scoped re-score just run
...
aff = [l.strip() for l in open(O + "/_affected_r428.txt", encoding="utf-8") if l.strip()] + "ARFUN05 BLL124 BLL141 BLL252 CEDO301 CEDW303 HES1007 MXFUN02 OSSM401 PWY1008 WJFUN205 XGF9001".split()
