#!/usr/bin/env python3
"""r429 — per-module decomposition of the scoped-ship delta (compare_structure matched / exact / EXTRA / missing and the skeleton
...
aff = [l.strip() for l in open(O + "/_affected_r429.txt", encoding="utf-8") if l.strip()]
