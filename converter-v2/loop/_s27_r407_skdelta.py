#!/usr/bin/env python3
"""r407 skeleton delta: r406 -> r407 (_sk_final.json), movers named, bucket crossings, outside-affected check."""
import json
a = json.load(open('_s27_r406_sk_final.json')); b = json.load(open('_s27_r407_sk_final.json'))
aff = set(l.strip() for l in open('_s27_r407_affected.txt') if l.strip())
