...
**Produced:** 2026-09-20 21:31 NZST by `reference/tests/_diff_miner.py` on the CURRENT corpus (pageforge-site HEAD 1a7feb4; Claude corpus 494 dirs). **Population:** the skeleton gate's own — 2349 paired pages / 483 modules (compare_exclusions.txt honoured; acks / glossary / references pages excluded); parse errors skipped: 0 (must be 0); modules without a parsed WT: 2. Run time 87.5 s.
...
- differing skeleton lines: 263974 — by direction {'MISSING': 140627, 'SUBSTITUTED': 23792, 'EXTRA': 91196, 'MOVED': 8359}
- by region: {'module-code': 15, 'title': 352, 'header': 5, 'module-menu': 13322, 'phases-nav': 108, 'crumbs': 202, 'footer': 2418, 'acks': 1310, 'activity': 94203, 'body': 150446, 'root': 1593}
- classes: 8886 — CANDIDATE 182, below floor 8424, the rest below consensus / not derivable
...
| 611 | activity | EXTRA | `div.col-12` | `—` | `h3` | 98 | 78 | 0.87 of 2342 | template=Standard c=0.92 n=62 | structure | — | CANDIDATE |
...
| 621 | activity | EXTRA | `a` | `—` | `div.button` | 103 | 66 | 0.77 of 2342 | series=XDLS90 c=0.92 n=31 | structure | yes | CANDIDATE |
...
| 1036 | activity | SUBSTITUTED | `div.col-12.col-md-8` | `div.activity.dropbox[number=*]` | `div.activity.clickDropContent.dropbox[number=*]` | 21 | 4 | 0.15 of 2342 | series=XDLS90 c=0.68 n=21 | structure | yes | CANDIDATE |
| 3714 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p` | 1055 | 386 | 0.82 of 2342 | subject+ptype=NCEA1/overview c=1.00 n=29 | structure | — | CANDIDATE |
| 3715 | body | EXTRA | `div#body` | `—` | `div.row` | 1396 | 374 | 0.73 of 2342 | subject+ptype=1-10 Blended Literacy/overview c=1.00 n=29 | structure | — | CANDIDATE |
...
| 3727 | body | MISSING | `div.row` | `div.col-12.col-md-8` | `—` | 309 | 166 | 0.29 of 2342 | template+ptype=Fundamentals/overview c=0.94 n=20 | 0.94 | — | CANDIDATE |
...
| 3731 | body | EXTRA | `div.col-12.col-md-8` | `—` | `a` | 220 | 143 | 0.98 of 2342 | subject=ConnectED c=1.00 n=28 | structure | — | CANDIDATE |
...
| 3742 | body | EXTRA | `a` | `—` | `div.button` | 171 | 103 | 0.96 of 2342 | subject=NCEA1 c=0.98 n=36 | structure | — | CANDIDATE |
...
| 4050 | body | SUBSTITUTED | `div.row` | `div.col-12.col-md-8` | `div.button` | 21 | 9 | 0.98 of 2342 | ptype=lesson c=0.99 n=21 | structure | — | CANDIDATE |
| 8811 | root | EXTRA | `body.container-fluid` | `—` | `div.row` | 261 | 261 | 0.88 of 2349 | subject+ptype=1-10 Mathematics/overview c=0.97 n=33 | structure | — | CANDIDATE |
| 8815 | root | SUBSTITUTED | `#root` | `body` | `body.container-fluid` | 138 | 15 | 0.06 of 2349 | series=PWY10 c=1.00 n=44 | structure | yes | CANDIDATE |
