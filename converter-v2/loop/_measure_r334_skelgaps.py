...
Writes _r334_skelgaps.json next to itself and prints the summary.
"""
...
def main():
    ...
    json.dump(out, open(os.path.join(HERE, "_r334_skelgaps.json"), "w", encoding="utf-8"), indent=1, ensure_ascii=False)
    print("\nwrote _r334_skelgaps.json")
