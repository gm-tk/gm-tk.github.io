#!/usr/bin/env python3
"""r405 skeleton delta: r403 -> r405 (_sk_final.json), movers named, bucket crossings, outside-affected check."""
import json
a = json.load(open('_s27_r403_sk_final.json')); b = json.load(open('_s27_r405_sk_final.json'))
aff = set(l.strip() for l in open('_s27_r405_affected.txt') if l.strip())
