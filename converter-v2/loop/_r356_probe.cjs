/** _r356_probe.cjs — ROUND 356 in-memory A/B probe (the r354 probe, unchanged mechanics; toggle WIDGETMEMBERS_OFF). Converts each module exactly as batch_convert.cjs
 ...
 *    WIDGETMEMBERS_OFF=1 STUB_OEMBED=1 node --require ./_deflate_raw_polyfill.cjs ../../outputs/_r356_probe.cjs CODES…   (expect: all identical)
 *    STUB_OEMBED=1 node --require ./_deflate_raw_polyfill.cjs ../../outputs/_r356_probe.cjs CODES…                     (the round's diffs)
