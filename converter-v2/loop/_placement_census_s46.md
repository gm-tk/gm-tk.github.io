...
Generated 2026-09-25 11:40 by `outputs/_placement_census.py` over 533 modules / 2492 paired pages (`_corpus.gate_mods()`; the skeleton gate's pairing) in 83 s. A block = one h1–h6 / p / li / td / th / figcaption / dt / dd with ≥ 20 characters or ≥ 4 words; the module menu's nav labels are not blocks.
...
| 7 | `body:activity` | `body:widget:cv2-interactive` | 2672 | 708 | 334 | OSOH (0.43, 53, 5) | Standard 2029, Fundamentals 382, Bilingual 236 | floor ok |
...
| 11 | `body:free` | `body:widget:cv2-interactive` | 1731 | 373 | 215 | OSAH (0.38, 80, 3) | Standard 1437, Fundamentals 236, Bilingual 30 | floor ok |
...
| 15 | `body:widget:accordion` | `body:widget:cv2-interactive` | 1295 | 164 | 116 | HPFUN (0.28, 39, 3) | Standard 1078, Fundamentals 175, Inquiry 42 | un-built widget (A1) |
| 16 | `body:alert` | `body:free` | 1271 | 378 | 168 | BLLR (1.00, 37, 3) | Standard 1068, Fundamentals 107, Bilingual 89 | CANDIDATE |
| 17 | `acks` | `ABSENT-inWT` | 1246 | 251 | 237 | PWY (0.29, 74, 5) | Standard 928, Inquiry 210, Fundamentals 100 | acks gate |
| 18 | `body:widget:accordion` | `ABSENT-inWT` | 1207 | 209 | 129 | XMES (0.58, 128, 3) | Standard 972, Fundamentals 218, Inquiry 15 | floor ok |
...
| 31 | `body:widget:carousel` | `ABSENT-inWT` | 632 | 135 | 106 | BLL (0.49, 99, 13) | Standard 551, Fundamentals 71, Inquiry 5 | floor ok |
...
| 40 | `body:widget:carousel` | `body:widget:cv2-interactive` | 535 | 96 | 76 | BLLR (0.37, 23, 3) | Standard 403, Fundamentals 100, Bilingual 29 | un-built widget (A1) |
...
| 45 | `body:widget:accordion` | `body:activity` | 484 | 49 | 34 | BLL (0.08, 59, 11) | Standard 437, Bilingual 39, Inquiry 7 | floor ok |
...
| 67 | `body:widget:carousel` | `body:free` | 256 | 60 | 55 | TEFUN (0.36, 47, 4) | Standard 167, Fundamentals 82, Bilingual 6 | floor ok |
...
| 75 | `body:panel:free` | `body:panel:widget:cv2-interactive` | 203 | 28 | 28 | CEDR (0.18, 42, 3) | Inquiry 200, Standard 3 | floor ok |
| 76 | `body:widget:speechBubble` | `body:widget:cv2-interactive` | 202 | 93 | 61 | XDLS (0.26, 47, 5) | Standard 175, Fundamentals 20, Bilingual 4 | un-built widget (A1) |
| 77 | `body:widget:wordHighlighter` | `ABSENT-inWT` | 199 | 48 | 40 | ENGJ (0.55, 23, 5) | Standard 107, Fundamentals 92 | floor ok |
...
| 107 | `body:alert` | `body:widget:cv2-interactive` | 124 | 58 | 46 | ENGI (0.12, 10, 3) | Standard 86, Fundamentals 28, Bilingual 10 | floor ok |
...
| 135 | `body:widget:wordHighlighter` | `body:widget:cv2-interactive` | 86 | 19 | 18 | BLL (0.35, 15, 3) | Standard 45, Fundamentals 41 | un-built widget (A1) |
| 136 | `body:widget:tabs` | `body:alert` | 86 | 7 | 5 |  | Standard 86 | below floor |
| 137 | `other:free` | `body:free` | 86 | 5 | 5 |  | Standard 86 | below floor |
...
| 150 | `body:free` | `menu:flat` | 68 | 11 | 11 |  | Fundamentals 48, Standard 13, Inquiry 7 | floor ok |
...
| `body:widget:carousel` | `body:widget:cv2-interactive` | 52 | 19 | 17 | BLL271 BLL271_1_0.html <h4>→<td> “pa / ki / hi / wi”; CEDO502 CEDO502_5_0.html <h5>→<p> “Use keywords carefully”; CEDO502 CEDO502_5_0.html <h5>→<p> “Use headings and subheadings” |
...
|---|---:|---:|---:|---:|
| `body:free` | 24012 | 20138 | 3874 | 0.839 |
| `body:activity` | 18336 | 11956 | 6380 | 0.652 |
| `menu:flat` | 7743 | 7335 | 408 | 0.947 |
| `body:widget:accordion` | 6230 | 2997 | 3233 | 0.481 |
...
| `body:widget:carousel` | 2138 | 1140 | 998 | 0.533 |
...
| `body:activity` | 18336 | 840 | 0.046 | 347 | 189 |
| `menu:flat` | 7743 | 113 | 0.015 | 61 | 44 |
| `body:widget:accordion` | 6230 | 198 | 0.032 | 62 | 51 |
| `body:widget:dragAndDrop` | 4007 | 730 | 0.182 | 203 | 146 |
...
| `body:widget:carousel` | 2138 | 90 | 0.042 | 38 | 35 |
...
|---|---:|---:|
| `body:widget:dragAndDrop` · p | 723 | 146 |
| `body:free` · p | 490 | 175 |
...
### `body:activity` → `body:widget:cv2-interactive` — 2672 blocks / 708 pages / 334 modules
families: BLL 241, TRR 222, XMES 150, FRNO 143, WJFUN 127, MXDB 108, HIS 106, MXFL 103
...
### `body:free` → `body:widget:cv2-interactive` — 1731 blocks / 373 pages / 215 modules
...
### `body:widget:accordion` → `body:widget:cv2-interactive` — 1295 blocks / 164 pages / 116 modules
...
### `body:widget:accordion` → `ABSENT-inWT` — 1207 blocks / 209 pages / 129 modules
families: XMES 128, TEDC 111, CHFUN 109, AGH 63, XGF 59, BLL 58, PWY 52, ENGJ 46
