/** _s27_r400_probe.cjs — ROUND 400 in-memory A/B probe (OFF = ACTUNNUM_OFF=1; ON = the live data). Converts each module exactly as batch_convert.cjs
 ...
 *    ACTUNNUM_OFF=1 STUB_OEMBED=1 node --require ./_deflate_raw_polyfill.cjs ../../outputs/_s27_r400_probe.cjs CODES…   (expect: all identical)
 *    STUB_OEMBED=1 node --require ./_deflate_raw_polyfill.cjs ../../outputs/_s27_r400_probe.cjs CODES…                     (the round's diffs)
