#!/usr/bin/env python3
"""r392 skeleton delta: r398 -> r399 (_sk_final.json), movers named, bucket crossings, outside-affected check."""
import json
a = json.load(open('_s27_r398_sk_final.json')); b = json.load(open('_s27_r399_sk_final.json'))
aff = set(l.strip() for l in open('_s27_r399_affected.txt') if l.strip())
