/** _r361_probe.cjs — ROUND 361 in-memory A/B probe (the r354 / r356 probe, unchanged mechanics; toggle SECTIONNAV_OFF). Converts each module exactly as batch_convert.cjs
 ...
 *    SECTIONNAV_OFF=1 STUB_OEMBED=1 node --require ./_deflate_raw_polyfill.cjs ../../outputs/_r361_probe.cjs CODES…   (expect: all identical)
 *    STUB_OEMBED=1 node --require ./_deflate_raw_polyfill.cjs ../../outputs/_r361_probe.cjs CODES…                     (the round's diffs)
