/** _s27_r401_probe.cjs — ROUND 401 in-memory A/B probe (OFF = SABOXEMPTY_OFF=1; ON = the live data). Converts each module exactly as batch_convert.cjs
 ...
 *    SABOXEMPTY_OFF=1 STUB_OEMBED=1 node --require ./_deflate_raw_polyfill.cjs ../../outputs/_s27_r401_probe.cjs CODES…   (expect: all identical)
 *    STUB_OEMBED=1 node --require ./_deflate_raw_polyfill.cjs ../../outputs/_s27_r401_probe.cjs CODES…                     (the round's diffs)
