/** _s27_r402_probe.cjs — ROUND 402 in-memory A/B probe (OFF = OWNERALIAS_OFF=1; ON = the live data). Converts each module exactly as batch_convert.cjs
 ...
 *    OWNERALIAS_OFF=1 STUB_OEMBED=1 node --require ./_deflate_raw_polyfill.cjs ../../outputs/_s27_r402_probe.cjs CODES…   (expect: all identical)
 *    STUB_OEMBED=1 node --require ./_deflate_raw_polyfill.cjs ../../outputs/_s27_r402_probe.cjs CODES…                     (the round's diffs)
