#!/usr/bin/env python3
"""session 28 task 1 queue delta: CANDIDATE rows of the 19-Sept DIFF_QUEUE vs the re-mined one, keyed (region, dir, parent, gold, claude)."""
import re, sys
def rows(p):
    out = {}
    ...
    return out
a = rows("_diff_queue_pre_s28t1.md"); b = rows("../../DIFF_QUEUE.md")
