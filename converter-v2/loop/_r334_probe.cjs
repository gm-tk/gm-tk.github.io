/** _r334_probe.cjs — ROUND 334 in-memory A/B probe. Converts each module exactly as batch_convert.cjs
 ...
 *    ACTTITLEH3_OFF=1 STUB_OEMBED=1 node --require ./_deflate_raw_polyfill.cjs ../../outputs/_r334_probe.cjs CODES…   (expect: all identical)
 *    STUB_OEMBED=1 node --require ./_deflate_raw_polyfill.cjs ../../outputs/_r334_probe.cjs CODES…                     (the round's diffs)
