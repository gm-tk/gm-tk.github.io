...
- differing skeleton lines: 265690 — by direction {'MISSING': 140989, 'SUBSTITUTED': 23670, 'EXTRA': 92338, 'MOVED': 8693}
- by region: {'module-code': 15, 'title': 352, 'header': 5, 'module-menu': 13322, 'phases-nav': 108, 'crumbs': 202, 'footer': 2405, 'acks': 1310, 'activity': 95283, 'body': 151095, 'root': 1593}
- classes: 8834 — CANDIDATE 181, below floor 8370, the rest below consensus / not derivable
...
| 580 | activity | EXTRA | `div.col-12` | `—` | `p` | 572 | 281 | 0.88 of 2342 | series=XDLS90 c=1.00 n=22 | structure | — | CANDIDATE |
| 583 | activity | MISSING | `div.col-12` | `a` | `—` | 430 | 218 | 0.29 of 2342 | series=HIS10 c=0.71 n=40 | 0.62 | — | CANDIDATE |
| 584 | activity | EXTRA | `div.col-12` | `—` | `WIDGET` | 321 | 193 | 0.82 of 2342 | subject=NCEA1 c=0.94 n=33 | structure | — | CANDIDATE |
| 585 | activity | MISSING | `div.col-12` | `h3` | `—` | 388 | 192 | 0.31 of 2342 | template+ptype=Fundamentals/overview c=0.85 n=32 | 0.69 | — | CANDIDATE |
...
| 589 | activity | MISSING | `div.activity.interactive[number=*]` | `div.row` | `—` | 269 | 155 | 0.12 of 2342 | template+ptype=Fundamentals/overview c=0.65 n=34 | 0.92 | yes | CANDIDATE |
| 590 | activity | EXTRA | `div.col-12` | `—` | `img.img-fluid` | 230 | 141 | 0.97 of 2342 | subject+ptype=1-10 English/lesson c=0.99 n=22 | structure | — | CANDIDATE |
| 591 | activity | MOVED | `div.col-12` | `p` | `p` | 155 | 124 | 0.15 of 2342 | template+ptype=Inquiry/overview c=0.71 n=21 | structure | — | CANDIDATE |
| 592 | activity | EXTRA | `div.row` | `—` | `div.col-12` | 160 | 115 | 0.83 of 2342 | series=XDLS90 c=0.97 n=20 | structure | — | CANDIDATE |
...
| 596 | activity | EXTRA | `div.activity[number=*]` | `—` | `div.row` | 143 | 100 | 0.94 of 2342 | subject=1-10 English c=0.98 n=23 | structure | yes | CANDIDATE |
| 601 | activity | EXTRA | `div.col-12` | `—` | `ol` | 133 | 85 | 0.96 of 2342 | subject=1-10 Mathematics c=0.98 n=31 | structure | — | CANDIDATE |
| 603 | activity | EXTRA | `div.col-12` | `—` | `p>b` | 125 | 84 | 0.95 of 2342 | subject=1-10 Blended Literacy c=0.97 n=22 | structure | — | CANDIDATE |
| 604 | activity | SUBSTITUTED | `div.col-12` | `p` | `p` | 109 | 83 | 0.75 of 2342 | template+ptype=Standard/lesson c=0.88 n=70 | structure | — | CANDIDATE |
| 605 | activity | SUBSTITUTED | `div.col-12.col-md-8` | `div.activity[number=*]` | `div.activity[number=*]` | 114 | 82 | 0.46 of 2342 | subject+ptype=1-10 Mathematics/lesson c=0.68 n=22 | structure | yes | CANDIDATE |
...
| 607 | activity | EXTRA | `div.col-12` | `—` | `h3` | 106 | 81 | 0.87 of 2342 | template=Standard c=0.92 n=64 | structure | — | CANDIDATE |
| 612 | activity | EXTRA | `div.col-12` | `—` | `ul` | 102 | 76 | 0.94 of 2342 | template=Standard c=0.96 n=87 | structure | — | CANDIDATE |
| 613 | activity | EXTRA | `div.col-12` | `—` | `a` | 114 | 74 | 0.87 of 2342 | series=XDLS90 c=0.95 n=21 | structure | — | CANDIDATE |
| 614 | activity | EXTRA | `div.activity.interactive[number=*]` | `—` | `div.row` | 85 | 71 | 0.65 of 2342 | template=Standard c=0.68 n=70 | structure | yes | CANDIDATE |
...
| 627 | activity | SUBSTITUTED | `div.col-12` | `p` | `WIDGET` | 70 | 58 | 0.75 of 2342 | template+ptype=Standard/lesson c=0.88 n=51 | structure | — | CANDIDATE |
| 629 | activity | EXTRA | `div.col-12` | `—` | `h4.goJournal` | 128 | 55 | 0.95 of 2342 | series=HIS10 c=1.00 n=32 | structure | — | CANDIDATE |
...
| 632 | activity | SUBSTITUTED | `div.col-12` | `a` | `h4.goJournal` | 117 | 53 | 0.56 of 2342 | series=HIS10 c=0.83 n=20 | structure | — | CANDIDATE |
...
| 643 | activity | SUBSTITUTED | `div.col-12` | `WIDGET` | `div.row` | 45 | 43 | 0.60 of 2342 | ptype=lesson c=0.69 n=34 | structure | — | CANDIDATE |
| 647 | activity | EXTRA | `p>i` | `—` | `i` | 48 | 40 | 0.89 of 2342 | template=Standard c=0.90 n=44 | structure | — | CANDIDATE |
| 651 | activity | EXTRA | `a` | `—` | `div.externalButton` | 48 | 37 | 0.91 of 2342 | template=Standard c=0.91 n=35 | structure | — | CANDIDATE |
| 658 | activity | EXTRA | `div.col-12` | `—` | `div.icon.ratio.ratio-16x9.videoSection` | 50 | 35 | 0.98 of 2342 | template=Standard c=0.98 n=42 | structure | yes | CANDIDATE |
| 661 | activity | SUBSTITUTED | `div.col-12` | `a` | `WIDGET` | 40 | 34 | 0.56 of 2342 | template+ptype=Standard/lesson c=0.66 n=36 | structure | — | CANDIDATE |
...
| 681 | activity | EXTRA | `div.col-12` | `—` | `div.ratio.ratio-16x9.videoSection` | 49 | 27 | 0.99 of 2342 | template=Standard c=0.99 n=40 | structure | yes | CANDIDATE |
| 684 | activity | SUBSTITUTED | `div.row` | `div.col-12` | `div.col-12.col-md-8` | 29 | 26 | 0.79 of 2342 | ptype=lesson c=0.92 n=21 | structure | — | CANDIDATE |
| 690 | activity | EXTRA | `div.col-12` | `—` | `h5` | 29 | 25 | 0.99 of 2342 | template=Standard c=0.99 n=24 | structure | — | CANDIDATE |
| 691 | activity | SUBSTITUTED | `div.row` | `div.col-12` | `WIDGET` | 26 | 25 | 0.79 of 2342 | ptype=lesson c=0.92 n=20 | structure | — | CANDIDATE |
| 693 | activity | EXTRA | `div.icon.ratio.ratio-16x9.videoSection` | `—` | `iframe` | 27 | 24 | 0.99 of 2342 | template=Standard c=0.99 n=20 | structure | yes | CANDIDATE |
...
| 703 | activity | SUBSTITUTED | `div.row` | `div.col-12` | `div.row` | 23 | 22 | 0.79 of 2342 | era=Refresh c=0.79 n=23 | structure | — | CANDIDATE |
| 712 | activity | SUBSTITUTED | `div.col-12` | `p` | `p>b` | 26 | 20 | 0.75 of 2342 | ptype=lesson c=0.88 n=21 | structure | — | CANDIDATE |
| 721 | activity | EXTRA | `div.col-12` | `—` | `div.button` | 29 | 18 | 1.00 of 2342 | template=Standard c=1.00 n=25 | structure | yes | CANDIDATE |
| 722 | activity | EXTRA | `div.ratio.ratio-16x9.videoSection` | `—` | `iframe` | 26 | 18 | 0.99 of 2342 | ptype=lesson c=0.99 n=24 | structure | yes | CANDIDATE |
| 723 | activity | SUBSTITUTED | `div.col-12` | `h3` | `h3` | 26 | 18 | 0.76 of 2342 | template+ptype=Standard/lesson c=0.89 n=20 | structure | — | CANDIDATE |
...
| 3668 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p` | 1056 | 386 | 0.82 of 2342 | subject+ptype=NCEA1/overview c=1.00 n=29 | structure | — | CANDIDATE |
| 3669 | body | EXTRA | `div#body` | `—` | `div.row` | 1399 | 374 | 0.73 of 2342 | subject+ptype=1-10 Blended Literacy/overview c=1.00 n=29 | structure | — | CANDIDATE |
| 3670 | body | MISSING | `div#body` | `div.row` | `—` | 1294 | 323 | 0.34 of 2342 | series=CEDO50 c=0.76 n=20 | 0.86 | — | CANDIDATE |
| 3671 | body | MISSING | `div.col-12.col-md-8` | `p` | `—` | 590 | 274 | 0.25 of 2342 | template+ptype=Fundamentals/overview c=0.91 n=44 | 0.81 | — | CANDIDATE |
| 3672 | body | EXTRA | `div.col-12.col-md-8` | `—` | `img.img-fluid` | 539 | 243 | 0.96 of 2342 | template+ptype=Standard/overview c=1.00 n=25 | structure | — | CANDIDATE |
| 3673 | body | EXTRA | `div.col-12.col-md-8` | `—` | `WIDGET` | 359 | 225 | 0.93 of 2342 | subject+ptype=NCEA1/lesson c=0.99 n=51 | structure | — | CANDIDATE |
| 3674 | body | MOVED | `div.col-12.col-md-8` | `p` | `p` | 321 | 204 | 0.18 of 2342 | template+ptype=Fundamentals/overview c=0.84 n=40 | structure | — | CANDIDATE |
| 3675 | body | EXTRA | `div.row` | `—` | `div.col-12.col-md-8` | 284 | 195 | 0.85 of 2342 | subject+ptype=1-10 Blended Literacy/lesson c=0.96 n=22 | structure | — | CANDIDATE |
| 3676 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p>b` | 320 | 193 | 0.97 of 2342 | subject=1-10 Blended Literacy c=1.00 n=41 | structure | — | CANDIDATE |
| 3677 | body | SUBSTITUTED | `div.row` | `div.col-12` | `div.col-12.col-md-8` | 315 | 180 | 0.55 of 2342 | subject+ptype=1-10 Blended Literacy/overview c=0.96 n=64 | structure | — | CANDIDATE |
| 3678 | body | EXTRA | `div.col-12.col-md-8` | `—` | `h3` | 291 | 180 | 0.89 of 2342 | template+ptype=Standard/overview c=1.00 n=33 | structure | — | CANDIDATE |
| 3679 | body | EXTRA | `div.col-12.col-md-8` | `—` | `ul` | 294 | 171 | 0.95 of 2342 | subject=1-10 Mathematics c=0.98 n=21 | structure | — | CANDIDATE |
| 3680 | body | MISSING | `div.col-12.col-md-8` | `WIDGET` | `—` | 260 | 169 | 0.19 of 2342 | template+ptype=Fundamentals/overview c=0.65 n=31 | structure | — | CANDIDATE |
| 3681 | body | MISSING | `div.row` | `div.col-12.col-md-8` | `—` | 307 | 165 | 0.29 of 2342 | template+ptype=Fundamentals/overview c=0.94 n=20 | 0.95 | — | CANDIDATE |
| 3684 | body | EXTRA | `div.col-12.col-md-8` | `—` | `a` | 223 | 146 | 0.98 of 2342 | subject=ConnectED c=1.00 n=28 | structure | — | CANDIDATE |
| 3685 | body | MISSING | `div.col-12.col-md-8` | `h3` | `—` | 223 | 145 | 0.18 of 2342 | template+ptype=Fundamentals/overview c=0.75 n=21 | 0.89 | — | CANDIDATE |
| 3688 | body | EXTRA | `p>b` | `—` | `b` | 181 | 113 | 0.94 of 2342 | subject=1-10 Mathematics c=0.97 n=32 | structure | — | CANDIDATE |
| 3689 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.table-responsive` | 165 | 113 | 0.92 of 2342 | subject=NCEA1 c=0.92 n=41 | structure | — | CANDIDATE |
| 3691 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.ratio.ratio-16x9.videoSection` | 170 | 110 | 0.94 of 2342 | subject=NCEA1 c=0.98 n=23 | structure | yes | CANDIDATE |
| 3695 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p>a` | 162 | 108 | 0.99 of 2342 | subject=1-10 English c=1.00 n=20 | structure | — | CANDIDATE |
| 3696 | body | EXTRA | `a` | `—` | `div.button` | 172 | 104 | 0.99 of 2342 | subject=NCEA1 c=1.00 n=36 | structure | — | CANDIDATE |
| 3701 | body | EXTRA | `p` | `—` | `b` | 116 | 91 | 0.93 of 2342 | subject=NCEA1 c=0.96 n=29 | structure | — | CANDIDATE |
| 3702 | body | EXTRA | `div.table-responsive` | `—` | `table.table.table-bordered` | 136 | 89 | 0.96 of 2342 | subject=NCEA1 c=0.97 n=28 | structure | yes | CANDIDATE |
| 3705 | body | SUBSTITUTED | `div.icon.ratio.ratio-16x9.videoSection` | `iframe.embed-responsive-item` | `iframe` | 212 | 81 | 0.20 of 2342 | series=PES10 c=0.68 n=35 | structure | yes | CANDIDATE |
| 3706 | body | EXTRA | `p>i` | `—` | `i` | 107 | 80 | 0.97 of 2342 | subject+ptype=1-10 Blended Literacy/overview c=1.00 n=26 | structure | — | CANDIDATE |
| 3710 | body | EXTRA | `div.col-12.col-md-8` | `—` | `ol` | 105 | 78 | 0.99 of 2342 | template=Standard c=0.99 n=86 | structure | — | CANDIDATE |
| 3711 | body | EXTRA | `p>a` | `—` | `a` | 99 | 73 | 0.99 of 2342 | template=Standard c=1.00 n=78 | structure | — | CANDIDATE |
| 3712 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p>i` | 100 | 72 | 0.98 of 2342 | subject=NCEA1 c=0.99 n=26 | structure | — | CANDIDATE |
| 3715 | body | EXTRA | `div.row` | `—` | `div.col-12` | 125 | 70 | 0.71 of 2342 | subject=ANZH c=0.74 n=21 | structure | — | CANDIDATE |
| 3717 | body | EXTRA | `div.col-12.col-md-8` | `—` | `audio.audioPlayer.icon` | 125 | 69 | 1.00 of 2342 | subject=Leaving to Learn c=1.00 n=34 | structure | yes | CANDIDATE |
| 3722 | body | MOVED | `div.col-12.col-md-8` | `h3` | `h3` | 82 | 68 | 0.11 of 2342 | template+ptype=Fundamentals/overview c=0.67 n=24 | structure | — | CANDIDATE |
| 3723 | body | SUBSTITUTED | `div#body` | `div.row` | `WIDGET` | 112 | 67 | 0.94 of 2342 | subject=Online Safety (OS9000) c=1.00 n=25 | structure | — | CANDIDATE |
| 3725 | body | EXTRA | `div.fundamentalsPanel` | `—` | `div.row` | 67 | 67 | 0.98 of 2342 | era=Refresh c=0.98 n=67 | structure | — | CANDIDATE |
| 3727 | body | EXTRA | `table.table.table-bordered` | `—` | `tr` | 91 | 65 | 0.98 of 2342 | template=Standard c=0.98 n=78 | structure | yes | CANDIDATE |
| 3733 | body | EXTRA | `a` | `—` | `div.externalButton` | 86 | 60 | 0.92 of 2342 | template=Standard c=0.92 n=74 | structure | — | CANDIDATE |
| 3737 | body | EXTRA | `ul` | `—` | `li` | 72 | 59 | 0.94 of 2342 | template=Standard c=0.95 n=55 | structure | — | CANDIDATE |
| 3738 | body | EXTRA | `div.col-12.col-md-8` | `—` | `h4` | 67 | 59 | 0.97 of 2342 | template=Standard c=0.98 n=32 | structure | — | CANDIDATE |
| 3741 | body | SUBSTITUTED | `div.row` | `div.col-12.col-md-8` | `div.col-12.col-md-8` | 66 | 57 | 0.98 of 2342 | ptype=lesson c=0.99 n=37 | structure | — | CANDIDATE |
| 3742 | body | EXTRA | `div.ratio.ratio-16x9.videoSection` | `—` | `iframe` | 74 | 56 | 0.92 of 2342 | template=Standard c=0.93 n=53 | structure | yes | CANDIDATE |
| 3744 | body | EXTRA | `div.col-12` | `—` | `p` | 87 | 51 | 0.93 of 2342 | template=Standard c=0.94 n=75 | structure | — | CANDIDATE |
| 3745 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `p` | 65 | 51 | 0.85 of 2342 | template+ptype=Standard/lesson c=0.86 n=46 | structure | — | CANDIDATE |
| 3746 | body | EXTRA | `div.alert` | `—` | `div.row` | 64 | 50 | 0.91 of 2342 | template=Standard c=0.92 n=46 | structure | — | CANDIDATE |
| 3747 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `div.activity[number=*]` | 57 | 50 | 0.85 of 2342 | template+ptype=Standard/lesson c=0.86 n=49 | structure | yes | CANDIDATE |
| 3750 | body | EXTRA | `tr` | `—` | `td` | 55 | 47 | 0.94 of 2342 | template=Standard c=0.95 n=51 | structure | — | CANDIDATE |
| 3752 | body | EXTRA | `div.row` | `—` | `div.col-12.col-md-6` | 65 | 45 | 0.99 of 2342 | subject=Online Safety (OS9000) c=1.00 n=21 | structure | — | CANDIDATE |
| 3754 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.alert` | 60 | 45 | 0.91 of 2342 | template=Standard c=0.92 n=46 | structure | — | CANDIDATE |
| 3757 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.icon.ratio.ratio-16x9.videoSection` | 62 | 44 | 0.92 of 2342 | template=Standard c=0.93 n=54 | structure | yes | CANDIDATE |
| 3765 | body | EXTRA | `div#body` | `—` | `WIDGET` | 77 | 41 | 0.93 of 2342 | era=Refresh c=0.93 n=77 | structure | — | CANDIDATE |
| 3767 | body | SUBSTITUTED | `div.row` | `div.col-12.col-md-8` | `WIDGET` | 44 | 41 | 0.98 of 2342 | ptype=lesson c=0.99 n=37 | structure | — | CANDIDATE |
| 3768 | body | MISSING | `div#body` | `div.fundamentalsPanel` | `—` | 48 | 40 | 0.02 of 2342 | template+ptype=Fundamentals/overview c=0.60 n=39 | 0.98 | yes | CANDIDATE |
| 3771 | body | EXTRA | `p` | `—` | `i` | 44 | 38 | 0.96 of 2342 | template=Standard c=0.97 n=40 | structure | — | CANDIDATE |
| 3772 | body | EXTRA | `tr` | `—` | `th` | 41 | 38 | 0.99 of 2342 | template=Standard c=1.00 n=34 | structure | — | CANDIDATE |
| 3779 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `WIDGET` | 36 | 35 | 0.85 of 2342 | template+ptype=Standard/lesson c=0.86 n=23 | structure | — | CANDIDATE |
| 3781 | body | EXTRA | `div#body` | `—` | `div.row.supervisor` | 43 | 33 | 0.90 of 2342 | ptype=lesson c=0.91 n=38 | structure | yes | CANDIDATE |
| 3782 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p>span.infoTrigger` | 37 | 33 | 0.86 of 2342 | template=Standard c=0.87 n=31 | structure | — | CANDIDATE |
| 3784 | body | SUBSTITUTED | `div.row` | `div.col-12.col-md-8` | `div.row` | 34 | 33 | 0.98 of 2342 | era=Refresh c=0.98 n=34 | structure | — | CANDIDATE |
| 3785 | body | EXTRA | `div.row` | `—` | `div.col-12.col-md-4.offset-md-0` | 33 | 33 | 0.80 of 2342 | template=Standard c=0.80 n=21 | structure | — | CANDIDATE |
| 3791 | body | EXTRA | `div.col-12.col-md-8` | `—` | `h5` | 40 | 31 | 0.98 of 2342 | subject=NCEA1 c=0.99 n=21 | structure | — | CANDIDATE |
| 3792 | body | EXTRA | `div.col-12.col-md-8` | `—` | `h4.goJournal` | 39 | 30 | 1.00 of 2342 | era=Refresh c=1.00 n=39 | structure | — | CANDIDATE |
| 3797 | body | EXTRA | `div#body` | `—` | `div.fundamentalsPanel` | 30 | 30 | 0.98 of 2342 | era=Refresh c=0.98 n=30 | structure | yes | CANDIDATE |
| 3798 | body | EXTRA | `div.alert.solid` | `—` | `div.row` | 41 | 29 | 0.99 of 2342 | template=Standard c=0.99 n=36 | structure | yes | CANDIDATE |
| 3800 | body | EXTRA | `div.icon.ratio.ratio-16x9.videoSection` | `—` | `iframe` | 36 | 29 | 0.97 of 2342 | ptype=lesson c=0.98 n=30 | structure | yes | CANDIDATE |
| 3804 | body | EXTRA | `div.inquiryPanel` | `—` | `div.row` | 31 | 28 | 0.99 of 2342 | era=Refresh c=0.99 n=31 | structure | — | CANDIDATE |
| 3805 | body | EXTRA | `div.introduction` | `—` | `div.row` | 28 | 28 | 0.99 of 2342 | era=Refresh c=0.99 n=28 | structure | — | CANDIDATE |
| 3808 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.flipCardsContainer.row` | 30 | 27 | 0.94 of 2342 | template=Standard c=0.95 n=24 | structure | — | CANDIDATE |
| 3820 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `img.img-fluid` | 26 | 25 | 0.85 of 2342 | era=Refresh c=0.85 n=26 | structure | — | CANDIDATE |
| 3825 | body | EXTRA | `div.row` | `—` | `div.col-12.col-md-4` | 31 | 24 | 0.95 of 2342 | template=Standard c=0.95 n=25 | structure | — | CANDIDATE |
| 3828 | body | SUBSTITUTED | `div.row` | `div.col-12.col-md-8` | `div.col-12.col-md-6` | 27 | 24 | 0.98 of 2342 | ptype=lesson c=0.99 n=23 | structure | — | CANDIDATE |
| 3832 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.alert.solid` | 29 | 23 | 0.99 of 2342 | era=Refresh c=0.99 n=29 | structure | yes | CANDIDATE |
| 3836 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.clickDropContent` | 26 | 22 | 0.95 of 2342 | template=Standard c=0.95 n=23 | structure | — | CANDIDATE |
| 3838 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `div.activity.interactive[number=*]` | 24 | 22 | 0.85 of 2342 | template+ptype=Standard/lesson c=0.86 n=22 | structure | yes | CANDIDATE |
| 3839 | body | SUBSTITUTED | `div.row` | `div.col-12.col-md-8` | `p` | 23 | 22 | 0.98 of 2342 | era=Refresh c=0.98 n=23 | structure | — | CANDIDATE |
| 3840 | body | EXTRA | `div#body` | `—` | `div.inquiryPanel` | 29 | 21 | 0.98 of 2342 | era=Refresh c=0.98 n=29 | structure | — | CANDIDATE |
| 3844 | body | EXTRA | `p>span.infoTrigger` | `—` | `span.infoTrigger` | 21 | 21 | 0.84 of 2342 | era=Refresh c=0.84 n=21 | structure | — | CANDIDATE |
| 3846 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `div.alert` | 28 | 20 | 0.85 of 2342 | era=Refresh c=0.85 n=28 | structure | — | CANDIDATE |
| 3864 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `h3` | 20 | 19 | 0.85 of 2342 | era=Refresh c=0.85 n=20 | structure | — | CANDIDATE |
| 3876 | body | SUBSTITUTED | `div#body` | `div.row` | `div.table-responsive` | 23 | 17 | 0.94 of 2342 | ptype=lesson c=0.98 n=21 | structure | — | CANDIDATE |
| 3898 | body | MISSING | `div#body` | `div.clickDropContent.noBorder.row` | `—` | 50 | 15 | 0.02 of 2342 | series=XDLS90 c=0.64 n=38 | 0.93 | yes | CANDIDATE |
| 3900 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p.captionText` | 21 | 15 | 1.00 of 2342 | era=Refresh c=1.00 n=21 | structure | — | CANDIDATE |
| 3908 | body | EXTRA | `div.col-12.col-md-6` | `—` | `p` | 23 | 14 | 1.00 of 2342 | ptype=lesson c=1.00 n=21 | structure | — | CANDIDATE |
| 4360 | body | SUBSTITUTED | `div.col-12.col-md-8` | `div.alert` | `div.activity.clickDropContent.dropbox[number=*]` | 20 | 4 | 0.31 of 2342 | series=XDLS90 c=0.80 n=20 | structure | yes | CANDIDATE |
| 8759 | root | EXTRA | `body.container-fluid` | `—` | `div.row` | 261 | 261 | 0.88 of 2349 | subject+ptype=1-10 Mathematics/overview c=0.97 n=33 | structure | — | CANDIDATE |
| 8763 | root | SUBSTITUTED | `#root` | `body` | `body.container-fluid` | 138 | 15 | 0.06 of 2349 | series=PWY10 c=1.00 n=44 | structure | yes | CANDIDATE |
