/** _s30_r5_items.cjs — dump a module's page item stream (type / primary tag / directive / class / text / blackAfter / consumedBy)
 *  for the pages whose label matches ITEMS_PAGE (default "1"). Usage (reference/tests/):
 *    ITEMS_PAGE=1.0 STUB_OEMBED=1 node --require ./_deflate_raw_polyfill.cjs ../../outputs/_s30_r5_items.cjs FRFUN06 */
"use strict";
...
async function main() {
  ...
  InteractiveScanner.ScanPage = function (page, normaliser, run) {
    ...
    if (String(label).startsWith(WANT)) {
