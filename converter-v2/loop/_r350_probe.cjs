/** _r350_probe.cjs — ROUND 350 in-memory A/B probe (the r342 probe, unchanged mechanics; toggles DDIMAGES_OFF + DDBUTTONS_OFF). Converts each module exactly as batch_convert.cjs
 ...
 *    DDIMAGES_OFF=1 DDBUTTONS_OFF=1 STUB_OEMBED=1 node --require ./_deflate_raw_polyfill.cjs ../../outputs/_r350_probe.cjs CODES…   (expect: all identical)
 *    STUB_OEMBED=1 node --require ./_deflate_raw_polyfill.cjs ../../outputs/_r350_probe.cjs CODES…                     (the round's diffs)
