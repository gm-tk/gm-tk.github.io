#!/usr/bin/env python3
"""_r341_quality.py — ROUND 341 proofs over the affected modules (outputs/_r341_on/<code>/<page> = the ON output; disk = the
...
OUT = os.path.join(HERE, "..", "..", "01-Claude_Modules_"); ON = os.path.join(HERE, "_r341_on")
AFF = [l.strip() for l in open(os.path.join(HERE, "_r341_affected.txt")) if l.strip()]
