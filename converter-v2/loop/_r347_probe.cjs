/** _r347_probe.cjs — ROUND 347 in-memory A/B probe (the r342 probe, unchanged mechanics). Converts each module exactly as batch_convert.cjs
 ...
 *    TBLBORDER_OFF=1 STUB_OEMBED=1 node --require ./_deflate_raw_polyfill.cjs ../../outputs/_r342_probe.cjs CODES…   (expect: all identical)
