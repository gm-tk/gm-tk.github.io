#!/usr/bin/env python3
"""r406 skeleton delta: r405 -> r406 (_sk_final.json), movers named, bucket crossings, outside-affected check."""
import json
a = json.load(open('_s27_r405_sk_final.json')); b = json.load(open('_s27_r406_sk_final.json'))
aff = set(l.strip() for l in open('_s27_r406_affected.txt') if l.strip())
