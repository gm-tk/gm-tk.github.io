/** _s28_t1_probe.cjs — ROUND 407 in-memory A/B probe (OFF = HEADLEDOWNER_OFF=1; ON = the live data). Converts each module exactly as batch_convert.cjs
...
async function main() {
  ...
  if (preFile) {   // SESSION 28 / TASK 1 OFF leg: --pre <dir> = the pre-rebuild snapshot of the mined registries (outputs/_s28_t1_pre)
