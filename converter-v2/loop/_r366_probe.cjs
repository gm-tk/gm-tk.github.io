/** _r366_probe.cjs — ROUND 366 in-memory A/B probe (the r362 probe, unchanged mechanics; toggle LEADFREE_OFF). Converts each module exactly as batch_convert.cjs
 ...
 *    LEADFREE_OFF=1 STUB_OEMBED=1 node --require ./_deflate_raw_polyfill.cjs ../../outputs/_r366_probe.cjs CODES…   (expect: all identical)
 *    STUB_OEMBED=1 node --require ./_deflate_raw_polyfill.cjs ../../outputs/_r366_probe.cjs CODES…                     (the round's diffs)
