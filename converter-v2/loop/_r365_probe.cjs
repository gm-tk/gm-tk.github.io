/** _r365_probe.cjs — ROUND 365 in-memory A/B probe (the r362 probe, unchanged mechanics; toggle TYPEDTAG_OFF). Converts each module exactly as batch_convert.cjs
 ...
 *    TYPEDTAG_OFF=1 STUB_OEMBED=1 node --require ./_deflate_raw_polyfill.cjs ../../outputs/_r365_probe.cjs CODES…   (expect: all identical)
 *    STUB_OEMBED=1 node --require ./_deflate_raw_polyfill.cjs ../../outputs/_r365_probe.cjs CODES…                     (the round's diffs)
