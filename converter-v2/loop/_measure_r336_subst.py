"""ROUND 336 PICK instrument (the r334 substitution instrument re-run after r335) — SUBSTITUTION pairs in the PRIMARY gate's own difflib opcodes: for every paired page,
...
json.dump(out, open(os.path.join(HERE, "_r336_subst.json"), "w", encoding="utf-8"), indent=1, ensure_ascii=False)
