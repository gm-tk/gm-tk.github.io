...
- Session 15 Round 5 (measurement-tool round r355 — the skeleton scorer's autojunk cliff: `autojunk=False`, 128 long pages re-scored honestly, the skeleton baseline re-established at 51.979 % / 1093 / 160 / 14, RAW 36.711 %, = 56.6 % of achievable — an instrument correction, never a gain): **SHIPPED 2026-09-17 ≈13:05 (session 15)**. AppVersion 260619.26, CLAUDE.md §9/§14, `gate_baseline.json`. No engine / data change, no regeneration.
