#!/usr/bin/env bash
# ROUND 443 (session 39 Round 5 — D13-14 + D13-15, the XOTP flagged gaps) — the loop mirror:
...
n=0
for f in $(cd $O && ls -d _r443_* _affected_r443.txt _diff_miner_r443.log 2>/dev/null); do
