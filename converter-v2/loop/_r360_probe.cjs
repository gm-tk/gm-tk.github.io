/** _r360_probe.cjs — ROUND 360 in-memory A/B probe (the r354 / r356 probe, unchanged mechanics; toggle TMPLDELTA_OFF). Converts each module exactly as batch_convert.cjs
 ...
 *    TMPLDELTA_OFF=1 STUB_OEMBED=1 node --require ./_deflate_raw_polyfill.cjs ../../outputs/_r360_probe.cjs CODES…   (expect: all identical)
 *    STUB_OEMBED=1 node --require ./_deflate_raw_polyfill.cjs ../../outputs/_r360_probe.cjs CODES…                     (the round's diffs)
