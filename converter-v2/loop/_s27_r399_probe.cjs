/** _s27_r399_probe.cjs — ROUND 399 in-memory A/B probe (OFF = WANANGA_OFF=1; ON = the live data). Converts each module exactly as batch_convert.cjs
 ...
 *    WANANGA_OFF=1 STUB_OEMBED=1 node --require ./_deflate_raw_polyfill.cjs ../../outputs/_s27_r399_probe.cjs CODES…   (expect: all identical)
 *    STUB_OEMBED=1 node --require ./_deflate_raw_polyfill.cjs ../../outputs/_s27_r399_probe.cjs CODES…                     (the round's diffs)
