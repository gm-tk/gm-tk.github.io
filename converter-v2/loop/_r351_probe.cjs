/** _r351_probe.cjs — ROUND 351 in-memory A/B probe (the r350 probe, unchanged mechanics; toggle DDCOLUMN_OFF). Converts each module exactly as batch_convert.cjs
 ...
 *    DDCOLUMN_OFF=1 STUB_OEMBED=1 node --require ./_deflate_raw_polyfill.cjs ../../outputs/_r351_probe.cjs CODES…   (expect: all identical)
 *    STUB_OEMBED=1 node --require ./_deflate_raw_polyfill.cjs ../../outputs/_r351_probe.cjs CODES…                     (the round's diffs)
