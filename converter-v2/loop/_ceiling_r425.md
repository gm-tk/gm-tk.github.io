...
- pages 2308 / modules 479 / text blocks (scaffold scope) 106542
- no-source share, scaffold scope: per-page mean **raw 11.8% → net 9.1%** (pooled raw 11.5% → net 9.6%)
- no-source share, full scope (widget internals included): per-page mean raw 16.5% → net 13.3%
...
- baseline `_s33_r425_sk_final.json` (2377 pairs): SCAFFOLD mean 54.232% / RAW mean 38.239%
- **SCAFFOLD 54.23% = 59.7% of achievable** (band 58.0%–59.7%: the loose ceiling gives the lower figure); RAW 38.24% = 44.1% of its own ceiling (band 42.9%–44.1%); per-page mean of (score ÷ own ceiling) = 60.2% over 2303 joined pages
...
|---|---|---|---|---|---|---|---|---|---|---|
| paired (gate population) | 2308 | 479 | 106542 | 11.8% | 9.1% | 6.5% | 90.9% | 93.5% | 16.5% | 13.3% |
...
|---|---|---|---|---|---|---|---|---|
| Standard | 2071 | 345 | 12.1% | 9.3% | 6.7% | 90.7% | 93.3% | 10.1% |
| Fundamentals | 117 | 81 | 9.3% | 7.5% | 4.6% | 92.5% | 95.4% | 9.0% |
| Inquiry | 94 | 45 | 9.8% | 7.2% | 4.7% | 92.8% | 95.3% | 7.4% |
| Bilingual | 26 | 8 | 5.3% | 5.2% | 3.9% | 94.8% | 96.1% | 6.4% |

## By HTML sub-type (KB 06) — paired population

| group | pages | modules | mean no-source raw | mean no-source NET | mean LOOSE | ceiling | ceiling loose | pooled NET |
|---|---|---|---|---|---|---|---|---|
| Standard | 1953 | 328 | 12.2% | 9.4% | 6.8% | 90.6% | 93.2% | 10.2% |
...
| group | pages | modules | mean no-source raw | mean no-source NET | mean LOOSE | ceiling | ceiling loose | pooled NET |
|---|---|---|---|---|---|---|---|---|
| False | 2308 | 479 | 11.8% | 9.1% | 6.5% | 90.9% | 93.5% | 9.6% |

## By KB subject family (14.x, prefix heuristic) — paired population

| group | pages | modules | mean no-source raw | mean no-source NET | mean LOOSE | ceiling | ceiling loose | pooled NET |
|---|---|---|---|---|---|---|---|---|
| no KB family | 1469 | 237 | 11.9% | 9.4% | 6.4% | 90.6% | 93.6% | 9.6% |
| BLL (14.7) | 258 | 91 | 8.0% | 3.4% | 2.5% | 96.6% | 97.5% | 3.1% |
| Languages (14.1) | 120 | 23 | 24.6% | 22.5% | 20.6% | 77.5% | 79.4% | 25.5% |
| X-prefixed other (learningSupport) | 117 | 24 | 11.2% | 8.3% | 5.8% | 91.7% | 94.2% | 9.9% |
...
| Leaving to Learn | 220 | 42 | 11.8% | 9.0% | 6.3% | 91.0% | 93.7% | 9.9% |
...
| Te Marautanga o Aotearoa TMoA | 26 | 8 | 5.3% | 5.2% | 3.9% | 94.8% | 96.1% | 6.4% |
