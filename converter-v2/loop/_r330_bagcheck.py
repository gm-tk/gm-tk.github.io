"""ROUND 330 — position-independent line overlap (bag intersection with the gold skeleton) OFF vs ON on the dip pages."""
...
OFF=os.path.join(HERE,"_r330_off_pages")
for code, page in [("TRR111","TRR111_2_0.html"),("PNR102","PNR102_2_0.html"),("TRR113","TRR113_3_0.html"),("TRR109","TRR109_1_0.html")]:
