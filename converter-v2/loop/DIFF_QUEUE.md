...
**Produced:** 2026-09-18 11:53 NZST by `reference/tests/_diff_miner.py` on the CURRENT corpus (pageforge-site HEAD 56f43c5; Claude corpus 416 dirs). **Population:** the skeleton gate's own — 1956 paired pages / 405 modules (compare_exclusions.txt honoured; acks / glossary / references pages excluded); parse errors skipped: 0 (must be 0); modules without a parsed WT: 2. Run time 63.2 s.
...
- differing skeleton lines: 230575 — by direction {'MISSING': 121035, 'SUBSTITUTED': 20934, 'EXTRA': 80657, 'MOVED': 7949}
- by region: {'module-code': 17, 'title': 253, 'header': 6, 'module-menu': 11987, 'phases-nav': 42, 'crumbs': 183, 'footer': 2101, 'acks': 1176, 'activity': 83642, 'body': 129278, 'root': 1890}
- classes: 8355 — CANDIDATE 179, below floor 7929, the rest below consensus / not derivable
...
| 530 | activity | MISSING | `div.col-12` | `p` | `—` | 640 | 290 | 0.31 of 1950 | subject+ptype=1-10 Blended Literacy/lesson c=0.78 n=106 | 0.81 | — | CANDIDATE |
| 531 | activity | EXTRA | `div.col-12` | `—` | `p` | 483 | 239 | 0.88 of 1950 | series=XDLS90 c=1.00 n=21 | structure | — | CANDIDATE |
| 533 | activity | MISSING | `div.col-12` | `a` | `—` | 416 | 203 | 0.29 of 1950 | series=HIS10 c=0.71 n=41 | 0.66 | — | CANDIDATE |
| 534 | activity | MISSING | `a` | `div.button` | `—` | 519 | 192 | 0.23 of 1950 | series=HIS10 c=0.71 n=35 | 0.63 | yes | CANDIDATE |
| 536 | activity | MOVED | `div.col-12` | `p` | `p` | 250 | 150 | 0.19 of 1950 | template+ptype=Fundamentals/overview c=0.62 n=20 | structure | — | CANDIDATE |
| 537 | activity | EXTRA | `div.col-12` | `—` | `WIDGET` | 243 | 150 | 0.82 of 1950 | subject=1-10 English c=0.92 n=36 | structure | — | CANDIDATE |
| 539 | activity | SUBSTITUTED | `div.col-md-8.col-12` | `div.activity.interactive[number=*]` | `div.activity[number=*]` | 190 | 135 | 0.42 of 1950 | subject+ptype=1-10 Blended Literacy/lesson c=0.72 n=52 | structure | yes | CANDIDATE |
| 540 | activity | EXTRA | `div.col-12` | `—` | `img.img-fluid` | 204 | 123 | 0.97 of 1950 | template=Standard c=0.98 n=153 | structure | — | CANDIDATE |
| 541 | activity | MISSING | `div.activity.interactive[number=*]` | `div.row` | `—` | 196 | 112 | 0.20 of 1950 | template+ptype=Bilingual/lesson c=0.68 n=25 | 0.91 | yes | CANDIDATE |
| 542 | activity | EXTRA | `div.row` | `—` | `div.col-12` | 155 | 112 | 0.89 of 1950 | template=Standard c=0.92 n=124 | structure | — | CANDIDATE |
...
| 551 | activity | EXTRA | `div.activity[number=*]` | `—` | `div.row` | 100 | 79 | 0.94 of 1950 | template=Standard c=0.96 n=81 | structure | yes | CANDIDATE |
| 554 | activity | EXTRA | `div.col-12` | `—` | `ol` | 115 | 74 | 0.96 of 1950 | subject=1-10 Mathematics c=0.98 n=27 | structure | — | CANDIDATE |
| 555 | activity | EXTRA | `div.col-12` | `—` | `p>b` | 110 | 74 | 0.97 of 1950 | template=Standard c=0.98 n=80 | structure | — | CANDIDATE |
| 557 | activity | SUBSTITUTED | `div.col-md-8.col-12` | `div.activity[number=*]` | `div.activity.interactive[number=*]` | 101 | 72 | 0.48 of 1950 | subject+ptype=1-10 Blended Literacy/lesson c=0.86 n=24 | structure | yes | CANDIDATE |
| 559 | activity | EXTRA | `div.col-12` | `—` | `h3` | 94 | 71 | 0.86 of 1950 | template=Standard c=0.91 n=57 | structure | — | CANDIDATE |
| 560 | activity | EXTRA | `div.col-12` | `—` | `ul` | 86 | 68 | 0.94 of 1950 | template=Standard c=0.96 n=69 | structure | — | CANDIDATE |
| 562 | activity | SUBSTITUTED | `div.col-12` | `p` | `p` | 84 | 66 | 0.76 of 1950 | template+ptype=Standard/lesson c=0.89 n=57 | structure | — | CANDIDATE |
...
| 565 | activity | SUBSTITUTED | `div.col-md-8.col-12` | `div.activity[number=*]` | `h3` | 85 | 61 | 0.48 of 1950 | subject+ptype=NCEA1/lesson c=0.63 n=33 | structure | yes | CANDIDATE |
| 566 | activity | EXTRA | `p>b` | `—` | `b` | 84 | 61 | 0.93 of 1950 | template=Standard c=0.94 n=56 | structure | — | CANDIDATE |
| 568 | activity | EXTRA | `div.col-12` | `—` | `h4.goJournal` | 123 | 55 | 0.95 of 1950 | series=HIS10 c=1.00 n=33 | structure | — | CANDIDATE |
| 571 | activity | SUBSTITUTED | `div.col-12` | `p` | `WIDGET` | 66 | 54 | 0.76 of 1950 | template+ptype=Standard/lesson c=0.89 n=50 | structure | — | CANDIDATE |
| 572 | activity | SUBSTITUTED | `div.col-12` | `WIDGET` | `div.row` | 64 | 54 | 0.60 of 1950 | ptype=lesson c=0.70 n=57 | structure | — | CANDIDATE |
...
| 579 | activity | EXTRA | `ol` | `—` | `li` | 67 | 51 | 0.95 of 1950 | template=Standard c=0.96 n=51 | structure | — | CANDIDATE |
...
| 587 | activity | EXTRA | `div.col-12` | `—` | `p>i` | 47 | 41 | 0.97 of 1950 | template=Standard c=0.98 n=41 | structure | — | CANDIDATE |
| 590 | activity | EXTRA | `p>i` | `—` | `i` | 46 | 40 | 0.88 of 1950 | template=Standard c=0.88 n=44 | structure | — | CANDIDATE |
| 595 | activity | EXTRA | `div.col-md-8.col-12` | `—` | `div.activity[number=*]` | 40 | 38 | 0.95 of 1950 | template=Standard c=0.98 n=27 | structure | yes | CANDIDATE |
...
| 602 | activity | EXTRA | `div.col-md-8.col-12` | `—` | `div.activity.interactive[number=*]` | 37 | 35 | 0.90 of 1950 | template=Standard c=0.93 n=30 | structure | yes | CANDIDATE |
| 603 | activity | EXTRA | `div.col-12` | `—` | `div.videoSection.ratio.ratio-16x9` | 53 | 34 | 0.99 of 1950 | template=Standard c=0.99 n=43 | structure | yes | CANDIDATE |
| 610 | activity | SUBSTITUTED | `div.col-md-8.col-12` | `div.activity[number=*]` | `div.activity` | 49 | 32 | 0.48 of 1950 | subject+ptype=NCEA1/lesson c=0.63 n=34 | structure | yes | CANDIDATE |
| 612 | activity | EXTRA | `div.activity` | `—` | `div.row` | 48 | 30 | 1.00 of 1950 | era=Refresh c=1.00 n=48 | structure | yes | CANDIDATE |
...
| 619 | activity | EXTRA | `div.col-12` | `—` | `div.activity.interactive[number=*]` | 33 | 29 | 0.89 of 1950 | era=Refresh c=0.89 n=33 | structure | yes | CANDIDATE |
| 620 | activity | EXTRA | `div.col-12` | `—` | `audio.audioPlayer.icon` | 44 | 28 | 1.00 of 1950 | subject=1-10 Blended Literacy c=1.00 n=20 | structure | yes | CANDIDATE |
| 628 | activity | EXTRA | `p` | `—` | `b` | 33 | 26 | 0.96 of 1950 | template=Standard c=0.96 n=30 | structure | — | CANDIDATE |
| 631 | activity | SUBSTITUTED | `div.col-12` | `WIDGET` | `div.col-md-8.col-12` | 27 | 26 | 0.60 of 1950 | ptype=lesson c=0.70 n=20 | structure | — | CANDIDATE |
...
| 647 | activity | EXTRA | `div.col-12` | `—` | `h5` | 26 | 22 | 0.98 of 1950 | template=Standard c=0.99 n=21 | structure | — | CANDIDATE |
| 648 | activity | SUBSTITUTED | `div.row` | `div.col-12` | `div.col-md-8.col-12` | 25 | 22 | 0.79 of 1950 | ptype=lesson c=0.93 n=20 | structure | — | CANDIDATE |
| 652 | activity | SUBSTITUTED | `div.row` | `div.col-12` | `div.row` | 21 | 21 | 0.79 of 1950 | era=Refresh c=0.79 n=21 | structure | — | CANDIDATE |
| 657 | activity | EXTRA | `div.col-md-8.col-12` | `—` | `div.activity` | 24 | 19 | 1.00 of 1950 | era=Refresh c=1.00 n=24 | structure | yes | CANDIDATE |
| 663 | activity | EXTRA | `a` | `—` | `div.externalButton` | 25 | 18 | 0.91 of 1950 | era=Refresh c=0.91 n=25 | structure | — | CANDIDATE |
...
| 672 | activity | EXTRA | `div.col-12` | `—` | `div.TKmodal` | 20 | 17 | 0.99 of 1950 | era=Refresh c=0.99 n=20 | structure | — | CANDIDATE |
| 683 | activity | SUBSTITUTED | `div.col-12` | `p` | `h4.goJournal` | 25 | 15 | 0.76 of 1950 | template+ptype=Standard/lesson c=0.89 n=24 | structure | — | CANDIDATE |
| 684 | activity | EXTRA | `div.row` | `—` | `div.clickDropContent` | 23 | 15 | 0.99 of 1950 | template=Standard c=1.00 n=23 | structure | — | CANDIDATE |
| 685 | activity | EXTRA | `div.row` | `—` | `WIDGET` | 22 | 15 | 1.00 of 1950 | era=Refresh c=1.00 n=22 | structure | — | CANDIDATE |
| 687 | activity | SUBSTITUTED | `div.col-12` | `WIDGET` | `img.img-fluid` | 21 | 15 | 0.60 of 1950 | era=Refresh c=0.60 n=21 | structure | — | CANDIDATE |
| 3600 | body | EXTRA | `div#body` | `—` | `div.row` | 1250 | 324 | 0.73 of 1950 | subject+ptype=1-10 Blended Literacy/overview c=1.00 n=29 | structure | — | CANDIDATE |
| 3601 | body | EXTRA | `div.col-md-8.col-12` | `—` | `p` | 856 | 321 | 0.82 of 1950 | subject=1-10 Blended Literacy c=1.00 n=36 | structure | — | CANDIDATE |
| 3602 | body | MISSING | `div#body` | `div.row` | `—` | 1080 | 285 | 0.34 of 1950 | series=CEDO50 c=0.76 n=20 | 0.86 | — | CANDIDATE |
| 3603 | body | MISSING | `div.col-md-8.col-12` | `p` | `—` | 509 | 241 | 0.29 of 1950 | template+ptype=Fundamentals/overview c=0.93 n=34 | 0.82 | — | CANDIDATE |
...
| 3605 | body | MOVED | `div.col-md-8.col-12` | `p` | `p` | 285 | 182 | 0.18 of 1950 | template+ptype=Fundamentals/overview c=0.87 n=36 | structure | — | CANDIDATE |
| 3606 | body | EXTRA | `div.col-md-8.col-12` | `—` | `WIDGET` | 262 | 171 | 0.89 of 1950 | subject=NCEA1 c=0.96 n=21 | structure | — | CANDIDATE |
| 3607 | body | EXTRA | `div.row` | `—` | `div.col-md-8.col-12` | 246 | 162 | 0.86 of 1950 | subject+ptype=1-10 Blended Literacy/lesson c=0.99 n=20 | structure | — | CANDIDATE |
...
| 3618 | body | EXTRA | `div.col-md-8.col-12` | `—` | `a` | 175 | 108 | 0.93 of 1950 | subject=1-10 English c=0.95 n=21 | structure | — | CANDIDATE |
...
| 3623 | body | EXTRA | `div.col-md-8.col-12` | `—` | `div.table-responsive` | 156 | 95 | 0.98 of 1950 | subject+ptype=1-10 English/lesson c=0.99 n=22 | structure | — | CANDIDATE |
...
| 3627 | body | EXTRA | `div.col-md-8.col-12` | `—` | `p>a` | 119 | 86 | 0.99 of 1950 | template=Standard c=0.99 n=94 | structure | — | CANDIDATE |
| 3629 | body | EXTRA | `p` | `—` | `b` | 100 | 80 | 0.93 of 1950 | template=Standard c=0.94 n=85 | structure | — | CANDIDATE |
...
| 3638 | body | SUBSTITUTED | `div.videoSection.icon.ratio.ratio-16x9` | `iframe.embed-responsive-item` | `iframe` | 176 | 69 | 0.21 of 1950 | series=PES10 c=0.68 n=35 | structure | yes | CANDIDATE |
| 3641 | body | EXTRA | `div.col-md-8.col-12` | `—` | `ol` | 83 | 65 | 0.99 of 1950 | ptype=overview c=0.99 n=25 | structure | — | CANDIDATE |
| 3643 | body | EXTRA | `div.col-md-8.col-12` | `—` | `p>i` | 87 | 64 | 0.98 of 1950 | subject=NCEA1 c=0.99 n=23 | structure | — | CANDIDATE |
...
| 3649 | body | MOVED | `div.col-md-8.col-12` | `h3` | `h3` | 76 | 61 | 0.17 of 1950 | template+ptype=Fundamentals/overview c=0.81 n=21 | structure | — | CANDIDATE |
...
| 3658 | body | EXTRA | `ul` | `—` | `li` | 66 | 54 | 0.94 of 1950 | template=Standard c=0.96 n=48 | structure | — | CANDIDATE |
...
| 3672 | body | SUBSTITUTED | `div.col-md-8.col-12` | `p` | `div.activity[number=*]` | 47 | 44 | 0.85 of 1950 | template+ptype=Standard/lesson c=0.85 n=42 | structure | yes | CANDIDATE |
| 3673 | body | EXTRA | `div.fundamentalsPanel` | `—` | `div.row` | 44 | 44 | 0.99 of 1950 | era=Refresh c=0.99 n=44 | structure | — | CANDIDATE |
| 3677 | body | EXTRA | `a` | `—` | `div.externalButton` | 65 | 42 | 0.92 of 1950 | template=Standard c=0.93 n=58 | structure | — | CANDIDATE |
| 3679 | body | EXTRA | `tr` | `—` | `th` | 46 | 42 | 0.99 of 1950 | template=Standard c=0.99 n=37 | structure | — | CANDIDATE |
| 3681 | body | EXTRA | `div.col-12` | `—` | `p` | 67 | 40 | 0.86 of 1950 | template=Standard c=0.88 n=60 | structure | — | CANDIDATE |
| 3683 | body | EXTRA | `tr` | `—` | `td` | 44 | 40 | 0.95 of 1950 | template=Standard c=0.95 n=36 | structure | — | CANDIDATE |
| 3684 | body | EXTRA | `div.row` | `—` | `div.col-md-6.col-12` | 56 | 39 | 0.99 of 1950 | subject=Online Safety (OS9000) c=1.00 n=20 | structure | — | CANDIDATE |
| 3685 | body | SUBSTITUTED | `div.col-md-8.col-12` | `p` | `p` | 54 | 39 | 0.85 of 1950 | template+ptype=Standard/lesson c=0.85 n=37 | structure | — | CANDIDATE |
| 3686 | body | EXTRA | `div#body` | `—` | `div.row.supervisor` | 51 | 39 | 0.88 of 1950 | ptype=lesson c=0.89 n=46 | structure | yes | CANDIDATE |
| 3688 | body | EXTRA | `div.alert` | `—` | `div.row` | 51 | 38 | 0.91 of 1950 | template=Standard c=0.92 n=39 | structure | — | CANDIDATE |
| 3689 | body | EXTRA | `p` | `—` | `i` | 44 | 38 | 0.97 of 1950 | template=Standard c=0.97 n=40 | structure | — | CANDIDATE |
...
| 3719 | body | EXTRA | `div.row` | `—` | `div.col-md-4.offset-md-0.col-12` | 27 | 27 | 0.79 of 1950 | era=Refresh c=0.79 n=27 | structure | — | CANDIDATE |
| 3722 | body | EXTRA | `div.col-md-8.col-12` | `—` | `div.videoSection.icon.ratio.ratio-16x9` | 38 | 26 | 0.91 of 1950 | template=Standard c=0.93 n=30 | structure | yes | CANDIDATE |
| 3726 | body | SUBSTITUTED | `div.col-md-8.col-12` | `p` | `WIDGET` | 27 | 26 | 0.85 of 1950 | era=Refresh c=0.85 n=27 | structure | — | CANDIDATE |
| 3728 | body | EXTRA | `div#body` | `—` | `div.inquiryPanel` | 25 | 25 | 0.99 of 1950 | era=Refresh c=0.99 n=25 | structure | — | CANDIDATE |
| 3732 | body | EXTRA | `div.col-md-8.col-12` | `—` | `p>span.infoTrigger` | 28 | 24 | 0.86 of 1950 | template=Standard c=0.87 n=24 | structure | — | CANDIDATE |
| 3738 | body | EXTRA | `div.col-md-8.col-12` | `—` | `div.row.flipCardsContainer` | 28 | 23 | 0.93 of 1950 | template=Standard c=0.94 n=24 | structure | — | CANDIDATE |
| 3742 | body | EXTRA | `div.alert.solid` | `—` | `div.row` | 31 | 22 | 0.99 of 1950 | template=Standard c=0.99 n=26 | structure | yes | CANDIDATE |
...
| 3763 | body | SUBSTITUTED | `div.col-md-8.col-12` | `p` | `img.img-fluid` | 20 | 20 | 0.85 of 1950 | era=Refresh c=0.85 n=20 | structure | — | CANDIDATE |
| 3767 | body | EXTRA | `div.videoSection.icon.ratio.ratio-16x9` | `—` | `iframe` | 24 | 19 | 0.97 of 1950 | template=Standard c=0.98 n=20 | structure | yes | CANDIDATE |
...
| 3793 | body | EXTRA | `th>b` | `—` | `b` | 22 | 16 | 1.00 of 1950 | era=Refresh c=1.00 n=22 | structure | — | CANDIDATE |
