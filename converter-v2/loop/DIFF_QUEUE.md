...
**Produced:** 2026-09-24 22:43 NZST by `reference/tests/_diff_miner.py` on the CURRENT corpus (pageforge-site HEAD 7fa3ab0; Claude corpus 545 dirs). **Population:** the skeleton gate's own — 2491 paired pages / 530 modules (compare_exclusions.txt honoured; acks / glossary / references pages excluded); parse errors skipped: 0 (must be 0); modules without a parsed WT: 2. Run time 91.0 s.
...
- differing skeleton lines: 276117 — by direction {'MISSING': 144507, 'SUBSTITUTED': 25784, 'EXTRA': 96671, 'MOVED': 9155}
- by region: {'module-code': 23, 'title': 356, 'header': 6, 'module-menu': 13150, 'phases-nav': 57, 'crumbs': 57, 'footer': 2570, 'acks': 1394, 'activity': 98865, 'body': 158043, 'root': 1596}
- classes: 9366 — CANDIDATE 197, below floor 8869, the rest below consensus / not derivable
...
| 560 | activity | MISSING | `div.col-12` | `p` | `—` | 772 | 376 | 0.29 of 2484 | template+ptype=Inquiry/overview c=0.80 n=40 | 0.81 | — | CANDIDATE |
...
| 593 | activity | EXTRA | `p>a` | `—` | `a` | 93 | 79 | 0.98 of 2484 | subject+ptype=1-10 Blended Literacy/lesson c=1.00 n=32 | structure | — | CANDIDATE |
...
| 4042 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p` | 1121 | 416 | 0.82 of 2484 | series=DAN10 c=1.00 n=20 | structure | — | CANDIDATE |
...
| 4045 | body | MISSING | `div.col-12.col-md-8` | `p` | `—` | 619 | 296 | 0.26 of 2484 | template+ptype=Fundamentals/overview c=0.91 n=46 | 0.80 | — | CANDIDATE |
...
| 4047 | body | EXTRA | `div.col-12.col-md-8` | `—` | `WIDGET` | 399 | 245 | 0.93 of 2484 | subject+ptype=NCEA1/lesson c=0.99 n=49 | structure | — | CANDIDATE |
| 4048 | body | MOVED | `div.col-12.col-md-8` | `p` | `p` | 354 | 224 | 0.16 of 2484 | template+ptype=Fundamentals/overview c=0.83 n=43 | structure | — | CANDIDATE |
...
| 4062 | body | EXTRA | `p>b` | `—` | `b` | 194 | 128 | 0.93 of 2484 | subject=1-10 Mathematics c=0.97 n=32 | structure | — | CANDIDATE |
| 4063 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p>a` | 181 | 124 | 0.99 of 2484 | subject=1-10 English c=1.00 n=21 | structure | — | CANDIDATE |
...
| 4081 | body | EXTRA | `a` | `—` | `div.button` | 143 | 85 | 0.99 of 2484 | subject=NCEA1 c=1.00 n=21 | structure | — | CANDIDATE |
...
| 4088 | body | EXTRA | `p>a` | `—` | `a` | 103 | 77 | 0.99 of 2484 | template=Standard c=1.00 n=80 | structure | — | CANDIDATE |
...
| 4110 | body | EXTRA | `div.col-12` | `—` | `p` | 101 | 64 | 0.92 of 2484 | template=Standard c=0.94 n=83 | structure | — | CANDIDATE |
...
| 4200 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `img.img-fluid` | 27 | 26 | 0.85 of 2484 | era=Refresh c=0.85 n=27 | structure | — | CANDIDATE |
| 4201 | body | SUBSTITUTED | `div.row` | `div.col-12.col-md-8` | `div.col-12.col-md-6` | 32 | 25 | 0.98 of 2484 | ptype=lesson c=0.99 n=28 | structure | — | CANDIDATE |
| 4213 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `h3` | 25 | 23 | 0.85 of 2484 | template+ptype=Standard/lesson c=0.85 n=21 | structure | — | CANDIDATE |
| 4214 | body | SUBSTITUTED | `div.row` | `div.col-12.col-md-8` | `p` | 25 | 23 | 0.98 of 2484 | ptype=lesson c=0.99 n=21 | structure | — | CANDIDATE |
...
| 4229 | body | EXTRA | `div.flipCardsContainer.row` | `—` | `div.col-12.col-md-4.paddingLR` | 22 | 21 | 0.97 of 2484 | era=Refresh c=0.97 n=22 | structure | — | CANDIDATE |
...
| 4325 | body | SUBSTITUTED | `div.row` | `div.col-12.col-md-8` | `div.button` | 24 | 12 | 0.98 of 2484 | ptype=lesson c=0.99 n=23 | structure | — | CANDIDATE |
| 9293 | root | EXTRA | `body.container-fluid` | `—` | `div.row` | 272 | 272 | 0.88 of 2491 | subject+ptype=1-10 Mathematics/overview c=0.97 n=33 | structure | — | CANDIDATE |
| 9297 | root | SUBSTITUTED | `#root` | `body` | `body.container-fluid` | 139 | 15 | 0.06 of 2491 | series=PWY10 c=1.00 n=45 | structure | yes | CANDIDATE |
