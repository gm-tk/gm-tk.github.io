...
**Produced:** 2026-09-25 01:13 NZST by `reference/tests/_diff_miner.py` on the CURRENT corpus (pageforge-site HEAD fdbd45f; Claude corpus 545 dirs). **Population:** the skeleton gate's own — 2491 paired pages / 530 modules (compare_exclusions.txt honoured; acks / glossary / references pages excluded); parse errors skipped: 0 (must be 0); modules without a parsed WT: 2. Run time 88.0 s.
...
- differing skeleton lines: 275837 — by direction {'MISSING': 144443, 'SUBSTITUTED': 25669, 'EXTRA': 96593, 'MOVED': 9132}
- by region: {'module-code': 23, 'title': 356, 'header': 6, 'module-menu': 13150, 'phases-nav': 57, 'crumbs': 57, 'footer': 2570, 'acks': 1394, 'activity': 99226, 'body': 157402, 'root': 1596}
- classes: 9353 — CANDIDATE 195, below floor 8859, the rest below consensus / not derivable
...
| 4 | title | MISSING | `div#header` | `h1>span` | `—` | 270 | 128 | 0.24 of 2491 | subject+ptype=Online Safety (OS9000)/overview c=0.93 n=12 | 0.74 | yes | CANDIDATE |
...
| 562 | activity | MISSING | `div.col-12` | `p` | `—` | 769 | 376 | 0.29 of 2484 | template+ptype=Inquiry/overview c=0.80 n=40 | 0.81 | — | CANDIDATE |
| 563 | activity | EXTRA | `div.col-12` | `—` | `p` | 620 | 307 | 0.88 of 2484 | subject=ANZH c=0.99 n=24 | structure | — | CANDIDATE |
| 564 | activity | MISSING | `div.col-12` | `WIDGET` | `—` | 426 | 264 | 0.17 of 2484 | template+ptype=Inquiry/overview c=0.67 n=27 | structure | — | CANDIDATE |
| 566 | activity | MISSING | `div.col-12` | `a` | `—` | 454 | 235 | 0.28 of 2484 | template+ptype=Inquiry/overview c=0.75 n=28 | 0.65 | — | CANDIDATE |
| 567 | activity | MOVED | `div.col-12` | `p` | `p` | 319 | 216 | 0.19 of 2484 | template+ptype=Inquiry/overview c=0.77 n=25 | structure | — | CANDIDATE |
| 568 | activity | EXTRA | `div.col-12` | `—` | `WIDGET` | 350 | 213 | 0.82 of 2484 | subject=NCEA1 c=0.96 n=36 | structure | — | CANDIDATE |
| 569 | activity | MISSING | `div.col-12` | `h3` | `—` | 398 | 197 | 0.30 of 2484 | template+ptype=Fundamentals/overview c=0.85 n=31 | 0.70 | — | CANDIDATE |
| 570 | activity | SUBSTITUTED | `div.col-12.col-md-8` | `div.activity.interactive[number=*]` | `div.activity[number=*]` | 283 | 193 | 0.44 of 2484 | template=Fundamentals c=0.77 n=20 | structure | yes | CANDIDATE |
| 571 | activity | MISSING | `div.col-12` | `div.row` | `—` | 238 | 174 | 0.21 of 2484 | template+ptype=Bilingual/lesson c=0.61 n=21 | 0.95 | — | CANDIDATE |
| 572 | activity | MISSING | `div.activity.interactive[number=*]` | `div.row` | `—` | 280 | 170 | 0.12 of 2484 | template+ptype=Fundamentals/overview c=0.65 n=35 | 0.92 | yes | CANDIDATE |
| 573 | activity | EXTRA | `div.col-12` | `—` | `img.img-fluid` | 257 | 158 | 0.97 of 2484 | subject+ptype=1-10 English/lesson c=0.99 n=22 | structure | — | CANDIDATE |
| 574 | activity | MOVED | `div.col-12` | `p` | `p` | 167 | 130 | 0.15 of 2484 | template+ptype=Inquiry/overview c=0.77 n=21 | structure | — | CANDIDATE |
| 575 | activity | EXTRA | `div.row` | `—` | `div.col-12` | 165 | 120 | 0.90 of 2484 | template=Standard c=0.93 n=135 | structure | — | CANDIDATE |
...
| 584 | activity | SUBSTITUTED | `div.col-12` | `p` | `p` | 129 | 97 | 0.75 of 2484 | subject+ptype=1-10 Blended Literacy/lesson c=0.92 n=21 | structure | — | CANDIDATE |
...
| 588 | activity | EXTRA | `div.col-12` | `—` | `p>b` | 137 | 87 | 0.97 of 2484 | template=Standard c=0.98 n=88 | structure | — | CANDIDATE |
| 590 | activity | EXTRA | `p>b` | `—` | `b` | 119 | 86 | 0.92 of 2484 | template=Standard c=0.94 n=72 | structure | — | CANDIDATE |
| 591 | activity | EXTRA | `div.col-12` | `—` | `h3` | 114 | 85 | 0.86 of 2484 | template=Standard c=0.92 n=66 | structure | — | CANDIDATE |
| 592 | activity | EXTRA | `div.col-12` | `—` | `ol` | 128 | 84 | 0.96 of 2484 | subject=1-10 Mathematics c=0.98 n=31 | structure | — | CANDIDATE |
...
| 599 | activity | SUBSTITUTED | `div.col-12` | `WIDGET` | `p` | 89 | 72 | 0.59 of 2484 | subject+ptype=1-10 Mathematics/lesson c=0.77 n=28 | structure | — | CANDIDATE |
| 600 | activity | EXTRA | `div.activity.interactive[number=*]` | `—` | `div.row` | 90 | 71 | 0.79 of 2484 | template=Standard c=0.83 n=72 | structure | yes | CANDIDATE |
| 602 | activity | EXTRA | `div.col-12` | `—` | `a` | 84 | 68 | 0.72 of 2484 | template=Standard c=0.73 n=66 | structure | — | CANDIDATE |
| 605 | activity | EXTRA | `div.col-12` | `—` | `h4.goJournal` | 145 | 65 | 0.95 of 2484 | series=HIS10 c=1.00 n=27 | structure | — | CANDIDATE |
| 608 | activity | SUBSTITUTED | `div.col-12` | `p` | `WIDGET` | 71 | 64 | 0.75 of 2484 | template+ptype=Standard/lesson c=0.88 n=53 | structure | — | CANDIDATE |
...
| 618 | activity | EXTRA | `div.col-12.col-md-8` | `—` | `div.activity[number=*]` | 59 | 53 | 0.96 of 2484 | template=Standard c=0.98 n=44 | structure | yes | CANDIDATE |
...
| 621 | activity | EXTRA | `div.col-12` | `—` | `p>i` | 58 | 51 | 0.97 of 2484 | template=Standard c=0.98 n=47 | structure | — | CANDIDATE |
...
| 652 | activity | EXTRA | `p` | `—` | `b` | 46 | 36 | 0.97 of 2484 | template=Standard c=0.97 n=36 | structure | — | CANDIDATE |
...
| 657 | activity | EXTRA | `ul` | `—` | `li` | 36 | 35 | 0.93 of 2484 | template=Standard c=0.95 n=28 | structure | — | CANDIDATE |
...
| 664 | activity | EXTRA | `div.col-12` | `—` | `div.ratio.ratio-16x9.videoSection` | 43 | 31 | 0.96 of 2484 | template=Standard c=0.97 n=27 | structure | yes | CANDIDATE |
| 673 | activity | SUBSTITUTED | `div.row` | `div.col-12` | `WIDGET` | 29 | 28 | 0.78 of 2484 | ptype=lesson c=0.92 n=21 | structure | — | CANDIDATE |
| 684 | activity | SUBSTITUTED | `div.col-12` | `WIDGET` | `ol` | 27 | 24 | 0.59 of 2484 | ptype=lesson c=0.68 n=22 | structure | — | CANDIDATE |
| 685 | activity | EXTRA | `div.icon.ratio.ratio-16x9.videoSection` | `—` | `iframe` | 26 | 24 | 0.99 of 2484 | era=Refresh c=0.99 n=26 | structure | yes | CANDIDATE |
| 691 | activity | EXTRA | `div.col-12` | `—` | `h5` | 27 | 23 | 0.99 of 2484 | template=Standard c=0.99 n=21 | structure | — | CANDIDATE |
| 695 | activity | SUBSTITUTED | `div.activity.interactive[number=*]` | `div.row` | `WIDGET` | 25 | 22 | 0.55 of 2484 | ptype=lesson c=0.63 n=20 | structure | yes | CANDIDATE |
| 696 | activity | SUBSTITUTED | `div.row` | `div.col-12` | `div.col-12.col-md-8` | 24 | 22 | 0.78 of 2484 | era=Refresh c=0.78 n=24 | structure | — | CANDIDATE |
| 707 | activity | SUBSTITUTED | `div.row` | `div.col-12` | `div.row` | 23 | 21 | 0.78 of 2484 | era=Refresh c=0.78 n=23 | structure | — | CANDIDATE |
...
| 723 | activity | EXTRA | `div.col-12` | `—` | `div.TKmodal` | 23 | 18 | 1.00 of 2484 | era=Refresh c=1.00 n=23 | structure | — | CANDIDATE |
| 728 | activity | EXTRA | `div.col-12` | `—` | `div.button` | 34 | 17 | 1.00 of 2484 | template=Standard c=1.00 n=30 | structure | yes | CANDIDATE |
...
| 737 | activity | SUBSTITUTED | `div.col-12` | `h3` | `h3` | 20 | 16 | 0.76 of 2484 | template+ptype=Standard/lesson c=0.89 n=20 | structure | — | CANDIDATE |
...
| 1077 | activity | EXTRA | `div.activity.clickDropContent.dropbox[nu` | `—` | `a` | 23 | 4 | 1.00 of 2484 | era=Refresh c=1.00 n=23 | structure | yes | CANDIDATE |
| 1078 | activity | EXTRA | `div.activity.dropbox[number=*]` | `—` | `a` | 21 | 4 | 0.99 of 2484 | era=Refresh c=0.99 n=21 | structure | yes | CANDIDATE |
| 4035 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p` | 1109 | 414 | 0.82 of 2484 | series=DAN10 c=1.00 n=20 | structure | — | CANDIDATE |
...
| 4037 | body | MISSING | `div#body` | `div.row` | `—` | 1381 | 350 | 0.34 of 2484 | series=CEDO50 c=0.76 n=20 | 0.87 | — | CANDIDATE |
| 4038 | body | MISSING | `div.col-12.col-md-8` | `p` | `—` | 624 | 298 | 0.26 of 2484 | template+ptype=Fundamentals/overview c=0.91 n=46 | 0.80 | — | CANDIDATE |
| 4039 | body | EXTRA | `div.col-12.col-md-8` | `—` | `img.img-fluid` | 557 | 252 | 0.96 of 2484 | template+ptype=Standard/overview c=1.00 n=27 | structure | — | CANDIDATE |
...
| 4041 | body | MOVED | `div.col-12.col-md-8` | `p` | `p` | 353 | 224 | 0.16 of 2484 | template+ptype=Fundamentals/overview c=0.83 n=43 | structure | — | CANDIDATE |
| 4042 | body | EXTRA | `div.row` | `—` | `div.col-12.col-md-8` | 292 | 209 | 0.85 of 2484 | subject+ptype=1-10 Blended Literacy/lesson c=0.97 n=24 | structure | — | CANDIDATE |
| 4043 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p>b` | 331 | 206 | 0.97 of 2484 | subject=1-10 Blended Literacy c=1.00 n=46 | structure | — | CANDIDATE |
| 4044 | body | SUBSTITUTED | `div.row` | `div.col-12` | `div.col-12.col-md-8` | 330 | 191 | 0.54 of 2484 | subject+ptype=1-10 Blended Literacy/overview c=0.96 n=67 | structure | — | CANDIDATE |
| 4046 | body | EXTRA | `div.col-12.col-md-8` | `—` | `ul` | 308 | 183 | 0.95 of 2484 | subject=1-10 Mathematics c=0.98 n=21 | structure | — | CANDIDATE |
| 4047 | body | EXTRA | `div.col-12.col-md-8` | `—` | `h3` | 293 | 181 | 0.82 of 2484 | subject+ptype=1-10 Blended Literacy/overview c=1.00 n=20 | structure | — | CANDIDATE |
...
| 4049 | body | MISSING | `div.row` | `div.col-12.col-md-8` | `—` | 318 | 172 | 0.29 of 2484 | template=Fundamentals c=0.78 n=22 | 0.94 | — | CANDIDATE |
| 4051 | body | MISSING | `div.col-12.col-md-8` | `h3` | `—` | 249 | 154 | 0.18 of 2484 | template+ptype=Fundamentals/overview c=0.75 n=21 | 0.89 | — | CANDIDATE |
...
| 4055 | body | EXTRA | `p>b` | `—` | `b` | 193 | 127 | 0.93 of 2484 | subject=1-10 Mathematics c=0.97 n=32 | structure | — | CANDIDATE |
| 4056 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p>a` | 181 | 124 | 0.99 of 2484 | subject=1-10 English c=1.00 n=21 | structure | — | CANDIDATE |
| 4057 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.table-responsive` | 165 | 118 | 0.92 of 2484 | ptype=overview c=0.95 n=21 | structure | — | CANDIDATE |
| 4059 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.ratio.ratio-16x9.videoSection` | 183 | 115 | 0.93 of 2484 | subject=NCEA1 c=0.98 n=21 | structure | yes | CANDIDATE |
...
| 4068 | body | EXTRA | `p` | `—` | `b` | 122 | 95 | 0.93 of 2484 | subject=NCEA1 c=0.96 n=30 | structure | — | CANDIDATE |
...
| 4073 | body | EXTRA | `a` | `—` | `div.button` | 143 | 85 | 0.99 of 2484 | subject=NCEA1 c=1.00 n=21 | structure | — | CANDIDATE |
| 4075 | body | EXTRA | `div.col-12.col-md-8` | `—` | `ol` | 109 | 84 | 0.99 of 2484 | template=Standard c=0.99 n=84 | structure | — | CANDIDATE |
| 4076 | body | EXTRA | `p>i` | `—` | `i` | 109 | 83 | 0.90 of 2484 | subject=1-10 Blended Literacy c=0.95 n=26 | structure | — | CANDIDATE |
| 4078 | body | SUBSTITUTED | `div.icon.ratio.ratio-16x9.videoSection` | `iframe.embed-responsive-item` | `iframe` | 211 | 79 | 0.19 of 2484 | series=PES10 c=0.67 n=37 | structure | yes | CANDIDATE |
...
| 4082 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p>i` | 106 | 76 | 0.98 of 2484 | subject=NCEA1 c=0.99 n=29 | structure | — | CANDIDATE |
| 4083 | body | EXTRA | `div.row` | `—` | `div.col-12` | 140 | 75 | 0.71 of 2484 | subject=ANZH c=0.75 n=22 | structure | — | CANDIDATE |
...
| 4089 | body | MOVED | `div.col-12.col-md-8` | `h3` | `h3` | 86 | 71 | 0.11 of 2484 | template+ptype=Fundamentals/overview c=0.67 n=24 | structure | — | CANDIDATE |
| 4093 | body | EXTRA | `table.table.table-bordered` | `—` | `tr` | 98 | 69 | 0.98 of 2484 | template=Standard c=0.98 n=84 | structure | yes | CANDIDATE |
| 4095 | body | EXTRA | `div.fundamentalsPanel` | `—` | `div.row` | 74 | 69 | 0.99 of 2484 | era=Refresh c=0.99 n=74 | structure | — | CANDIDATE |
| 4100 | body | EXTRA | `a` | `—` | `div.externalButton` | 91 | 66 | 0.93 of 2484 | template=Standard c=0.93 n=78 | structure | — | CANDIDATE |
| 4103 | body | EXTRA | `div.col-12` | `—` | `p` | 101 | 64 | 0.92 of 2484 | template=Standard c=0.94 n=83 | structure | — | CANDIDATE |
| 4104 | body | EXTRA | `div.col-12.col-md-8` | `—` | `h4` | 78 | 64 | 0.97 of 2484 | template=Standard c=0.98 n=37 | structure | — | CANDIDATE |
| 4108 | body | EXTRA | `ul` | `—` | `li` | 72 | 62 | 0.95 of 2484 | template=Standard c=0.96 n=49 | structure | — | CANDIDATE |
...
| 4110 | body | SUBSTITUTED | `div.row` | `div.col-12.col-md-8` | `div.col-12.col-md-8` | 65 | 57 | 0.98 of 2484 | ptype=lesson c=0.99 n=39 | structure | — | CANDIDATE |
| 4112 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `p` | 71 | 54 | 0.85 of 2484 | template+ptype=Standard/lesson c=0.85 n=50 | structure | — | CANDIDATE |
| 4113 | body | EXTRA | `div.alert` | `—` | `div.row` | 66 | 54 | 0.91 of 2484 | template=Standard c=0.92 n=47 | structure | — | CANDIDATE |
| 4114 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.alert` | 67 | 53 | 0.90 of 2484 | template=Standard c=0.91 n=51 | structure | — | CANDIDATE |
| 4116 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `div.activity[number=*]` | 58 | 52 | 0.85 of 2484 | template+ptype=Standard/lesson c=0.85 n=50 | structure | yes | CANDIDATE |
| 4121 | body | EXTRA | `tr` | `—` | `td` | 58 | 49 | 0.95 of 2484 | template=Standard c=0.95 n=52 | structure | — | CANDIDATE |
| 4123 | body | EXTRA | `div.inquiryPanel` | `—` | `div.row` | 49 | 48 | 0.99 of 2484 | era=Refresh c=0.99 n=49 | structure | — | CANDIDATE |
| 4127 | body | EXTRA | `div.row` | `—` | `div.col-12.col-md-6` | 69 | 46 | 0.99 of 2484 | subject=Online Safety (OS9000) c=1.00 n=25 | structure | — | CANDIDATE |
| 4129 | body | EXTRA | `div.col-12.col-md-8` | `—` | `h4.goJournal` | 60 | 46 | 1.00 of 2484 | subject=NCEA1 c=1.00 n=21 | structure | — | CANDIDATE |
| 4133 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.icon.ratio.ratio-16x9.videoSection` | 62 | 44 | 0.92 of 2484 | template=Standard c=0.93 n=54 | structure | yes | CANDIDATE |
| 4136 | body | SUBSTITUTED | `div.row` | `div.col-12.col-md-8` | `WIDGET` | 47 | 44 | 0.98 of 2484 | ptype=lesson c=0.99 n=39 | structure | — | CANDIDATE |
...
| 4147 | body | EXTRA | `div.alert.solid` | `—` | `div.row` | 48 | 38 | 0.99 of 2484 | template=Standard c=0.99 n=39 | structure | yes | CANDIDATE |
| 4150 | body | EXTRA | `div.col-12.col-md-8` | `—` | `h5` | 45 | 37 | 0.99 of 2484 | template=Standard c=0.99 n=28 | structure | — | CANDIDATE |
...
| 4160 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p>span.infoTrigger` | 36 | 32 | 0.87 of 2484 | template=Standard c=0.87 n=30 | structure | — | CANDIDATE |
| 4163 | body | EXTRA | `div#body` | `—` | `div.fundamentalsPanel` | 38 | 31 | 0.98 of 2484 | era=Refresh c=0.98 n=38 | structure | yes | CANDIDATE |
| 4167 | body | SUBSTITUTED | `div.row` | `div.col-12.col-md-8` | `div.row` | 32 | 31 | 0.98 of 2484 | era=Refresh c=0.98 n=32 | structure | — | CANDIDATE |
...
| 4193 | body | EXTRA | `div.inquiryPanel.showing` | `—` | `div.row` | 28 | 26 | 0.99 of 2484 | era=Refresh c=0.99 n=28 | structure | yes | CANDIDATE |
| 4195 | body | SUBSTITUTED | `div.row` | `div.col-12.col-md-8` | `div.col-12.col-md-6` | 32 | 25 | 0.98 of 2484 | ptype=lesson c=0.99 n=28 | structure | — | CANDIDATE |
...
| 4208 | body | SUBSTITUTED | `div.row` | `div.col-12.col-md-8` | `p` | 25 | 23 | 0.98 of 2484 | ptype=lesson c=0.99 n=21 | structure | — | CANDIDATE |
| 4211 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `div.alert` | 32 | 22 | 0.85 of 2484 | template+ptype=Standard/lesson c=0.85 n=22 | structure | — | CANDIDATE |
| 4213 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.alert.solid` | 27 | 22 | 0.99 of 2484 | template=Standard c=0.99 n=21 | structure | yes | CANDIDATE |
| 4216 | body | EXTRA | `p>span.infoTrigger` | `—` | `span.infoTrigger` | 24 | 22 | 0.95 of 2484 | era=Refresh c=0.95 n=24 | structure | — | CANDIDATE |
| 4217 | body | EXTRA | `div.col-12.col-md-8` | `—` | `h2` | 24 | 22 | 0.98 of 2484 | era=Refresh c=0.98 n=24 | structure | — | CANDIDATE |
| 4222 | body | EXTRA | `div.flipCardsContainer.row` | `—` | `div.col-12.col-md-4.paddingLR` | 22 | 21 | 0.97 of 2484 | era=Refresh c=0.97 n=22 | structure | — | CANDIDATE |
| 4240 | body | SUBSTITUTED | `div#body` | `div.row` | `div.table-responsive` | 24 | 18 | 0.94 of 2484 | template+ptype=Standard/lesson c=0.98 n=20 | structure | — | CANDIDATE |
| 4242 | body | EXTRA | `div.col-12.col-md-6` | `—` | `img.img-fluid` | 22 | 18 | 0.99 of 2484 | era=Refresh c=0.99 n=22 | structure | — | CANDIDATE |
| 4246 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `div.activity.interactive[number=*]` | 21 | 18 | 0.85 of 2484 | template+ptype=Standard/lesson c=0.85 n=20 | structure | yes | CANDIDATE |
...
| 9280 | root | EXTRA | `body.container-fluid` | `—` | `div.row` | 272 | 272 | 0.88 of 2491 | subject+ptype=1-10 Mathematics/overview c=0.97 n=33 | structure | — | CANDIDATE |
| 9284 | root | SUBSTITUTED | `#root` | `body` | `body.container-fluid` | 139 | 15 | 0.06 of 2491 | series=PWY10 c=1.00 n=45 | structure | yes | CANDIDATE |
...
- pages 270 / modules 128 / lines 274; consensus (all) 0.24 of 2491 gold pages with the region; derivable 0.74 (70 lines with no WT source)
