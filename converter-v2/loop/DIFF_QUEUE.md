...
**Produced:** 2026-09-24 15:21 NZST by `reference/tests/_diff_miner.py` on the CURRENT corpus (pageforge-site HEAD d34b067; Claude corpus 545 dirs). **Population:** the skeleton gate's own — 2487 paired pages / 529 modules (compare_exclusions.txt honoured; acks / glossary / references pages excluded); parse errors skipped: 0 (must be 0); modules without a parsed WT: 2. Run time 85.4 s.
...
- differing skeleton lines: 275037 — by direction {'MISSING': 144091, 'SUBSTITUTED': 25736, 'EXTRA': 96083, 'MOVED': 9127}
- by region: {'module-code': 23, 'title': 352, 'header': 6, 'module-menu': 13142, 'phases-nav': 57, 'crumbs': 57, 'footer': 2560, 'acks': 1390, 'activity': 98431, 'body': 157425, 'root': 1594}
- classes: 9355 — CANDIDATE 197, below floor 8858, the rest below consensus / not derivable
...
| 562 | activity | MOVED | `div.col-12` | `p` | `p` | 324 | 216 | 0.19 of 2480 | template+ptype=Inquiry/overview c=0.77 n=25 | structure | — | CANDIDATE |
| 563 | activity | EXTRA | `div.col-12` | `—` | `WIDGET` | 348 | 212 | 0.82 of 2480 | subject=NCEA1 c=0.96 n=36 | structure | — | CANDIDATE |
| 564 | activity | MISSING | `div.col-12` | `h3` | `—` | 401 | 198 | 0.30 of 2480 | template+ptype=Fundamentals/overview c=0.85 n=31 | 0.71 | — | CANDIDATE |
...
| 579 | activity | SUBSTITUTED | `div.col-12` | `p` | `p` | 135 | 99 | 0.75 of 2480 | subject+ptype=1-10 Blended Literacy/lesson c=0.92 n=21 | structure | — | CANDIDATE |
...
| 589 | activity | EXTRA | `div.col-12` | `—` | `h3` | 101 | 81 | 0.86 of 2480 | template=Standard c=0.92 n=66 | structure | — | CANDIDATE |
...
| 643 | activity | EXTRA | `a` | `—` | `div.externalButton` | 50 | 38 | 0.92 of 2480 | template=Standard c=0.92 n=37 | structure | — | CANDIDATE |
...
| 665 | activity | EXTRA | `div.col-12` | `—` | `div.ratio.ratio-16x9.videoSection` | 40 | 28 | 0.99 of 2480 | template=Standard c=0.99 n=27 | structure | yes | CANDIDATE |
...
| 829 | activity | MISSING | `div.col-12.col-md-8` | `div.activity.dropbox[number=*]` | `—` | 24 | 9 | 0.03 of 2480 | series=XDLS90 c=0.68 n=20 | 1.00 | yes | CANDIDATE |
| 1068 | activity | EXTRA | `div.activity.clickDropContent.dropbox[nu` | `—` | `a` | 23 | 4 | 1.00 of 2480 | era=Refresh c=1.00 n=23 | structure | yes | CANDIDATE |
| 1069 | activity | EXTRA | `div.activity.dropbox[number=*]` | `—` | `a` | 21 | 4 | 0.99 of 2480 | era=Refresh c=0.99 n=21 | structure | yes | CANDIDATE |
| 4039 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p` | 1119 | 415 | 0.82 of 2480 | series=DAN10 c=1.00 n=20 | structure | — | CANDIDATE |
| 4040 | body | EXTRA | `div#body` | `—` | `div.row` | 1432 | 388 | 0.73 of 2480 | subject+ptype=1-10 Blended Literacy/overview c=1.00 n=30 | structure | — | CANDIDATE |
| 4041 | body | MISSING | `div#body` | `div.row` | `—` | 1381 | 349 | 0.34 of 2480 | series=CEDO50 c=0.76 n=20 | 0.87 | — | CANDIDATE |
| 4042 | body | MISSING | `div.col-12.col-md-8` | `p` | `—` | 620 | 296 | 0.26 of 2480 | template+ptype=Fundamentals/overview c=0.91 n=46 | 0.80 | — | CANDIDATE |
| 4043 | body | EXTRA | `div.col-12.col-md-8` | `—` | `img.img-fluid` | 563 | 255 | 0.96 of 2480 | template+ptype=Standard/overview c=1.00 n=27 | structure | — | CANDIDATE |
| 4044 | body | EXTRA | `div.col-12.col-md-8` | `—` | `WIDGET` | 399 | 246 | 0.93 of 2480 | subject+ptype=NCEA1/lesson c=0.99 n=48 | structure | — | CANDIDATE |
| 4045 | body | MOVED | `div.col-12.col-md-8` | `p` | `p` | 354 | 223 | 0.16 of 2480 | template+ptype=Fundamentals/overview c=0.83 n=43 | structure | — | CANDIDATE |
| 4046 | body | EXTRA | `div.row` | `—` | `div.col-12.col-md-8` | 295 | 209 | 0.85 of 2480 | subject+ptype=1-10 Blended Literacy/lesson c=0.97 n=24 | structure | — | CANDIDATE |
| 4047 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p>b` | 340 | 207 | 0.97 of 2480 | subject=1-10 Blended Literacy c=1.00 n=46 | structure | — | CANDIDATE |
| 4048 | body | SUBSTITUTED | `div.row` | `div.col-12` | `div.col-12.col-md-8` | 330 | 191 | 0.54 of 2480 | subject+ptype=1-10 Blended Literacy/overview c=0.96 n=67 | structure | — | CANDIDATE |
| 4049 | body | EXTRA | `div.col-12.col-md-8` | `—` | `h3` | 310 | 185 | 0.89 of 2480 | subject+ptype=1-10 Blended Literacy/overview c=1.00 n=20 | structure | — | CANDIDATE |
| 4050 | body | EXTRA | `div.col-12.col-md-8` | `—` | `ul` | 306 | 182 | 0.95 of 2480 | subject=1-10 Mathematics c=0.98 n=21 | structure | — | CANDIDATE |
| 4052 | body | MISSING | `div.col-12.col-md-8` | `WIDGET` | `—` | 271 | 177 | 0.19 of 2480 | template+ptype=Fundamentals/overview c=0.65 n=32 | structure | — | CANDIDATE |
| 4053 | body | MISSING | `div.row` | `div.col-12.col-md-8` | `—` | 317 | 171 | 0.29 of 2480 | template=Fundamentals c=0.78 n=22 | 0.94 | — | CANDIDATE |
| 4055 | body | MISSING | `div.col-12.col-md-8` | `h3` | `—` | 247 | 153 | 0.18 of 2480 | template+ptype=Fundamentals/overview c=0.75 n=21 | 0.90 | — | CANDIDATE |
| 4056 | body | EXTRA | `div.col-12.col-md-8` | `—` | `a` | 225 | 152 | 0.98 of 2480 | subject+ptype=ConnectED/lesson c=1.00 n=25 | structure | — | CANDIDATE |
| 4059 | body | EXTRA | `p>b` | `—` | `b` | 193 | 128 | 0.93 of 2480 | subject=1-10 Mathematics c=0.97 n=31 | structure | — | CANDIDATE |
| 4060 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p>a` | 176 | 121 | 0.99 of 2480 | subject=1-10 English c=1.00 n=20 | structure | — | CANDIDATE |
...
| 4063 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.ratio.ratio-16x9.videoSection` | 186 | 117 | 0.93 of 2480 | subject=NCEA1 c=0.98 n=21 | structure | yes | CANDIDATE |
| 4071 | body | EXTRA | `p` | `—` | `b` | 124 | 96 | 0.93 of 2480 | subject=NCEA1 c=0.96 n=30 | structure | — | CANDIDATE |
| 4072 | body | MOVED | `div.col-12.col-md-8` | `p` | `p` | 131 | 95 | 0.18 of 2480 | template+ptype=Inquiry/overview c=0.62 n=20 | structure | — | CANDIDATE |
| 4073 | body | EXTRA | `div.table-responsive` | `—` | `table.table.table-bordered` | 144 | 94 | 0.96 of 2480 | subject=NCEA1 c=0.97 n=29 | structure | yes | CANDIDATE |
| 4077 | body | EXTRA | `a` | `—` | `div.button` | 148 | 90 | 0.99 of 2480 | subject=NCEA1 c=1.00 n=22 | structure | — | CANDIDATE |
| 4079 | body | EXTRA | `p>i` | `—` | `i` | 110 | 84 | 0.97 of 2480 | subject+ptype=1-10 Blended Literacy/overview c=1.00 n=26 | structure | — | CANDIDATE |
| 4080 | body | EXTRA | `div.col-12.col-md-8` | `—` | `ol` | 108 | 83 | 0.99 of 2480 | template=Standard c=0.99 n=84 | structure | — | CANDIDATE |
| 4082 | body | SUBSTITUTED | `div.icon.ratio.ratio-16x9.videoSection` | `iframe.embed-responsive-item` | `iframe` | 211 | 79 | 0.19 of 2480 | series=PES10 c=0.67 n=37 | structure | yes | CANDIDATE |
...
| 4086 | body | EXTRA | `div.col-12.col-md-8` | `—` | `audio.audioPlayer.icon` | 124 | 76 | 1.00 of 2480 | ptype=overview c=1.00 n=35 | structure | yes | CANDIDATE |
| 4087 | body | EXTRA | `div.row` | `—` | `div.col-12` | 140 | 75 | 0.71 of 2480 | subject=ANZH c=0.75 n=22 | structure | — | CANDIDATE |
| 4088 | body | SUBSTITUTED | `div#body` | `div.row` | `WIDGET` | 124 | 75 | 0.94 of 2480 | subject=Online Safety (OS9000) c=1.00 n=27 | structure | — | CANDIDATE |
| 4091 | body | MOVED | `div.col-12.col-md-8` | `h3` | `h3` | 88 | 73 | 0.11 of 2480 | template+ptype=Fundamentals/overview c=0.67 n=24 | structure | — | CANDIDATE |
| 4094 | body | EXTRA | `table.table.table-bordered` | `—` | `tr` | 98 | 69 | 0.98 of 2480 | template=Standard c=0.98 n=84 | structure | yes | CANDIDATE |
| 4097 | body | EXTRA | `div.fundamentalsPanel` | `—` | `div.row` | 74 | 69 | 0.98 of 2480 | era=Refresh c=0.98 n=74 | structure | — | CANDIDATE |
| 4103 | body | EXTRA | `a` | `—` | `div.externalButton` | 91 | 66 | 0.93 of 2480 | template=Standard c=0.93 n=78 | structure | — | CANDIDATE |
| 4106 | body | EXTRA | `div.col-12.col-md-8` | `—` | `h4` | 77 | 64 | 0.97 of 2480 | template=Standard c=0.98 n=37 | structure | — | CANDIDATE |
| 4108 | body | EXTRA | `div.col-12` | `—` | `p` | 100 | 63 | 0.92 of 2480 | template=Standard c=0.94 n=83 | structure | — | CANDIDATE |
| 4112 | body | EXTRA | `ul` | `—` | `li` | 70 | 60 | 0.95 of 2480 | template=Standard c=0.96 n=49 | structure | — | CANDIDATE |
| 4113 | body | EXTRA | `div.ratio.ratio-16x9.videoSection` | `—` | `iframe` | 75 | 59 | 0.92 of 2480 | template=Standard c=0.94 n=56 | structure | yes | CANDIDATE |
| 4114 | body | SUBSTITUTED | `div.row` | `div.col-12.col-md-8` | `div.col-12.col-md-8` | 65 | 57 | 0.98 of 2480 | ptype=lesson c=0.99 n=39 | structure | — | CANDIDATE |
| 4116 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `p` | 71 | 54 | 0.85 of 2480 | template+ptype=Standard/lesson c=0.85 n=50 | structure | — | CANDIDATE |
| 4117 | body | EXTRA | `div.alert` | `—` | `div.row` | 66 | 54 | 0.91 of 2480 | template=Standard c=0.92 n=47 | structure | — | CANDIDATE |
| 4119 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.alert` | 67 | 53 | 0.90 of 2480 | template=Standard c=0.91 n=51 | structure | — | CANDIDATE |
| 4120 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `div.activity[number=*]` | 58 | 52 | 0.85 of 2480 | template+ptype=Standard/lesson c=0.85 n=50 | structure | yes | CANDIDATE |
| 4124 | body | EXTRA | `tr` | `—` | `td` | 58 | 49 | 0.95 of 2480 | template=Standard c=0.95 n=52 | structure | — | CANDIDATE |
| 4128 | body | EXTRA | `div.inquiryPanel` | `—` | `div.row` | 49 | 48 | 0.99 of 2480 | era=Refresh c=0.99 n=49 | structure | — | CANDIDATE |
| 4133 | body | EXTRA | `div.col-12.col-md-8` | `—` | `h4.goJournal` | 60 | 46 | 1.00 of 2480 | subject=NCEA1 c=1.00 n=21 | structure | — | CANDIDATE |
| 4134 | body | EXTRA | `div.row` | `—` | `div.col-12.col-md-6` | 68 | 45 | 0.99 of 2480 | subject=Online Safety (OS9000) c=1.00 n=25 | structure | — | CANDIDATE |
| 4137 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.icon.ratio.ratio-16x9.videoSection` | 62 | 44 | 0.92 of 2480 | template=Standard c=0.93 n=54 | structure | yes | CANDIDATE |
| 4140 | body | SUBSTITUTED | `div.row` | `div.col-12.col-md-8` | `WIDGET` | 46 | 43 | 0.98 of 2480 | ptype=lesson c=0.99 n=38 | structure | — | CANDIDATE |
| 4143 | body | EXTRA | `div#body` | `—` | `WIDGET` | 80 | 41 | 0.93 of 2480 | template=Bilingual c=0.97 n=21 | structure | — | CANDIDATE |
| 4144 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `WIDGET` | 42 | 41 | 0.85 of 2480 | template+ptype=Standard/lesson c=0.85 n=25 | structure | — | CANDIDATE |
| 4145 | body | MISSING | `div#body` | `div.fundamentalsPanel` | `—` | 45 | 39 | 0.02 of 2480 | template+ptype=Fundamentals/overview c=0.60 n=38 | 0.98 | yes | CANDIDATE |
| 4146 | body | EXTRA | `p` | `—` | `i` | 44 | 39 | 0.96 of 2480 | template=Standard c=0.97 n=40 | structure | — | CANDIDATE |
| 4151 | body | EXTRA | `div.alert.solid` | `—` | `div.row` | 48 | 38 | 0.99 of 2480 | template=Standard c=0.99 n=39 | structure | yes | CANDIDATE |
| 4154 | body | EXTRA | `div.col-12.col-md-8` | `—` | `h5` | 45 | 37 | 0.99 of 2480 | template=Standard c=0.99 n=28 | structure | — | CANDIDATE |
| 4155 | body | EXTRA | `div#body` | `—` | `div.row.supervisor` | 46 | 36 | 0.90 of 2480 | ptype=lesson c=0.91 n=39 | structure | yes | CANDIDATE |
| 4157 | body | MISSING | `div#body` | `div.inquiryPanel` | `—` | 39 | 36 | 0.02 of 2480 | template+ptype=Inquiry/overview c=0.62 n=34 | 0.92 | — | CANDIDATE |
| 4160 | body | EXTRA | `tr` | `—` | `th` | 38 | 34 | 0.99 of 2480 | template=Standard c=1.00 n=33 | structure | — | CANDIDATE |
| 4161 | body | EXTRA | `div.row` | `—` | `div.col-12.col-md-4.offset-md-0` | 34 | 34 | 0.80 of 2480 | template=Standard c=0.81 n=20 | structure | — | CANDIDATE |
| 4164 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p>span.infoTrigger` | 36 | 32 | 0.87 of 2480 | template=Standard c=0.87 n=30 | structure | — | CANDIDATE |
| 4168 | body | EXTRA | `div#body` | `—` | `div.fundamentalsPanel` | 38 | 31 | 0.98 of 2480 | era=Refresh c=0.98 n=38 | structure | yes | CANDIDATE |
| 4173 | body | SUBSTITUTED | `div.row` | `div.col-12.col-md-8` | `div.row` | 32 | 31 | 0.98 of 2480 | era=Refresh c=0.98 n=32 | structure | — | CANDIDATE |
| 4174 | body | EXTRA | `div#body` | `—` | `div.inquiryPanel` | 31 | 31 | 0.98 of 2480 | era=Refresh c=0.98 n=31 | structure | — | CANDIDATE |
| 4178 | body | EXTRA | `div.introduction` | `—` | `div.row` | 30 | 30 | 0.99 of 2480 | era=Refresh c=0.99 n=30 | structure | — | CANDIDATE |
| 4181 | body | EXTRA | `div.icon.ratio.ratio-16x9.videoSection` | `—` | `iframe` | 38 | 29 | 0.97 of 2480 | template=Standard c=0.98 n=33 | structure | yes | CANDIDATE |
| 4183 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.flipCardsContainer.row` | 33 | 29 | 0.93 of 2480 | template=Standard c=0.95 n=27 | structure | — | CANDIDATE |
| 4189 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.clickDropContent` | 32 | 27 | 0.94 of 2480 | template=Standard c=0.94 n=29 | structure | — | CANDIDATE |
| 4193 | body | EXTRA | `div.row` | `—` | `div.col-12.col-md-4` | 33 | 26 | 0.94 of 2480 | template=Standard c=0.95 n=26 | structure | — | CANDIDATE |
| 4196 | body | EXTRA | `div.inquiryPanel.showing` | `—` | `div.row` | 28 | 26 | 0.99 of 2480 | era=Refresh c=0.99 n=28 | structure | yes | CANDIDATE |
| 4197 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `img.img-fluid` | 27 | 26 | 0.85 of 2480 | era=Refresh c=0.85 n=27 | structure | — | CANDIDATE |
| 4198 | body | SUBSTITUTED | `div.row` | `div.col-12.col-md-8` | `div.col-12.col-md-6` | 32 | 25 | 0.98 of 2480 | ptype=lesson c=0.99 n=28 | structure | — | CANDIDATE |
| 4210 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `h3` | 25 | 23 | 0.85 of 2480 | template+ptype=Standard/lesson c=0.85 n=21 | structure | — | CANDIDATE |
| 4211 | body | SUBSTITUTED | `div.row` | `div.col-12.col-md-8` | `p` | 25 | 23 | 0.98 of 2480 | ptype=lesson c=0.99 n=21 | structure | — | CANDIDATE |
| 4214 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `div.alert` | 32 | 22 | 0.85 of 2480 | template+ptype=Standard/lesson c=0.85 n=22 | structure | — | CANDIDATE |
| 4215 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.alert.solid` | 27 | 22 | 0.99 of 2480 | template=Standard c=0.99 n=21 | structure | yes | CANDIDATE |
| 4219 | body | EXTRA | `p>span.infoTrigger` | `—` | `span.infoTrigger` | 24 | 22 | 0.95 of 2480 | era=Refresh c=0.95 n=24 | structure | — | CANDIDATE |
| 4220 | body | EXTRA | `div.col-12.col-md-8` | `—` | `h2` | 24 | 22 | 0.98 of 2480 | era=Refresh c=0.98 n=24 | structure | — | CANDIDATE |
| 4235 | body | EXTRA | `div.flipCardsContainer.row` | `—` | `div.col-12.col-md-4.paddingLR` | 21 | 20 | 0.97 of 2480 | era=Refresh c=0.97 n=21 | structure | — | CANDIDATE |
...
| 4251 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `div.activity.interactive[number=*]` | 21 | 18 | 0.85 of 2480 | template+ptype=Standard/lesson c=0.85 n=20 | structure | yes | CANDIDATE |
| 4288 | body | EXTRA | `div.col-12.col-md-6` | `—` | `p` | 23 | 14 | 1.00 of 2480 | ptype=lesson c=1.00 n=21 | structure | — | CANDIDATE |
| 4321 | body | SUBSTITUTED | `div.row` | `div.col-12.col-md-8` | `div.button` | 24 | 12 | 0.98 of 2480 | ptype=lesson c=0.99 n=23 | structure | — | CANDIDATE |
| 9282 | root | EXTRA | `body.container-fluid` | `—` | `div.row` | 272 | 272 | 0.88 of 2487 | subject+ptype=1-10 Mathematics/overview c=0.97 n=33 | structure | — | CANDIDATE |
