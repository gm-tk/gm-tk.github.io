...
**Produced:** 2026-09-18 17:00 NZST by `reference/tests/_diff_miner.py` on the CURRENT corpus (pageforge-site HEAD a691cfd; Claude corpus 416 dirs). **Population:** the skeleton gate's own — 1956 paired pages / 405 modules (compare_exclusions.txt honoured; acks / glossary / references pages excluded); parse errors skipped: 0 (must be 0); modules without a parsed WT: 2. Run time 70.0 s.
...
- differing skeleton lines: 229017 — by direction {'MISSING': 119730, 'SUBSTITUTED': 21010, 'EXTRA': 80380, 'MOVED': 7897}
- by region: {'module-code': 15, 'title': 251, 'header': 5, 'module-menu': 11986, 'phases-nav': 43, 'crumbs': 179, 'footer': 2085, 'acks': 1177, 'activity': 83655, 'body': 128212, 'root': 1409}
- classes: 8352 — CANDIDATE 177, below floor 7925, the rest below consensus / not derivable
...
|---|---|---|---|---|---|---|---|---|
| module-menu | 1246 | 13989 | 13016 | 10997 | 4402 | 618 | 168 | CANDIDATE (verify by eye — text presence, not position) |
...
| 25 | module-menu | SUBSTITUTED | `div.col-md-6.col-12.paddingR` | `p` | `h5` | 83 | 83 | 0.07 of 1956 | subject=1-10 Health and PE c=0.93 n=14 | structure | yes | CANDIDATE |
| 26 | module-menu | MISSING | `ul` | `li` | `—` | 107 | 72 | 0.11 of 1956 | subject+ptype=1-10 Blended Literacy/overview c=0.66 n=21 | 0.88 | — | CANDIDATE |
| 27 | module-menu | EXTRA | `div.row` | `—` | `div.col-md-6.col-12.paddingR` | 64 | 47 | 0.96 of 1956 | template=Standard c=0.96 n=40 | structure | yes | CANDIDATE |
| 28 | module-menu | EXTRA | `ul` | `—` | `li` | 67 | 39 | 0.77 of 1956 | ptype=lesson c=0.83 n=12 | structure | — | CANDIDATE |
| 29 | module-menu | SUBSTITUTED | `div.col-md-6.col-12.paddingL` | `p` | `h5` | 38 | 38 | 0.03 of 1956 | subject=1-10 Health and PE c=0.93 n=14 | structure | yes | CANDIDATE |
| 30 | module-menu | MISSING | `div.col-md-8.col-12` | `p` | `—` | 158 | 35 | 0.09 of 1956 | — | 0.97 | — | BELOW CONSENSUS (no group ≥ 0.60 at the floor) |
| 31 | module-menu | MISSING | `div.col-md-6.col-12.paddingR` | `p` | `—` | 46 | 35 | 0.05 of 1956 | subject+ptype=1-10 Blended Literacy/overview c=0.78 n=23 | 0.68 | yes | CANDIDATE |
| 32 | module-menu | MISSING | `div.col-md-8.col-12` | `ul` | `—` | 130 | 32 | 0.29 of 1956 | — | 0.92 | — | BELOW CONSENSUS (no group ≥ 0.60 at the floor) |
| 33 | module-menu | MISSING | `div.col-md-8.col-12` | `h5` | `—` | 120 | 25 | 0.22 of 1956 | — | 0.72 | — | BELOW CONSENSUS (no group ≥ 0.60 at the floor) |
...
| 35 | module-menu | EXTRA | `div.col-md-8.col-12` | `—` | `h5` | 62 | 24 | 0.78 of 1956 | era=Refresh c=0.78 n=24 | structure | — | CANDIDATE |
| 36 | module-menu | EXTRA | `div.col-md-8.col-12` | `—` | `p` | 56 | 24 | 0.87 of 1956 | era=Refresh c=0.87 n=24 | structure | — | CANDIDATE |
| 37 | module-menu | EXTRA | `div.col-md-6.col-12.paddingR` | `—` | `p>b` | 22 | 22 | 1.00 of 1956 | era=Refresh c=1.00 n=22 | structure | yes | CANDIDATE |
| 38 | module-menu | MISSING | `div.col-md-6.col-12.paddingR` | `ul` | `—` | 29 | 21 | 0.05 of 1956 | — | 0.77 | yes | BELOW CONSENSUS (no group ≥ 0.60 at the floor) |
| 39 | module-menu | MOVED | `ul` | `li` | `li>i` | 64 | 20 | 0.37 of 1956 | — | structure | — | BELOW CONSENSUS (no group ≥ 0.60 at the floor) |
| 40 | module-menu | MISSING | `p` | `br` | `—` | 35 | 20 | 0.01 of 1956 | — | structure | — | BELOW CONSENSUS (no group ≥ 0.60 at the floor) |
| 41 | module-menu | EXTRA | `div#header` | `—` | `div#module-head-buttons` | 30 | 20 | 0.24 of 1956 | — | structure | yes | BELOW CONSENSUS (no group ≥ 0.60 at the floor) |
| 42 | module-menu | SUBSTITUTED | `div.col-md-6.offset-md-0.col-12` | `p` | `h5` | 26 | 20 | 0.04 of 1956 | — | structure | yes | BELOW CONSENSUS (no group ≥ 0.60 at the floor) |
| 43 | module-menu | MISSING | `div.row` | `div.col-md-6.col-12.paddingL` | `—` | 34 | 19 | 0.04 of 1956 | — | 1.00 | yes | BELOW CONSENSUS (no group ≥ 0.60 at the floor) |
| 44 | module-menu | MISSING | `div.col-md-6.col-12.paddingR` | `h4>span` | `—` | 19 | 19 | 0.02 of 1956 | — | 1.00 | yes | BELOW CONSENSUS (no group ≥ 0.60 at the floor) |
| 45 | module-menu | EXTRA | `div.col-md-6.offset-md-0.col-12` | `—` | `p` | 24 | 18 | 0.99 of 1956 | era=Refresh c=0.99 n=18 | structure | yes | CANDIDATE |
| 46 | module-menu | MISSING | `div.col-md-6.offset-md-0.col-12` | `h3>span` | `—` | 75 | 17 | 0.02 of 1956 | — | 0.95 | yes | BELOW CONSENSUS (no group ≥ 0.60 at the floor) |
| 47 | module-menu | MISSING | `div.row` | `div.col-md-6.offset-md-0.col-12` | `—` | 66 | 17 | 0.05 of 1956 | — | 0.86 | yes | BELOW CONSENSUS (no group ≥ 0.60 at the floor) |
| 48 | module-menu | SUBSTITUTED | `div.col-md-8.col-12` | `p` | `h5` | 62 | 17 | 0.13 of 1956 | — | structure | — | BELOW CONSENSUS (no group ≥ 0.60 at the floor) |
...
| 50 | module-menu | EXTRA | `div.col-md-6.col-12.paddingR` | `—` | `p` | 17 | 17 | 0.94 of 1956 | template=Standard c=0.95 n=14 | structure | yes | CANDIDATE |
| 51 | module-menu | SUBSTITUTED | `ul` | `li` | `li` | 63 | 16 | 0.59 of 1956 | template+ptype=Standard/lesson c=0.63 n=12 | structure | — | CANDIDATE |
| 52 | module-menu | EXTRA | `div.row` | `—` | `div.col-md-12.col-12.paddingR` | 18 | 16 | 0.95 of 1956 | template=Standard c=0.96 n=16 | structure | yes | CANDIDATE |
| 53 | module-menu | EXTRA | `div.row` | `—` | `div.col-md-8.col-12` | 97 | 15 | 0.68 of 1956 | subject=1-10 Mathematics c=0.77 n=12 | structure | — | CANDIDATE |
| 54 | module-menu | EXTRA | `div.col-md-8.col-12` | `—` | `ul` | 37 | 15 | 0.71 of 1956 | era=Refresh c=0.71 n=15 | structure | — | CANDIDATE |
| 55 | module-menu | SUBSTITUTED | `div.col-md-6.col-12.paddingR` | `h4>span` | `h5>span` | 15 | 15 | 0.03 of 1956 | — | structure | yes | BELOW CONSENSUS (no group ≥ 0.60 at the floor) |
| 56 | module-menu | EXTRA | `div.row` | `—` | `div.col-md-6.offset-md-0.col-12` | 30 | 14 | 0.95 of 1956 | era=Refresh c=0.95 n=14 | structure | yes | CANDIDATE |
| 57 | module-menu | SUBSTITUTED | `div.col-md-6.col-12.paddingR` | `ul` | `p>b` | 14 | 14 | 0.07 of 1956 | subject+ptype=1-10 Blended Literacy/overview c=0.85 n=14 | structure | yes | CANDIDATE |
...
| 60 | module-menu | MISSING | `div.col-md-6.offset-md-0.col-12` | `ul` | `—` | 59 | 12 | 0.02 of 1956 | — | 0.98 | yes | BELOW CONSENSUS (no group ≥ 0.60 at the floor) |
| 61 | module-menu | EXTRA | `div.col-md-6.col-12.paddingR` | `—` | `h5` | 14 | 12 | 0.99 of 1956 | ptype=overview c=1.00 n=10 | structure | yes | CANDIDATE |
| 62 | module-menu | MISSING | `div.row` | `div.col-md-6.offset-md-0.col-12.paddingL` | `—` | 12 | 12 | 0.01 of 1956 | — | 0.42 | yes | BELOW CONSENSUS (no group ≥ 0.60 at the floor) |
| 63 | module-menu | SUBSTITUTED | `div.row` | `div.col-md-6.col-12.paddingR` | `div.col-md-12.col-12.paddingR` | 12 | 12 | 0.08 of 1956 | — | structure | yes | BELOW CONSENSUS (no group ≥ 0.60 at the floor) |
| 64 | module-menu | SUBSTITUTED | `div.row` | `WIDGET` | `div.col-md-8.col-12` | 24 | 11 | 0.11 of 1956 | — | structure | — | BELOW CONSENSUS (no group ≥ 0.60 at the floor) |
| 65 | module-menu | SUBSTITUTED | `div.row` | `div.col-md-6.col-12.paddingL` | `div.col-md-6.col-12.paddingR` | 11 | 11 | 0.04 of 1956 | — | structure | yes | BELOW CONSENSUS (no group ≥ 0.60 at the floor) |
...
| 68 | module-menu | SUBSTITUTED | `div.col-md-6.offset-md-0.col-12` | `h3>span` | `h5` | 17 | 10 | 0.05 of 1956 | — | structure | yes | BELOW CONSENSUS (no group ≥ 0.60 at the floor) |
| 69 | module-menu | SUBSTITUTED | `div.row` | `div.col-md-6.offset-md-0.col-12` | `div.col-md-8.col-12` | 56 | 9 | 0.05 of 1956 | — | structure | yes | BELOW FLOOR |
| 70 | module-menu | MISSING | `div#module-menu-content.moduleMenu` | `h5` | `—` | 45 | 9 | 0.04 of 1956 | — | 0.71 | yes | BELOW FLOOR |
| 71 | module-menu | EXTRA | `div.col-md-12.col-12.paddingR` | `—` | `h4>span` | 9 | 9 | 0.97 of 1956 | — | structure | yes | BELOW FLOOR |
| 72 | module-menu | EXTRA | `div.col-md-6.col-12.paddingR` | `—` | `h5>span` | 9 | 9 | 0.97 of 1956 | — | structure | yes | BELOW FLOOR |
| 73 | module-menu | MISSING | `div.col-md-6.col-12.paddingR` | `h5>span` | `—` | 9 | 9 | 0.03 of 1956 | — | 1.00 | yes | BELOW FLOOR |
| 74 | module-menu | SUBSTITUTED | `div.col-md-6.col-12` | `h4>span` | `h5>span` | 9 | 9 | 0.01 of 1956 | — | structure | yes | BELOW FLOOR |
| 75 | module-menu | MISSING | `div.col-md-6.offset-md-0.col-12` | `p` | `—` | 36 | 8 | 0.02 of 1956 | — | 0.91 | yes | BELOW FLOOR |
...
| 79 | module-menu | EXTRA | `div.col-md-6.col-12.paddingL` | `—` | `h5` | 8 | 8 | 1.00 of 1956 | — | structure | yes | BELOW FLOOR |
| 80 | module-menu | MISSING | `h5>span` | `span` | `—` | 8 | 8 | 0.04 of 1956 | — | 1.00 | — | BELOW FLOOR |
| 81 | module-menu | SUBSTITUTED | `div.col-md-6.offset-md-0.col-12.paddingR` | `p` | `h5` | 8 | 8 | 0.01 of 1956 | — | structure | yes | BELOW FLOOR |
| 82 | module-menu | MOVED | `div#module-menu-content.moduleMenu` | `h5` | `h5` | 35 | 7 | 0.04 of 1956 | — | structure | yes | BELOW FLOOR |
| 83 | module-menu | SUBSTITUTED | `div.col-md-6.offset-md-0.col-12` | `h3>span` | `h4>span` | 10 | 7 | 0.05 of 1956 | — | structure | yes | BELOW FLOOR |
| 84 | module-menu | EXTRA | `div.col-md-6.offset-md-0.col-12` | `—` | `ul` | 7 | 7 | 0.98 of 1956 | — | structure | yes | BELOW FLOOR |
| 85 | module-menu | SUBSTITUTED | `div.row` | `div.col-md-12.col-12` | `div.col-md-12.col-12.paddingR` | 7 | 7 | 0.01 of 1956 | — | structure | yes | BELOW FLOOR |
| 86 | module-menu | SUBSTITUTED | `div.row` | `div.col-12` | `div.col-md-8.col-12` | 50 | 6 | 0.03 of 1956 | — | structure | — | BELOW FLOOR |
| 87 | module-menu | SUBSTITUTED | `div.row` | `div.col-md-8.col-12.paddingR` | `div.col-md-8.col-12` | 50 | 6 | 0.03 of 1956 | — | structure | yes | BELOW FLOOR |
| 88 | module-menu | SUBSTITUTED | `div.item` | `div.row` | `div.col-md-8.col-12` | 37 | 6 | 0.03 of 1956 | — | structure | yes | BELOW FLOOR |
| 89 | module-menu | MISSING | `div.col-md-8.col-12.paddingR` | `h5` | `—` | 30 | 6 | 0.02 of 1956 | — | 1.00 | yes | BELOW FLOOR |
| 90 | module-menu | SUBSTITUTED | `div.row` | `div.col-md-12.col-12.paddingR` | `div.col-md-8.col-12` | 30 | 6 | 0.05 of 1956 | — | structure | yes | BELOW FLOOR |
| 91 | module-menu | MISSING | `div.col-md-8.col-12.paddingR` | `ul` | `—` | 28 | 6 | 0.02 of 1956 | — | 0.98 | yes | BELOW FLOOR |
| 92 | module-menu | MISSING | `div.row` | `div.col-md-6.col-12` | `—` | 21 | 6 | 0.01 of 1956 | — | 1.00 | yes | BELOW FLOOR |
| 93 | module-menu | SUBSTITUTED | `div.col-md-8.col-12` | `p>b` | `h5` | 17 | 6 | 0.02 of 1956 | — | structure | — | BELOW FLOOR |
| 94 | module-menu | SUBSTITUTED | `div.col-md-6.offset-md-0.col-12` | `ul` | `p` | 14 | 6 | 0.05 of 1956 | — | structure | yes | BELOW FLOOR |
| 95 | module-menu | SUBSTITUTED | `div.col-md-8.col-12` | `p` | `ul` | 13 | 6 | 0.13 of 1956 | — | structure | — | BELOW FLOOR |
| 96 | module-menu | MOVED | `div.col-md-8.col-12` | `p` | `p` | 11 | 6 | 0.13 of 1956 | — | structure | — | BELOW FLOOR |
...
| 394 | footer | MISSING | `ul.footer-nav` | `li>a#next-lesson` | `—` | 96 | 59 | 0.72 of 1956 | subject+ptype=1-10 Mathematics/overview c=0.93 n=11 | structure | yes | CANDIDATE |
| 395 | footer | MISSING | `ul.footer-nav` | `li>a.home-nav` | `—` | 92 | 50 | 0.85 of 1956 | subject=1-10 English c=1.00 n=13 | structure | yes | CANDIDATE |
| 396 | footer | MISSING | `li>a#next-lesson` | `a#next-lesson` | `—` | 45 | 45 | 0.82 of 1956 | template=Standard c=0.84 n=35 | structure | yes | CANDIDATE |
| 397 | footer | MISSING | `ul.footer-nav.inquiry-nav` | `li>a.home-nav` | `—` | 38 | 33 | 0.14 of 1956 | subject+ptype=1-10 Blended Literacy/overview c=0.87 n=20 | structure | yes | CANDIDATE |
| 400 | footer | SUBSTITUTED | `div#footer` | `ul.footer-nav` | `ul.footer-nav.inquiry-nav` | 64 | 18 | 0.84 of 1956 | ptype=lesson c=0.89 n=15 | structure | yes | CANDIDATE |
| 401 | footer | MISSING | `ul.footer-nav` | `li>a#prev-lesson` | `—` | 33 | 17 | 0.71 of 1956 | ptype=lesson c=0.88 n=11 | structure | yes | CANDIDATE |
| 402 | footer | EXTRA | `ul.footer-nav.inquiry-nav` | `—` | `li>a.home-nav` | 17 | 17 | 0.86 of 1956 | era=Refresh c=0.86 n=17 | structure | yes | CANDIDATE |
| 403 | footer | SUBSTITUTED | `ul.footer-nav.inquiry-nav` | `li>a#next-lesson` | `li>a.home-nav` | 16 | 16 | 0.10 of 1956 | subject+ptype=1-10 Blended Literacy/overview c=0.83 n=15 | structure | yes | CANDIDATE |
| 405 | footer | SUBSTITUTED | `div#footer` | `ul.footer-nav.inquiry-nav` | `li>a#next-lesson` | 15 | 15 | 0.14 of 1956 | subject+ptype=1-10 Blended Literacy/overview c=0.87 n=15 | structure | yes | CANDIDATE |
| 406 | footer | MISSING | `li>a.home-nav` | `a.home-nav` | `—` | 25 | 14 | 0.99 of 1956 | ptype=lesson c=1.00 n=10 | structure | yes | CANDIDATE |
| 407 | footer | SUBSTITUTED | `div#footer` | `ul.footer-nav` | `ul.footer-nav` | 14 | 14 | 0.84 of 1956 | ptype=lesson c=0.89 n=11 | structure | yes | CANDIDATE |
| 408 | footer | EXTRA | `div#footer` | `—` | `ul.footer-nav.inquiry-nav` | 13 | 12 | 0.86 of 1956 | era=Refresh c=0.86 n=12 | structure | yes | CANDIDATE |
| 409 | footer | MISSING | `div#footer` | `ul.footer-nav` | `—` | 11 | 11 | 0.84 of 1956 | ptype=lesson c=0.89 n=10 | structure | yes | CANDIDATE |
...
| 503 | acks | SUBSTITUTED | `div.col-md-8.col-12` | `div.acks` | `div.acks.acksTemplate` | 84 | 84 | 0.17 of 1956 | template+ptype=Inquiry/overview c=0.83 n=27 | structure | yes | CANDIDATE |
| 529 | activity | MISSING | `div.col-12` | `p` | `—` | 625 | 288 | 0.31 of 1950 | subject+ptype=1-10 Blended Literacy/lesson c=0.78 n=99 | 0.80 | — | CANDIDATE |
| 530 | activity | EXTRA | `div.col-12` | `—` | `p` | 505 | 246 | 0.88 of 1950 | series=XDLS90 c=1.00 n=21 | structure | — | CANDIDATE |
| 532 | activity | MISSING | `div.col-12` | `a` | `—` | 399 | 198 | 0.29 of 1950 | series=HIS10 c=0.71 n=40 | 0.64 | — | CANDIDATE |
| 533 | activity | MISSING | `a` | `div.button` | `—` | 516 | 189 | 0.23 of 1950 | series=HIS10 c=0.71 n=35 | 0.63 | yes | CANDIDATE |
| 534 | activity | EXTRA | `div.col-12` | `—` | `WIDGET` | 263 | 161 | 0.82 of 1950 | subject=1-10 English c=0.92 n=44 | structure | — | CANDIDATE |
| 538 | activity | SUBSTITUTED | `div.col-md-8.col-12` | `div.activity.interactive[number=*]` | `div.activity[number=*]` | 192 | 137 | 0.42 of 1950 | subject+ptype=1-10 Blended Literacy/lesson c=0.72 n=53 | structure | yes | CANDIDATE |
| 539 | activity | EXTRA | `div.col-12` | `—` | `img.img-fluid` | 209 | 127 | 0.97 of 1950 | subject=1-10 English c=0.99 n=22 | structure | — | CANDIDATE |
| 540 | activity | EXTRA | `div.row` | `—` | `div.col-12` | 157 | 115 | 0.89 of 1950 | template=Standard c=0.92 n=125 | structure | — | CANDIDATE |
| 541 | activity | MISSING | `div.activity.interactive[number=*]` | `div.row` | `—` | 195 | 112 | 0.20 of 1950 | template+ptype=Bilingual/lesson c=0.68 n=25 | 0.90 | yes | CANDIDATE |
| 543 | activity | EXTRA | `div.col-12` | `—` | `p>a` | 118 | 94 | 1.00 of 1950 | subject+ptype=1-10 Blended Literacy/lesson c=1.00 n=33 | structure | — | CANDIDATE |
| 547 | activity | EXTRA | `div.activity.interactive[number=*]` | `—` | `div.row` | 109 | 84 | 0.80 of 1950 | template=Standard c=0.83 n=96 | structure | yes | CANDIDATE |
| 549 | activity | EXTRA | `div.activity[number=*]` | `—` | `div.row` | 103 | 83 | 0.94 of 1950 | template=Standard c=0.96 n=82 | structure | yes | CANDIDATE |
| 552 | activity | EXTRA | `div.col-12` | `—` | `ol` | 120 | 77 | 0.96 of 1950 | subject=1-10 Mathematics c=0.98 n=30 | structure | — | CANDIDATE |
| 554 | activity | EXTRA | `div.col-12` | `—` | `p>b` | 112 | 74 | 0.97 of 1950 | template=Standard c=0.98 n=83 | structure | — | CANDIDATE |
| 555 | activity | SUBSTITUTED | `div.col-md-8.col-12` | `div.activity[number=*]` | `div.activity.interactive[number=*]` | 104 | 74 | 0.48 of 1950 | subject+ptype=1-10 Blended Literacy/lesson c=0.86 n=23 | structure | yes | CANDIDATE |
| 557 | activity | EXTRA | `div.col-12` | `—` | `ul` | 91 | 71 | 0.94 of 1950 | template=Standard c=0.96 n=74 | structure | — | CANDIDATE |
| 558 | activity | EXTRA | `div.col-12` | `—` | `h3` | 94 | 70 | 0.86 of 1950 | template=Standard c=0.91 n=58 | structure | — | CANDIDATE |
| 562 | activity | SUBSTITUTED | `div.col-md-8.col-12` | `div.activity[number=*]` | `div.activity[number=*]` | 87 | 65 | 0.48 of 1950 | subject+ptype=1-10 Mathematics/lesson c=0.68 n=22 | structure | yes | CANDIDATE |
| 563 | activity | EXTRA | `p>b` | `—` | `b` | 87 | 64 | 0.93 of 1950 | template=Standard c=0.94 n=57 | structure | — | CANDIDATE |
| 564 | activity | SUBSTITUTED | `div.col-12` | `p` | `p` | 81 | 63 | 0.76 of 1950 | template+ptype=Standard/lesson c=0.89 n=55 | structure | — | CANDIDATE |
| 566 | activity | SUBSTITUTED | `div.col-md-8.col-12` | `div.activity[number=*]` | `h3` | 82 | 59 | 0.48 of 1950 | subject+ptype=NCEA1/lesson c=0.63 n=33 | structure | yes | CANDIDATE |
| 567 | activity | EXTRA | `div.col-12` | `—` | `a` | 93 | 57 | 0.86 of 1950 | template=Standard c=0.87 n=83 | structure | — | CANDIDATE |
| 568 | activity | EXTRA | `a` | `—` | `div.button` | 93 | 57 | 0.77 of 1950 | series=XDLS90 c=0.92 n=31 | structure | yes | CANDIDATE |
| 569 | activity | EXTRA | `div.col-12` | `—` | `h4.goJournal` | 126 | 56 | 0.95 of 1950 | series=HIS10 c=1.00 n=33 | structure | — | CANDIDATE |
| 570 | activity | SUBSTITUTED | `div.col-12` | `WIDGET` | `p` | 70 | 56 | 0.60 of 1950 | subject+ptype=1-10 Mathematics/lesson c=0.78 n=31 | structure | — | CANDIDATE |
| 571 | activity | EXTRA | `p>a` | `—` | `a` | 64 | 56 | 0.98 of 1950 | subject+ptype=1-10 Blended Literacy/lesson c=1.00 n=24 | structure | — | CANDIDATE |
| 573 | activity | SUBSTITUTED | `div.col-12` | `WIDGET` | `div.row` | 65 | 54 | 0.60 of 1950 | ptype=lesson c=0.70 n=57 | structure | — | CANDIDATE |
| 574 | activity | EXTRA | `ol` | `—` | `li` | 70 | 53 | 0.95 of 1950 | template=Standard c=0.96 n=53 | structure | — | CANDIDATE |
| 576 | activity | SUBSTITUTED | `div.col-md-8.col-12` | `div.activity.interactive[number=*]` | `div.activity.interactive[number=*]` | 67 | 52 | 0.42 of 1950 | subject+ptype=1-10 Mathematics/lesson c=0.65 n=21 | structure | yes | CANDIDATE |
| 577 | activity | SUBSTITUTED | `div.col-12` | `a` | `h4.goJournal` | 115 | 51 | 0.57 of 1950 | series=HIS10 c=0.83 n=20 | structure | — | CANDIDATE |
| 581 | activity | SUBSTITUTED | `div.col-12` | `p` | `WIDGET` | 59 | 49 | 0.76 of 1950 | template+ptype=Standard/lesson c=0.89 n=42 | structure | — | CANDIDATE |
| 584 | activity | SUBSTITUTED | `div.col-12` | `a` | `p` | 57 | 43 | 0.57 of 1950 | subject+ptype=1-10 Mathematics/lesson c=0.80 n=21 | structure | — | CANDIDATE |
| 585 | activity | EXTRA | `div.col-12` | `—` | `p>i` | 49 | 43 | 0.97 of 1950 | template=Standard c=0.98 n=43 | structure | — | CANDIDATE |
| 586 | activity | EXTRA | `p>i` | `—` | `i` | 49 | 42 | 0.88 of 1950 | template=Standard c=0.88 n=45 | structure | — | CANDIDATE |
| 592 | activity | EXTRA | `div.col-md-8.col-12` | `—` | `div.activity[number=*]` | 41 | 39 | 0.95 of 1950 | template=Standard c=0.98 n=29 | structure | yes | CANDIDATE |
| 595 | activity | EXTRA | `div.col-md-8.col-12` | `—` | `div.activity.interactive[number=*]` | 39 | 37 | 0.90 of 1950 | template=Standard c=0.93 n=31 | structure | yes | CANDIDATE |
| 602 | activity | EXTRA | `div.col-12` | `—` | `div.videoSection.ratio.ratio-16x9` | 54 | 33 | 0.99 of 1950 | template=Standard c=0.99 n=44 | structure | yes | CANDIDATE |
| 609 | activity | SUBSTITUTED | `div.col-md-8.col-12` | `div.activity[number=*]` | `div.activity` | 46 | 30 | 0.48 of 1950 | subject+ptype=NCEA1/lesson c=0.63 n=32 | structure | yes | CANDIDATE |
| 613 | activity | EXTRA | `div.col-12` | `—` | `div.activity.interactive[number=*]` | 33 | 30 | 0.89 of 1950 | era=Refresh c=0.89 n=33 | structure | yes | CANDIDATE |
| 614 | activity | EXTRA | `ul` | `—` | `li` | 31 | 30 | 0.93 of 1950 | template=Standard c=0.95 n=26 | structure | — | CANDIDATE |
| 615 | activity | EXTRA | `div.activity` | `—` | `div.row` | 45 | 29 | 1.00 of 1950 | era=Refresh c=1.00 n=45 | structure | yes | CANDIDATE |
| 616 | activity | EXTRA | `div.col-12` | `—` | `audio.audioPlayer.icon` | 44 | 29 | 1.00 of 1950 | subject=1-10 Blended Literacy c=1.00 n=21 | structure | yes | CANDIDATE |
| 617 | activity | EXTRA | `div.videoSection.ratio.ratio-16x9` | `—` | `iframe` | 39 | 29 | 0.98 of 1950 | template=Standard c=0.99 n=26 | structure | yes | CANDIDATE |
| 620 | activity | EXTRA | `p` | `—` | `b` | 36 | 28 | 0.96 of 1950 | template=Standard c=0.96 n=33 | structure | — | CANDIDATE |
| 621 | activity | SUBSTITUTED | `div.col-12` | `a` | `WIDGET` | 34 | 28 | 0.57 of 1950 | template+ptype=Standard/lesson c=0.68 n=31 | structure | — | CANDIDATE |
| 631 | activity | SUBSTITUTED | `div.col-12` | `WIDGET` | `div.col-md-8.col-12` | 27 | 26 | 0.60 of 1950 | ptype=lesson c=0.70 n=21 | structure | — | CANDIDATE |
| 639 | activity | EXTRA | `div.col-12` | `—` | `div.videoSection.icon.ratio.ratio-16x9` | 37 | 23 | 0.97 of 1950 | template=Standard c=0.98 n=30 | structure | yes | CANDIDATE |
| 641 | activity | SUBSTITUTED | `div.row` | `div.col-12` | `div.col-md-8.col-12` | 27 | 23 | 0.79 of 1950 | template+ptype=Standard/lesson c=0.93 n=20 | structure | — | CANDIDATE |
| 643 | activity | SUBSTITUTED | `div.col-12` | `WIDGET` | `ol` | 25 | 23 | 0.60 of 1950 | ptype=lesson c=0.70 n=21 | structure | — | CANDIDATE |
| 645 | activity | SUBSTITUTED | `div.col-12` | `h3` | `WIDGET` | 28 | 22 | 0.76 of 1950 | template+ptype=Standard/lesson c=0.90 n=23 | structure | — | CANDIDATE |
| 646 | activity | EXTRA | `div.col-12` | `—` | `h5` | 26 | 22 | 0.98 of 1950 | template=Standard c=0.99 n=21 | structure | — | CANDIDATE |
| 657 | activity | EXTRA | `div.col-md-8.col-12` | `—` | `div.activity` | 24 | 19 | 1.00 of 1950 | era=Refresh c=1.00 n=24 | structure | yes | CANDIDATE |
| 663 | activity | EXTRA | `div.col-12` | `—` | `div.button` | 29 | 18 | 1.00 of 1950 | template=Standard c=1.00 n=25 | structure | yes | CANDIDATE |
| 664 | activity | EXTRA | `a` | `—` | `div.externalButton` | 26 | 18 | 0.96 of 1950 | era=Refresh c=0.96 n=26 | structure | — | CANDIDATE |
| 667 | activity | SUBSTITUTED | `div.row` | `div.col-12` | `WIDGET` | 20 | 18 | 0.79 of 1950 | era=Refresh c=0.79 n=20 | structure | — | CANDIDATE |
| 671 | activity | EXTRA | `div.col-12` | `—` | `div.TKmodal` | 20 | 17 | 0.99 of 1950 | era=Refresh c=0.99 n=20 | structure | — | CANDIDATE |
| 683 | activity | EXTRA | `div.row` | `—` | `div.clickDropContent` | 23 | 15 | 0.99 of 1950 | template=Standard c=1.00 n=23 | structure | — | CANDIDATE |
| 684 | activity | EXTRA | `div.row` | `—` | `WIDGET` | 22 | 15 | 1.00 of 1950 | era=Refresh c=1.00 n=22 | structure | — | CANDIDATE |
| 686 | activity | SUBSTITUTED | `div.col-12` | `WIDGET` | `img.img-fluid` | 21 | 15 | 0.60 of 1950 | era=Refresh c=0.60 n=21 | structure | — | CANDIDATE |
| 704 | activity | SUBSTITUTED | `div.col-12` | `p` | `h4.goJournal` | 22 | 13 | 0.76 of 1950 | template+ptype=Standard/lesson c=0.89 n=21 | structure | — | CANDIDATE |
| 3601 | body | EXTRA | `div#body` | `—` | `div.row` | 1250 | 324 | 0.73 of 1950 | subject+ptype=1-10 Blended Literacy/overview c=1.00 n=29 | structure | — | CANDIDATE |
| 3602 | body | EXTRA | `div.col-md-8.col-12` | `—` | `p` | 849 | 319 | 0.82 of 1950 | subject=1-10 Blended Literacy c=1.00 n=36 | structure | — | CANDIDATE |
| 3603 | body | MISSING | `div#body` | `div.row` | `—` | 1063 | 277 | 0.34 of 1950 | series=CEDO50 c=0.76 n=20 | 0.86 | — | CANDIDATE |
| 3604 | body | MISSING | `div.col-md-8.col-12` | `p` | `—` | 509 | 240 | 0.29 of 1950 | template+ptype=Fundamentals/overview c=0.93 n=34 | 0.82 | — | CANDIDATE |
| 3605 | body | EXTRA | `div.col-md-8.col-12` | `—` | `img.img-fluid` | 423 | 187 | 0.97 of 1950 | template+ptype=Standard/overview c=1.00 n=23 | structure | — | CANDIDATE |
| 3606 | body | MOVED | `div.col-md-8.col-12` | `p` | `p` | 285 | 181 | 0.18 of 1950 | template+ptype=Fundamentals/overview c=0.87 n=35 | structure | — | CANDIDATE |
| 3607 | body | EXTRA | `div.col-md-8.col-12` | `—` | `WIDGET` | 259 | 169 | 0.89 of 1950 | subject=NCEA1 c=0.96 n=20 | structure | — | CANDIDATE |
| 3608 | body | SUBSTITUTED | `div.row` | `div.col-12` | `div.col-md-8.col-12` | 291 | 163 | 0.55 of 1950 | subject+ptype=1-10 Blended Literacy/overview c=0.99 n=64 | structure | — | CANDIDATE |
| 3609 | body | EXTRA | `div.row` | `—` | `div.col-md-8.col-12` | 242 | 159 | 0.86 of 1950 | subject=1-10 Blended Literacy c=0.96 n=31 | structure | — | CANDIDATE |
| 3610 | body | EXTRA | `div.col-md-8.col-12` | `—` | `p>b` | 256 | 154 | 0.95 of 1950 | subject=1-10 Blended Literacy c=1.00 n=37 | structure | — | CANDIDATE |
| 3611 | body | EXTRA | `div.col-md-8.col-12` | `—` | `h3` | 227 | 146 | 0.83 of 1950 | subject=1-10 Blended Literacy c=1.00 n=20 | structure | — | CANDIDATE |
| 3612 | body | MISSING | `div.col-md-8.col-12` | `WIDGET` | `—` | 222 | 140 | 0.19 of 1950 | subject+ptype=Online Safety (OS9000)/lesson c=0.65 n=21 | structure | — | CANDIDATE |
| 3614 | body | EXTRA | `div.col-md-8.col-12` | `—` | `ul` | 249 | 132 | 0.96 of 1950 | subject=1-10 English c=0.99 n=24 | structure | — | CANDIDATE |
| 3619 | body | EXTRA | `div.col-md-8.col-12` | `—` | `div.videoSection.ratio.ratio-16x9` | 177 | 106 | 0.94 of 1950 | subject=1-10 English c=0.97 n=33 | structure | yes | CANDIDATE |
| 3620 | body | EXTRA | `div.col-md-8.col-12` | `—` | `a` | 173 | 105 | 0.93 of 1950 | subject=1-10 English c=0.95 n=23 | structure | — | CANDIDATE |
| 3624 | body | EXTRA | `p>b` | `—` | `b` | 153 | 93 | 0.94 of 1950 | subject=1-10 Mathematics c=0.97 n=32 | structure | — | CANDIDATE |
| 3625 | body | EXTRA | `div.col-md-8.col-12` | `—` | `div.table-responsive` | 151 | 91 | 0.98 of 1950 | subject+ptype=1-10 English/lesson c=0.99 n=22 | structure | — | CANDIDATE |
| 3626 | body | EXTRA | `a` | `—` | `div.button` | 156 | 88 | 0.97 of 1950 | ptype=overview c=0.98 n=20 | structure | — | CANDIDATE |
| 3628 | body | EXTRA | `div.col-md-8.col-12` | `—` | `p>a` | 117 | 84 | 0.99 of 1950 | template=Standard c=0.99 n=93 | structure | — | CANDIDATE |
| 3630 | body | EXTRA | `p` | `—` | `b` | 101 | 81 | 0.93 of 1950 | subject=NCEA1 c=0.96 n=20 | structure | — | CANDIDATE |
| 3636 | body | EXTRA | `div.table-responsive` | `—` | `table.table.table-bordered` | 115 | 72 | 0.96 of 1950 | template=Standard c=0.97 n=99 | structure | yes | CANDIDATE |
| 3637 | body | EXTRA | `p>i` | `—` | `i` | 97 | 71 | 0.97 of 1950 | subject=1-10 Blended Literacy c=1.00 n=26 | structure | — | CANDIDATE |
| 3638 | body | SUBSTITUTED | `div.videoSection.icon.ratio.ratio-16x9` | `iframe.embed-responsive-item` | `iframe` | 179 | 69 | 0.21 of 1950 | series=PES10 c=0.68 n=35 | structure | yes | CANDIDATE |
| 3644 | body | EXTRA | `table.table.table-bordered` | `—` | `tr` | 97 | 63 | 0.98 of 1950 | template=Standard c=0.99 n=85 | structure | yes | CANDIDATE |
| 3645 | body | EXTRA | `div.col-md-8.col-12` | `—` | `audio.audioPlayer.icon` | 107 | 62 | 0.99 of 1950 | subject+ptype=Leaving to Learn/lesson c=1.00 n=24 | structure | yes | CANDIDATE |
| 3647 | body | EXTRA | `div.row` | `—` | `div.col-12` | 110 | 61 | 0.84 of 1950 | ptype=lesson c=0.86 n=90 | structure | — | CANDIDATE |
| 3649 | body | EXTRA | `div.col-md-8.col-12` | `—` | `p>i` | 84 | 61 | 0.98 of 1950 | subject=NCEA1 c=0.99 n=21 | structure | — | CANDIDATE |
| 3650 | body | EXTRA | `div.col-md-8.col-12` | `—` | `ol` | 79 | 61 | 0.99 of 1950 | ptype=overview c=0.99 n=24 | structure | — | CANDIDATE |
| 3651 | body | MOVED | `div.col-md-8.col-12` | `h3` | `h3` | 74 | 60 | 0.17 of 1950 | template+ptype=Fundamentals/overview c=0.81 n=20 | structure | — | CANDIDATE |
| 3653 | body | EXTRA | `div.videoSection.ratio.ratio-16x9` | `—` | `iframe` | 80 | 59 | 0.93 of 1950 | subject=1-10 Mathematics c=0.95 n=27 | structure | yes | CANDIDATE |
| 3662 | body | EXTRA | `p>a` | `—` | `a` | 66 | 52 | 0.99 of 1950 | template=Standard c=1.00 n=51 | structure | — | CANDIDATE |
| 3664 | body | EXTRA | `ul` | `—` | `li` | 64 | 52 | 0.92 of 1950 | template=Standard c=0.94 n=48 | structure | — | CANDIDATE |
| 3667 | body | SUBSTITUTED | `div#body` | `div.row` | `WIDGET` | 60 | 50 | 0.94 of 1950 | template+ptype=Standard/lesson c=0.98 n=53 | structure | — | CANDIDATE |
| 3668 | body | SUBSTITUTED | `div.row` | `div.col-md-8.col-12` | `div.col-md-8.col-12` | 58 | 50 | 0.98 of 1950 | ptype=lesson c=0.99 n=32 | structure | — | CANDIDATE |
| 3671 | body | EXTRA | `div.col-md-8.col-12` | `—` | `h4` | 55 | 48 | 0.96 of 1950 | template=Standard c=0.98 n=26 | structure | — | CANDIDATE |
| 3673 | body | SUBSTITUTED | `div.col-md-8.col-12` | `p` | `div.activity[number=*]` | 48 | 45 | 0.85 of 1950 | template+ptype=Standard/lesson c=0.85 n=42 | structure | yes | CANDIDATE |
| 3674 | body | EXTRA | `div.fundamentalsPanel` | `—` | `div.row` | 44 | 44 | 0.99 of 1950 | era=Refresh c=0.99 n=44 | structure | — | CANDIDATE |
| 3680 | body | EXTRA | `a` | `—` | `div.externalButton` | 63 | 41 | 0.92 of 1950 | template=Standard c=0.93 n=57 | structure | — | CANDIDATE |
| 3681 | body | SUBSTITUTED | `div.col-md-8.col-12` | `p` | `p` | 57 | 41 | 0.85 of 1950 | template+ptype=Standard/lesson c=0.85 n=40 | structure | — | CANDIDATE |
| 3682 | body | EXTRA | `tr` | `—` | `th` | 45 | 41 | 0.99 of 1950 | template=Standard c=0.99 n=37 | structure | — | CANDIDATE |
| 3685 | body | EXTRA | `div.row` | `—` | `div.col-md-6.col-12` | 56 | 39 | 0.99 of 1950 | subject=Online Safety (OS9000) c=1.00 n=20 | structure | — | CANDIDATE |
| 3686 | body | EXTRA | `div.alert` | `—` | `div.row` | 53 | 39 | 0.91 of 1950 | template=Standard c=0.92 n=40 | structure | — | CANDIDATE |
| 3687 | body | EXTRA | `div.col-12` | `—` | `p` | 65 | 38 | 0.86 of 1950 | template=Standard c=0.88 n=59 | structure | — | CANDIDATE |
| 3690 | body | EXTRA | `div#body` | `—` | `div.row.supervisor` | 50 | 38 | 0.88 of 1950 | ptype=lesson c=0.89 n=45 | structure | yes | CANDIDATE |
| 3691 | body | EXTRA | `p` | `—` | `i` | 45 | 38 | 0.97 of 1950 | template=Standard c=0.97 n=41 | structure | — | CANDIDATE |
| 3692 | body | EXTRA | `tr` | `—` | `td` | 41 | 37 | 0.95 of 1950 | template=Standard c=0.95 n=34 | structure | — | CANDIDATE |
| 3697 | body | MISSING | `div#body` | `div.fundamentalsPanel` | `—` | 35 | 35 | 0.02 of 1950 | template+ptype=Fundamentals/overview c=0.87 n=34 | 1.00 | yes | CANDIDATE |
| 3704 | body | EXTRA | `div.col-md-8.col-12` | `—` | `div.alert` | 43 | 32 | 0.91 of 1950 | template=Standard c=0.92 n=33 | structure | — | CANDIDATE |
| 3706 | body | SUBSTITUTED | `div.row` | `div.col-md-8.col-12` | `WIDGET` | 33 | 32 | 0.98 of 1950 | ptype=lesson c=0.99 n=27 | structure | — | CANDIDATE |
| 3707 | body | EXTRA | `div#body` | `—` | `WIDGET` | 48 | 31 | 0.94 of 1950 | era=Refresh c=0.94 n=48 | structure | — | CANDIDATE |
| 3710 | body | EXTRA | `div#body` | `—` | `div.fundamentalsPanel` | 30 | 30 | 0.98 of 1950 | era=Refresh c=0.98 n=30 | structure | yes | CANDIDATE |
| 3715 | body | EXTRA | `div.inquiryPanel` | `—` | `div.row` | 28 | 28 | 0.99 of 1950 | era=Refresh c=0.99 n=28 | structure | — | CANDIDATE |
| 3718 | body | EXTRA | `div.col-md-8.col-12` | `—` | `h4.goJournal` | 33 | 27 | 1.00 of 1950 | era=Refresh c=1.00 n=33 | structure | — | CANDIDATE |
| 3721 | body | SUBSTITUTED | `div.col-md-8.col-12` | `p` | `WIDGET` | 28 | 27 | 0.85 of 1950 | era=Refresh c=0.85 n=28 | structure | — | CANDIDATE |
| 3722 | body | SUBSTITUTED | `div.row` | `div.col-md-8.col-12` | `div.row` | 28 | 27 | 0.98 of 1950 | era=Refresh c=0.98 n=28 | structure | — | CANDIDATE |
| 3723 | body | EXTRA | `div.row` | `—` | `div.col-md-4.offset-md-0.col-12` | 27 | 27 | 0.79 of 1950 | era=Refresh c=0.79 n=27 | structure | — | CANDIDATE |
| 3727 | body | EXTRA | `div.col-md-8.col-12` | `—` | `div.videoSection.icon.ratio.ratio-16x9` | 36 | 25 | 0.91 of 1950 | template=Standard c=0.93 n=29 | structure | yes | CANDIDATE |
| 3730 | body | EXTRA | `div#body` | `—` | `div.inquiryPanel` | 25 | 25 | 0.99 of 1950 | era=Refresh c=0.99 n=25 | structure | — | CANDIDATE |
| 3732 | body | EXTRA | `div.alert.solid` | `—` | `div.row` | 33 | 24 | 0.99 of 1950 | template=Standard c=0.99 n=28 | structure | yes | CANDIDATE |
| 3735 | body | EXTRA | `div.col-md-8.col-12` | `—` | `p>span.infoTrigger` | 28 | 24 | 0.86 of 1950 | template=Standard c=0.87 n=24 | structure | — | CANDIDATE |
| 3740 | body | EXTRA | `div.col-md-8.col-12` | `—` | `div.row.flipCardsContainer` | 28 | 23 | 0.93 of 1950 | template=Standard c=0.94 n=25 | structure | — | CANDIDATE |
| 3751 | body | EXTRA | `div.row` | `—` | `div.col-md-4.col-12` | 28 | 21 | 0.95 of 1950 | template=Standard c=0.95 n=24 | structure | — | CANDIDATE |
| 3755 | body | EXTRA | `div.col-md-8.col-12` | `—` | `h5` | 23 | 21 | 1.00 of 1950 | era=Refresh c=1.00 n=23 | structure | — | CANDIDATE |
| 3756 | body | SUBSTITUTED | `div.row` | `div.col-md-8.col-12` | `div.col-md-6.col-12` | 23 | 21 | 0.98 of 1950 | era=Refresh c=0.98 n=23 | structure | — | CANDIDATE |
| 3757 | body | EXTRA | `div.row.flipCardsContainer` | `—` | `div.col-md-4.col-12.paddingLR` | 22 | 21 | 0.97 of 1950 | era=Refresh c=0.97 n=22 | structure | — | CANDIDATE |
| 3759 | body | SUBSTITUTED | `div.col-md-8.col-12` | `p` | `div.activity.interactive[number=*]` | 22 | 21 | 0.85 of 1950 | era=Refresh c=0.85 n=22 | structure | yes | CANDIDATE |
| 3762 | body | EXTRA | `div.videoSection.icon.ratio.ratio-16x9` | `—` | `iframe` | 25 | 20 | 0.97 of 1950 | template=Standard c=0.98 n=20 | structure | yes | CANDIDATE |
| 3765 | body | SUBSTITUTED | `div.row` | `div.col-md-8.col-12` | `p` | 20 | 20 | 0.98 of 1950 | era=Refresh c=0.98 n=20 | structure | — | CANDIDATE |
| 3766 | body | SUBSTITUTED | `div.col-md-8.col-12` | `p` | `img.img-fluid` | 20 | 20 | 0.85 of 1950 | era=Refresh c=0.85 n=20 | structure | — | CANDIDATE |
| 3769 | body | EXTRA | `div.col-md-8.col-12` | `—` | `div.alert.solid` | 25 | 19 | 0.99 of 1950 | era=Refresh c=0.99 n=25 | structure | yes | CANDIDATE |
| 3770 | body | EXTRA | `div.clickDropContent` | `—` | `p` | 21 | 19 | 0.96 of 1950 | era=Refresh c=0.96 n=21 | structure | — | CANDIDATE |
| 3772 | body | EXTRA | `div.row` | `—` | `div.clickDropContent` | 20 | 19 | 1.00 of 1950 | era=Refresh c=1.00 n=20 | structure | — | CANDIDATE |
| 3780 | body | SUBSTITUTED | `div.col-md-8.col-12` | `p` | `div.activity` | 21 | 18 | 0.85 of 1950 | era=Refresh c=0.85 n=21 | structure | — | CANDIDATE |
| 3787 | body | SUBSTITUTED | `div.col-md-8.col-12` | `p` | `div.alert` | 24 | 17 | 0.85 of 1950 | era=Refresh c=0.85 n=24 | structure | — | CANDIDATE |
| 3795 | body | EXTRA | `th>b` | `—` | `b` | 22 | 16 | 1.00 of 1950 | era=Refresh c=1.00 n=22 | structure | — | CANDIDATE |
| 3806 | body | SUBSTITUTED | `div#body` | `div.row` | `div.table-responsive` | 21 | 15 | 0.94 of 1950 | era=Refresh c=0.94 n=21 | structure | — | CANDIDATE |
| 3815 | body | MISSING | `div#body` | `div.row.clickDropContent.noBorder` | `—` | 49 | 14 | 0.03 of 1950 | series=XDLS90 c=0.64 n=38 | 0.94 | yes | CANDIDATE |
| 8283 | root | EXTRA | `body.container-fluid` | `—` | `div.row` | 233 | 233 | 0.87 of 1956 | subject+ptype=NCEA1/overview c=0.98 n=41 | structure | — | CANDIDATE |
| 8288 | root | SUBSTITUTED | `#root` | `body` | `body.container-fluid` | 94 | 10 | 0.05 of 1956 | series=CEDO50 c=1.00 n=25 | structure | yes | CANDIDATE |
...
### #25 · module-menu · SUBSTITUTED · `div.col-md-6.col-12.paddingR` › gold `p` vs Claude `h5` — CANDIDATE
...
### #27 · module-menu · EXTRA · `div.row` › gold `—` vs Claude `div.col-md-6.col-12.paddingR` — CANDIDATE
...
### #29 · module-menu · SUBSTITUTED · `div.col-md-6.col-12.paddingL` › gold `p` vs Claude `h5` — CANDIDATE
...
### #31 · module-menu · MISSING · `div.col-md-6.col-12.paddingR` › gold `p` vs Claude `—` — CANDIDATE
...
### #35 · module-menu · EXTRA · `div.col-md-8.col-12` › gold `—` vs Claude `h5` — CANDIDATE
...
### #36 · module-menu · EXTRA · `div.col-md-8.col-12` › gold `—` vs Claude `p` — CANDIDATE
...
### #37 · module-menu · EXTRA · `div.col-md-6.col-12.paddingR` › gold `—` vs Claude `p>b` — CANDIDATE
...
### #45 · module-menu · EXTRA · `div.col-md-6.offset-md-0.col-12` › gold `—` vs Claude `p` — CANDIDATE
...
### #52 · module-menu · EXTRA · `div.row` › gold `—` vs Claude `div.col-md-12.col-12.paddingR` — CANDIDATE
...
### #53 · module-menu · EXTRA · `div.row` › gold `—` vs Claude `div.col-md-8.col-12` — CANDIDATE
...
### #54 · module-menu · EXTRA · `div.col-md-8.col-12` › gold `—` vs Claude `ul` — CANDIDATE
...
### #56 · module-menu · EXTRA · `div.row` › gold `—` vs Claude `div.col-md-6.offset-md-0.col-12` — CANDIDATE
...
### #57 · module-menu · SUBSTITUTED · `div.col-md-6.col-12.paddingR` › gold `ul` vs Claude `p>b` — CANDIDATE
...
### #61 · module-menu · EXTRA · `div.col-md-6.col-12.paddingR` › gold `—` vs Claude `h5` — CANDIDATE
...
### #394 · footer · MISSING · `ul.footer-nav` › gold `li>a#next-lesson` vs Claude `—` — CANDIDATE
...
### #395 · footer · MISSING · `ul.footer-nav` › gold `li>a.home-nav` vs Claude `—` — CANDIDATE
- pages 92 / modules 50 / lines 92; consensus (all) 0.85 of 1956 gold pages with the region; derivable structure-only (0 lines with no WT source)
- by template: Standard 39m/81p c=0.86; Bilingual 9m/9p c=0.97; Inquiry 1m/1p c=0.59; Fundamentals 1m/1p c=0.58
- by subject: 1-10 English 13m/27p c=1.00; Te Marautanga o Aotearoa TMoA 9m/9p c=0.97; 1-10 Mathematics 8m/33p c=0.98; NCEA1 6m/6p c=1.00; ANZH 3m/3p c=1.00; Online Safety (OS9000) 3m/6p c=1.00
- by era: Refresh 50m/92p c=0.85
- authority (§1b): 1 — KB rule (verify the hit's scope)
  - KB: 06_TEMPLATE_RECOGNITION.md:40 — | Footer tag | `<nav id="module-foot">` with `<button>` + FA icons | `<div id="footer">` with `<ul class="footer-nav">` |
  - KB: 06_TEMPLATE_RECOGNITION.md:64 — | Footer `<ul>` class | `footer-nav` | `footer-nav` | `footer-nav fundamentals-nav` | `footer-nav inquiry-nav` | `footer-nav` |
  - KB: 06_TEMPLATE_RECOGNITION.md:114 — **Footer:** `<ul class="footer-nav">` with prev + next + home links.
...
- **ANZH205** ANZH205_6_0.html ↔ ANZH205_06.0.html (structure, derivable=True)
  - gold: `li`
  - Claude: `—`
- modules: AGH1004, AGH1009, ANZH205, ANZH301, ANZH303, BLL236, BLL237, CEDO501, CEDT207, ENGI101, ENGI400, ENGI401, ENGJ101, ENGJ102, ENGJ201, ENGJ301, ENGJ302, ENGJ402, ENGJ403, ENGR102, ENGR302, ENGS302, HES1005, HIS1003 …

### #396 · footer · MISSING · `li>a#next-lesson` › gold `a#next-lesson` vs Claude `—` — CANDIDATE
