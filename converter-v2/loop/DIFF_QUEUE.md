...
**Produced:** 2026-09-23 16:32 NZST by `reference/tests/_diff_miner.py` on the CURRENT corpus (pageforge-site HEAD 24ab15b; Claude corpus 545 dirs). **Population:** the skeleton gate's own — 2476 paired pages / 533 modules (compare_exclusions.txt honoured; acks / glossary / references pages excluded); parse errors skipped: 0 (must be 0); modules without a parsed WT: 2. Run time 80.4 s.
...
- differing skeleton lines: 277616 — by direction {'MISSING': 146069, 'SUBSTITUTED': 25628, 'EXTRA': 96982, 'MOVED': 8937}
- by region: {'module-code': 23, 'title': 388, 'header': 6, 'module-menu': 13297, 'phases-nav': 57, 'crumbs': 57, 'footer': 2562, 'acks': 1384, 'activity': 100324, 'body': 157927, 'root': 1591}
- classes: 9309 — CANDIDATE 196, below floor 8809, the rest below consensus / not derivable
...
|---|---|---|---|---|---|---|---|---|
| module-menu | 1534 | 17408 | 16113 | 13627 | 4354 | 700 | 200 | CANDIDATE (verify by eye — text presence, not position) |
...
| 96 | module-menu | MISSING | `div.item` | `p` | `—` | 18 | 8 | 0.01 of 2476 | — | 0.77 | yes | BELOW FLOOR |
...
| 416 | crumbs | MISSING | `div.crumbs` | `div` | `—` | 15 | 12 | 0.02 of 2469 | template+ptype=Inquiry/overview c=0.62 n=10 | 0.92 | yes | CANDIDATE |
| 433 | footer | MISSING | `ul.footer-nav` | `li>a#next-lesson` | `—` | 102 | 62 | 0.71 of 2476 | subject+ptype=1-10 Mathematics/overview c=0.93 n=13 | structure | yes | CANDIDATE |
| 434 | footer | MISSING | `ul.footer-nav` | `li>a.home-nav` | `—` | 100 | 57 | 0.83 of 2476 | subject=1-10 English c=1.00 n=13 | structure | yes | CANDIDATE |
| 435 | footer | MISSING | `li>a#next-lesson` | `a#next-lesson` | `—` | 51 | 51 | 0.82 of 2476 | template=Bilingual c=0.86 n=10 | structure | yes | CANDIDATE |
| 436 | footer | MISSING | `ul.footer-nav.inquiry-nav` | `li>a.home-nav` | `—` | 55 | 50 | 0.14 of 2476 | subject+ptype=1-10 Blended Literacy/overview c=0.89 n=24 | structure | yes | CANDIDATE |
| 438 | footer | EXTRA | `ul.footer-nav.inquiry-nav` | `—` | `li>a.home-nav` | 31 | 31 | 0.85 of 2476 | era=Refresh c=0.85 n=31 | structure | yes | CANDIDATE |
| 441 | footer | SUBSTITUTED | `div#footer` | `ul.footer-nav.inquiry-nav` | `li>a#next-lesson` | 22 | 22 | 0.14 of 2476 | subject+ptype=1-10 Blended Literacy/overview c=0.89 n=15 | structure | yes | CANDIDATE |
| 442 | footer | MISSING | `ul.footer-nav` | `li>a#prev-lesson` | `—` | 37 | 20 | 0.70 of 2476 | ptype=lesson c=0.87 n=14 | structure | yes | CANDIDATE |
| 443 | footer | SUBSTITUTED | `ul.footer-nav.inquiry-nav` | `li>a#next-lesson` | `li>a.home-nav` | 18 | 18 | 0.11 of 2476 | subject+ptype=1-10 Blended Literacy/overview c=0.87 n=15 | structure | yes | CANDIDATE |
| 444 | footer | EXTRA | `div#footer` | `—` | `ul.footer-nav.inquiry-nav` | 18 | 16 | 0.85 of 2476 | template=Standard c=0.86 n=13 | structure | yes | CANDIDATE |
| 445 | footer | SUBSTITUTED | `div#footer` | `ul.footer-nav` | `ul.footer-nav.inquiry-nav` | 52 | 15 | 0.82 of 2476 | ptype=lesson c=0.87 n=14 | structure | yes | CANDIDATE |
| 446 | footer | SUBSTITUTED | `div#footer` | `ul.footer-nav` | `ul.footer-nav` | 16 | 15 | 0.82 of 2476 | ptype=lesson c=0.87 n=10 | structure | yes | CANDIDATE |
| 448 | footer | MISSING | `li>a.home-nav` | `a.home-nav` | `—` | 24 | 13 | 0.99 of 2476 | era=Refresh c=0.99 n=13 | structure | yes | CANDIDATE |
| 449 | footer | EXTRA | `ul.footer-nav.fundamentals-nav` | `—` | `li>a.home-nav` | 21 | 12 | 0.98 of 2476 | era=Refresh c=0.98 n=12 | structure | yes | CANDIDATE |
| 452 | footer | SUBSTITUTED | `ul.footer-nav` | `li>a#next-lesson` | `li>a#next-lesson` | 12 | 11 | 0.71 of 2476 | template=Standard c=0.74 n=10 | structure | yes | CANDIDATE |
| 453 | footer | MISSING | `ul.footer-nav.inquiry-nav` | `li>a#prev-lesson` | `—` | 11 | 11 | 0.10 of 2476 | template+ptype=Inquiry/overview c=0.70 n=10 | structure | yes | CANDIDATE |
| 455 | footer | SUBSTITUTED | `ul.footer-nav` | `li>a.home-nav` | `li>a.home-nav` | 12 | 10 | 0.83 of 2476 | era=Refresh c=0.83 n=10 | structure | yes | CANDIDATE |
| 457 | footer | MISSING | `div#footer` | `ul.footer-nav` | `—` | 10 | 10 | 0.82 of 2476 | era=Refresh c=0.82 n=10 | structure | yes | CANDIDATE |
| 543 | acks | SUBSTITUTED | `div.col-12.col-md-8` | `div.acks` | `div.acks.acksTemplate` | 105 | 105 | 0.16 of 2476 | template+ptype=Inquiry/overview c=0.82 n=41 | structure | yes | CANDIDATE |
| 573 | activity | MISSING | `div.col-12` | `p` | `—` | 765 | 378 | 0.30 of 2469 | template+ptype=Inquiry/overview c=0.80 n=41 | 0.80 | — | CANDIDATE |
| 574 | activity | EXTRA | `div.col-12` | `—` | `p` | 598 | 299 | 0.88 of 2469 | subject=ANZH c=0.99 n=32 | structure | — | CANDIDATE |
| 575 | activity | MISSING | `div.col-12` | `WIDGET` | `—` | 408 | 259 | 0.18 of 2469 | template+ptype=Inquiry/overview c=0.67 n=27 | structure | — | CANDIDATE |
| 577 | activity | MISSING | `div.col-12` | `a` | `—` | 450 | 232 | 0.29 of 2469 | template+ptype=Inquiry/overview c=0.75 n=27 | 0.64 | — | CANDIDATE |
| 578 | activity | MOVED | `div.col-12` | `p` | `p` | 316 | 212 | 0.19 of 2469 | template+ptype=Inquiry/overview c=0.77 n=25 | structure | — | CANDIDATE |
| 579 | activity | EXTRA | `div.col-12` | `—` | `WIDGET` | 343 | 211 | 0.82 of 2469 | subject=NCEA1 c=0.94 n=35 | structure | — | CANDIDATE |
| 580 | activity | MISSING | `div.col-12` | `h3` | `—` | 391 | 200 | 0.31 of 2469 | template+ptype=Fundamentals/overview c=0.85 n=31 | 0.69 | — | CANDIDATE |
| 581 | activity | SUBSTITUTED | `div.col-12.col-md-8` | `div.activity.interactive[number=*]` | `div.activity[number=*]` | 274 | 188 | 0.44 of 2469 | template=Fundamentals c=0.77 n=20 | structure | yes | CANDIDATE |
| 583 | activity | MISSING | `div.activity.interactive[number=*]` | `div.row` | `—` | 289 | 166 | 0.12 of 2469 | template+ptype=Fundamentals/overview c=0.65 n=35 | 0.93 | yes | CANDIDATE |
| 584 | activity | EXTRA | `div.col-12` | `—` | `img.img-fluid` | 250 | 154 | 0.97 of 2469 | subject+ptype=1-10 English/lesson c=0.99 n=22 | structure | — | CANDIDATE |
| 585 | activity | MOVED | `div.col-12` | `p` | `p` | 153 | 124 | 0.15 of 2469 | template+ptype=Inquiry/overview c=0.77 n=21 | structure | — | CANDIDATE |
| 586 | activity | EXTRA | `div.row` | `—` | `div.col-12` | 166 | 122 | 0.84 of 2469 | template=Standard c=0.87 n=136 | structure | — | CANDIDATE |
| 588 | activity | EXTRA | `div.col-12` | `—` | `p>a` | 138 | 114 | 1.00 of 2469 | subject+ptype=1-10 Blended Literacy/lesson c=1.00 n=37 | structure | — | CANDIDATE |
| 591 | activity | EXTRA | `div.activity[number=*]` | `—` | `div.row` | 148 | 106 | 0.94 of 2469 | subject=1-10 English c=0.98 n=23 | structure | yes | CANDIDATE |
| 595 | activity | SUBSTITUTED | `div.col-12` | `p` | `p` | 130 | 97 | 0.75 of 2469 | subject+ptype=1-10 Blended Literacy/lesson c=0.92 n=21 | structure | — | CANDIDATE |
| 597 | activity | SUBSTITUTED | `div.col-12.col-md-8` | `div.activity[number=*]` | `div.activity[number=*]` | 118 | 86 | 0.47 of 2469 | subject+ptype=1-10 Mathematics/lesson c=0.66 n=23 | structure | yes | CANDIDATE |
| 598 | activity | SUBSTITUTED | `div.col-12.col-md-8` | `div.activity[number=*]` | `div.activity.interactive[number=*]` | 118 | 86 | 0.47 of 2469 | subject+ptype=1-10 Blended Literacy/lesson c=0.81 n=24 | structure | yes | CANDIDATE |
| 600 | activity | EXTRA | `div.col-12` | `—` | `ol` | 132 | 85 | 0.96 of 2469 | subject=1-10 Mathematics c=0.98 n=31 | structure | — | CANDIDATE |
| 602 | activity | EXTRA | `div.col-12` | `—` | `p>b` | 126 | 84 | 0.97 of 2469 | template=Standard c=0.98 n=93 | structure | — | CANDIDATE |
| 603 | activity | EXTRA | `div.col-12` | `—` | `h3` | 105 | 84 | 0.87 of 2469 | template=Standard c=0.92 n=70 | structure | — | CANDIDATE |
| 604 | activity | EXTRA | `p>b` | `—` | `b` | 105 | 83 | 0.92 of 2469 | template=Standard c=0.94 n=71 | structure | — | CANDIDATE |
| 605 | activity | EXTRA | `div.col-12` | `—` | `ul` | 103 | 79 | 0.93 of 2469 | template=Standard c=0.96 n=85 | structure | — | CANDIDATE |
| 609 | activity | EXTRA | `div.activity.interactive[number=*]` | `—` | `div.row` | 91 | 77 | 0.65 of 2469 | template=Standard c=0.68 n=72 | structure | yes | CANDIDATE |
| 610 | activity | EXTRA | `p>a` | `—` | `a` | 91 | 77 | 0.98 of 2469 | subject+ptype=1-10 Blended Literacy/lesson c=1.00 n=32 | structure | — | CANDIDATE |
| 611 | activity | EXTRA | `div.col-12` | `—` | `a` | 98 | 74 | 0.71 of 2469 | template=Standard c=0.73 n=81 | structure | — | CANDIDATE |
| 612 | activity | SUBSTITUTED | `div.col-12.col-md-8` | `div.activity.interactive[number=*]` | `div.activity.interactive[number=*]` | 96 | 71 | 0.44 of 2469 | subject+ptype=1-10 Mathematics/lesson c=0.66 n=21 | structure | yes | CANDIDATE |
| 613 | activity | SUBSTITUTED | `div.col-12` | `WIDGET` | `p` | 85 | 70 | 0.59 of 2469 | subject+ptype=1-10 Mathematics/lesson c=0.77 n=31 | structure | — | CANDIDATE |
| 614 | activity | MOVED | `div.col-12` | `h3` | `h3` | 98 | 69 | 0.21 of 2469 | template+ptype=Bilingual/lesson c=0.75 n=21 | structure | — | CANDIDATE |
| 616 | activity | EXTRA | `a` | `—` | `div.button` | 89 | 68 | 0.77 of 2469 | ptype=overview c=0.86 n=20 | structure | yes | CANDIDATE |
| 623 | activity | EXTRA | `div.col-12.col-md-8` | `—` | `div.activity[number=*]` | 72 | 60 | 0.96 of 2469 | template=Standard c=0.98 n=57 | structure | yes | CANDIDATE |
| 624 | activity | SUBSTITUTED | `div.col-12` | `p` | `WIDGET` | 67 | 60 | 0.75 of 2469 | template+ptype=Standard/lesson c=0.88 n=51 | structure | — | CANDIDATE |
| 626 | activity | EXTRA | `div.col-12` | `—` | `h4.goJournal` | 132 | 56 | 0.95 of 2469 | series=HIS10 c=1.00 n=32 | structure | — | CANDIDATE |
| 627 | activity | SUBSTITUTED | `div.col-12` | `a` | `h4.goJournal` | 119 | 55 | 0.55 of 2469 | series=HIS10 c=0.83 n=20 | structure | — | CANDIDATE |
| 628 | activity | SUBSTITUTED | `div.col-12` | `a` | `p` | 76 | 55 | 0.55 of 2469 | subject+ptype=1-10 Mathematics/lesson c=0.80 n=20 | structure | — | CANDIDATE |
| 629 | activity | EXTRA | `ol` | `—` | `li` | 71 | 55 | 0.96 of 2469 | template=Standard c=0.97 n=54 | structure | — | CANDIDATE |
| 632 | activity | EXTRA | `div.col-12` | `—` | `p>i` | 57 | 51 | 0.98 of 2469 | template=Standard c=0.98 n=48 | structure | — | CANDIDATE |
| 639 | activity | SUBSTITUTED | `div.col-12` | `WIDGET` | `div.row` | 48 | 46 | 0.59 of 2469 | ptype=lesson c=0.68 n=37 | structure | — | CANDIDATE |
| 646 | activity | EXTRA | `p>i` | `—` | `i` | 50 | 42 | 0.89 of 2469 | template=Standard c=0.90 n=44 | structure | — | CANDIDATE |
| 656 | activity | EXTRA | `a` | `—` | `div.externalButton` | 49 | 38 | 0.92 of 2469 | template=Standard c=0.92 n=36 | structure | — | CANDIDATE |
| 663 | activity | EXTRA | `div.col-12` | `—` | `div.icon.ratio.ratio-16x9.videoSection` | 50 | 35 | 0.98 of 2469 | template=Standard c=0.98 n=42 | structure | yes | CANDIDATE |
| 664 | activity | EXTRA | `p` | `—` | `b` | 42 | 34 | 0.96 of 2469 | template=Standard c=0.96 n=37 | structure | — | CANDIDATE |
| 665 | activity | SUBSTITUTED | `div.col-12` | `a` | `WIDGET` | 40 | 34 | 0.55 of 2469 | template+ptype=Standard/lesson c=0.65 n=37 | structure | — | CANDIDATE |
| 667 | activity | EXTRA | `div.col-12.col-md-8` | `—` | `div.activity.interactive[number=*]` | 35 | 33 | 0.78 of 2469 | template=Standard c=0.82 n=27 | structure | yes | CANDIDATE |
| 668 | activity | EXTRA | `ul` | `—` | `li` | 34 | 33 | 0.93 of 2469 | template=Standard c=0.95 n=27 | structure | — | CANDIDATE |
| 670 | activity | EXTRA | `div.col-12` | `—` | `audio.audioPlayer.icon` | 52 | 32 | 1.00 of 2469 | template=Bilingual c=1.00 n=24 | structure | yes | CANDIDATE |
| 671 | activity | SUBSTITUTED | `div.col-12` | `h3` | `WIDGET` | 39 | 32 | 0.75 of 2469 | template+ptype=Standard/lesson c=0.89 n=27 | structure | — | CANDIDATE |
| 679 | activity | SUBSTITUTED | `div.row` | `div.col-12` | `WIDGET` | 30 | 29 | 0.78 of 2469 | ptype=lesson c=0.92 n=22 | structure | — | CANDIDATE |
| 683 | activity | SUBSTITUTED | `div.row` | `div.col-12` | `div.col-12.col-md-8` | 31 | 28 | 0.78 of 2469 | ptype=lesson c=0.92 n=23 | structure | — | CANDIDATE |
| 685 | activity | EXTRA | `div.col-12` | `—` | `div.ratio.ratio-16x9.videoSection` | 41 | 27 | 0.99 of 2469 | template=Standard c=0.99 n=29 | structure | yes | CANDIDATE |
| 691 | activity | SUBSTITUTED | `div.col-12` | `WIDGET` | `ol` | 27 | 25 | 0.59 of 2469 | ptype=lesson c=0.68 n=22 | structure | — | CANDIDATE |
| 694 | activity | EXTRA | `div.col-12` | `—` | `h5` | 28 | 24 | 0.99 of 2469 | template=Standard c=0.99 n=22 | structure | — | CANDIDATE |
| 695 | activity | EXTRA | `div.icon.ratio.ratio-16x9.videoSection` | `—` | `iframe` | 28 | 24 | 0.99 of 2469 | template=Standard c=0.99 n=21 | structure | yes | CANDIDATE |
| 697 | activity | SUBSTITUTED | `div.activity.interactive[number=*]` | `div.row` | `WIDGET` | 27 | 24 | 0.55 of 2469 | ptype=lesson c=0.63 n=22 | structure | yes | CANDIDATE |
| 715 | activity | SUBSTITUTED | `div.row` | `div.col-12` | `div.row` | 22 | 21 | 0.78 of 2469 | era=Refresh c=0.78 n=22 | structure | — | CANDIDATE |
| 729 | activity | EXTRA | `div.ratio.ratio-16x9.videoSection` | `—` | `iframe` | 24 | 19 | 0.97 of 2469 | template=Standard c=0.98 n=20 | structure | yes | CANDIDATE |
| 732 | activity | SUBSTITUTED | `div.row` | `div.col-12` | `div.button` | 21 | 19 | 0.78 of 2469 | era=Refresh c=0.78 n=21 | structure | yes | CANDIDATE |
| 736 | activity | EXTRA | `div.col-12` | `—` | `div.button` | 29 | 18 | 1.00 of 2469 | template=Standard c=1.00 n=25 | structure | yes | CANDIDATE |
| 737 | activity | EXTRA | `div.col-12` | `—` | `div.TKmodal` | 23 | 18 | 1.00 of 2469 | era=Refresh c=1.00 n=23 | structure | — | CANDIDATE |
| 741 | activity | SUBSTITUTED | `div.col-12` | `h3` | `h3` | 25 | 17 | 0.75 of 2469 | template+ptype=Standard/lesson c=0.89 n=20 | structure | — | CANDIDATE |
| 749 | activity | SUBSTITUTED | `div.col-12` | `p` | `p>b` | 22 | 16 | 0.75 of 2469 | era=Refresh c=0.75 n=22 | structure | — | CANDIDATE |
| 775 | activity | SUBSTITUTED | `div.col-12` | `p` | `h4.goJournal` | 22 | 13 | 0.75 of 2469 | template+ptype=Standard/lesson c=0.88 n=21 | structure | — | CANDIDATE |
| 849 | activity | MISSING | `div.col-12.col-md-8` | `div.activity.dropbox[number=*]` | `—` | 25 | 9 | 0.03 of 2469 | series=XDLS90 c=0.68 n=21 | 0.96 | yes | CANDIDATE |
| 1076 | activity | EXTRA | `div.activity.clickDropContent.dropbox[nu` | `—` | `a` | 23 | 4 | 1.00 of 2469 | era=Refresh c=1.00 n=23 | structure | yes | CANDIDATE |
| 1077 | activity | EXTRA | `div.activity.dropbox[number=*]` | `—` | `a` | 21 | 4 | 0.99 of 2469 | era=Refresh c=0.99 n=21 | structure | yes | CANDIDATE |
| 4011 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p` | 1104 | 416 | 0.82 of 2469 | subject+ptype=1-10 Blended Literacy/lesson c=0.99 n=26 | structure | — | CANDIDATE |
| 4012 | body | EXTRA | `div#body` | `—` | `div.row` | 1414 | 390 | 0.73 of 2469 | subject+ptype=1-10 Blended Literacy/overview c=1.00 n=30 | structure | — | CANDIDATE |
| 4013 | body | MISSING | `div#body` | `div.row` | `—` | 1389 | 352 | 0.34 of 2469 | series=CEDO50 c=0.76 n=20 | 0.86 | — | CANDIDATE |
| 4014 | body | MISSING | `div.col-12.col-md-8` | `p` | `—` | 606 | 292 | 0.26 of 2469 | template+ptype=Fundamentals/overview c=0.91 n=46 | 0.81 | — | CANDIDATE |
| 4015 | body | EXTRA | `div.col-12.col-md-8` | `—` | `img.img-fluid` | 565 | 257 | 0.96 of 2469 | template+ptype=Standard/overview c=1.00 n=26 | structure | — | CANDIDATE |
| 4016 | body | EXTRA | `div.col-12.col-md-8` | `—` | `WIDGET` | 402 | 245 | 0.93 of 2469 | subject+ptype=NCEA1/lesson c=0.99 n=50 | structure | — | CANDIDATE |
| 4017 | body | MOVED | `div.col-12.col-md-8` | `p` | `p` | 346 | 219 | 0.18 of 2469 | template+ptype=Fundamentals/overview c=0.84 n=43 | structure | — | CANDIDATE |
| 4018 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p>b` | 337 | 208 | 0.97 of 2469 | subject=1-10 Blended Literacy c=1.00 n=45 | structure | — | CANDIDATE |
| 4019 | body | EXTRA | `div.row` | `—` | `div.col-12.col-md-8` | 293 | 207 | 0.85 of 2469 | subject+ptype=1-10 Blended Literacy/lesson c=0.97 n=25 | structure | — | CANDIDATE |
| 4020 | body | SUBSTITUTED | `div.row` | `div.col-12` | `div.col-12.col-md-8` | 334 | 192 | 0.55 of 2469 | subject+ptype=1-10 Blended Literacy/overview c=0.96 n=67 | structure | — | CANDIDATE |
| 4021 | body | EXTRA | `div.col-12.col-md-8` | `—` | `h3` | 302 | 188 | 0.89 of 2469 | subject+ptype=1-10 Blended Literacy/overview c=1.00 n=20 | structure | — | CANDIDATE |
| 4022 | body | EXTRA | `div.col-12.col-md-8` | `—` | `ul` | 298 | 183 | 0.95 of 2469 | subject=1-10 Mathematics c=0.98 n=21 | structure | — | CANDIDATE |
| 4024 | body | MISSING | `div.col-12.col-md-8` | `WIDGET` | `—` | 272 | 177 | 0.20 of 2469 | template+ptype=Fundamentals/overview c=0.65 n=32 | structure | — | CANDIDATE |
| 4025 | body | MISSING | `div.row` | `div.col-12.col-md-8` | `—` | 318 | 175 | 0.29 of 2469 | template=Fundamentals c=0.78 n=22 | 0.94 | — | CANDIDATE |
| 4027 | body | EXTRA | `div.col-12.col-md-8` | `—` | `a` | 239 | 161 | 0.98 of 2469 | subject+ptype=ConnectED/lesson c=1.00 n=27 | structure | — | CANDIDATE |
| 4028 | body | MISSING | `div.col-12.col-md-8` | `h3` | `—` | 240 | 152 | 0.18 of 2469 | template+ptype=Fundamentals/overview c=0.75 n=21 | 0.90 | — | CANDIDATE |
| 4031 | body | EXTRA | `p>b` | `—` | `b` | 194 | 127 | 0.94 of 2469 | subject=1-10 Mathematics c=0.97 n=35 | structure | — | CANDIDATE |
| 4033 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p>a` | 176 | 119 | 0.99 of 2469 | subject=1-10 English c=1.00 n=20 | structure | — | CANDIDATE |
| 4034 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.ratio.ratio-16x9.videoSection` | 185 | 118 | 0.93 of 2469 | subject=NCEA1 c=0.98 n=21 | structure | yes | CANDIDATE |
| 4035 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.table-responsive` | 169 | 118 | 0.98 of 2469 | subject+ptype=1-10 English/lesson c=0.99 n=21 | structure | — | CANDIDATE |
| 4038 | body | EXTRA | `a` | `—` | `div.button` | 181 | 110 | 0.97 of 2469 | subject=NCEA1 c=0.98 n=38 | structure | — | CANDIDATE |
| 4046 | body | EXTRA | `p` | `—` | `b` | 121 | 95 | 0.93 of 2469 | subject=NCEA1 c=0.96 n=29 | structure | — | CANDIDATE |
| 4047 | body | EXTRA | `div.table-responsive` | `—` | `table.table.table-bordered` | 140 | 94 | 0.96 of 2469 | subject=NCEA1 c=0.97 n=28 | structure | yes | CANDIDATE |
| 4050 | body | EXTRA | `div.col-12.col-md-8` | `—` | `ol` | 111 | 85 | 0.99 of 2469 | template=Standard c=0.99 n=87 | structure | — | CANDIDATE |
| 4052 | body | EXTRA | `p>i` | `—` | `i` | 109 | 82 | 0.97 of 2469 | subject+ptype=1-10 Blended Literacy/overview c=1.00 n=26 | structure | — | CANDIDATE |
| 4053 | body | SUBSTITUTED | `div.icon.ratio.ratio-16x9.videoSection` | `iframe.embed-responsive-item` | `iframe` | 212 | 81 | 0.19 of 2469 | series=PES10 c=0.68 n=36 | structure | yes | CANDIDATE |
| 4055 | body | EXTRA | `div.col-12.col-md-8` | `—` | `audio.audioPlayer.icon` | 130 | 76 | 1.00 of 2469 | ptype=overview c=1.00 n=36 | structure | yes | CANDIDATE |
| 4056 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p>i` | 105 | 76 | 0.98 of 2469 | subject=NCEA1 c=0.99 n=26 | structure | — | CANDIDATE |
| 4057 | body | EXTRA | `p>a` | `—` | `a` | 101 | 76 | 0.99 of 2469 | template=Standard c=1.00 n=77 | structure | — | CANDIDATE |
| 4059 | body | SUBSTITUTED | `div#body` | `div.row` | `WIDGET` | 123 | 75 | 0.94 of 2469 | subject=Online Safety (OS9000) c=1.00 n=27 | structure | — | CANDIDATE |
| 4060 | body | EXTRA | `div.row` | `—` | `div.col-12` | 136 | 74 | 0.71 of 2469 | subject=ANZH c=0.74 n=21 | structure | — | CANDIDATE |
| 4064 | body | MOVED | `div.col-12.col-md-8` | `h3` | `h3` | 84 | 71 | 0.11 of 2469 | template+ptype=Fundamentals/overview c=0.67 n=24 | structure | — | CANDIDATE |
| 4067 | body | EXTRA | `div.fundamentalsPanel` | `—` | `div.row` | 74 | 69 | 0.98 of 2469 | era=Refresh c=0.98 n=74 | structure | — | CANDIDATE |
| 4071 | body | EXTRA | `table.table.table-bordered` | `—` | `tr` | 95 | 67 | 0.98 of 2469 | template=Standard c=0.98 n=81 | structure | yes | CANDIDATE |
| 4076 | body | EXTRA | `a` | `—` | `div.externalButton` | 91 | 66 | 0.92 of 2469 | template=Standard c=0.93 n=78 | structure | — | CANDIDATE |
| 4078 | body | EXTRA | `div.col-12.col-md-8` | `—` | `h4` | 74 | 64 | 0.97 of 2469 | template=Standard c=0.98 n=35 | structure | — | CANDIDATE |
| 4081 | body | EXTRA | `div.col-12` | `—` | `p` | 99 | 63 | 0.92 of 2469 | template=Standard c=0.94 n=82 | structure | — | CANDIDATE |
| 4084 | body | EXTRA | `ul` | `—` | `li` | 70 | 60 | 0.95 of 2469 | template=Standard c=0.96 n=49 | structure | — | CANDIDATE |
| 4085 | body | EXTRA | `div.ratio.ratio-16x9.videoSection` | `—` | `iframe` | 73 | 58 | 0.92 of 2469 | template=Standard c=0.93 n=56 | structure | yes | CANDIDATE |
| 4086 | body | SUBSTITUTED | `div.row` | `div.col-12.col-md-8` | `div.col-12.col-md-8` | 67 | 58 | 0.98 of 2469 | ptype=lesson c=0.99 n=41 | structure | — | CANDIDATE |
| 4088 | body | EXTRA | `div.alert` | `—` | `div.row` | 69 | 55 | 0.91 of 2469 | template=Standard c=0.92 n=50 | structure | — | CANDIDATE |
| 4090 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `p` | 70 | 54 | 0.84 of 2469 | era=Refresh c=0.84 n=70 | structure | — | CANDIDATE |
| 4092 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `div.activity[number=*]` | 59 | 52 | 0.84 of 2469 | era=Refresh c=0.84 n=59 | structure | yes | CANDIDATE |
| 4093 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.alert` | 66 | 51 | 0.90 of 2469 | template=Standard c=0.91 n=50 | structure | — | CANDIDATE |
| 4097 | body | EXTRA | `tr` | `—` | `td` | 56 | 49 | 0.94 of 2469 | template=Standard c=0.95 n=50 | structure | — | CANDIDATE |
| 4101 | body | EXTRA | `div.inquiryPanel` | `—` | `div.row` | 49 | 48 | 0.99 of 2469 | era=Refresh c=0.99 n=49 | structure | — | CANDIDATE |
| 4102 | body | EXTRA | `div.row` | `—` | `div.col-12.col-md-6` | 71 | 47 | 0.99 of 2469 | subject=Online Safety (OS9000) c=1.00 n=26 | structure | — | CANDIDATE |
| 4106 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.icon.ratio.ratio-16x9.videoSection` | 63 | 45 | 0.92 of 2469 | template=Standard c=0.93 n=55 | structure | yes | CANDIDATE |
| 4111 | body | SUBSTITUTED | `div.row` | `div.col-12.col-md-8` | `WIDGET` | 46 | 43 | 0.98 of 2469 | ptype=lesson c=0.99 n=38 | structure | — | CANDIDATE |
| 4114 | body | EXTRA | `div#body` | `—` | `WIDGET` | 76 | 42 | 0.93 of 2469 | era=Refresh c=0.93 n=76 | structure | — | CANDIDATE |
| 4117 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `WIDGET` | 41 | 40 | 0.84 of 2469 | era=Refresh c=0.84 n=41 | structure | — | CANDIDATE |
| 4120 | body | MISSING | `div#body` | `div.fundamentalsPanel` | `—` | 45 | 39 | 0.02 of 2469 | template+ptype=Fundamentals/overview c=0.60 n=38 | 0.98 | yes | CANDIDATE |
| 4121 | body | EXTRA | `div.alert.solid` | `—` | `div.row` | 50 | 38 | 0.99 of 2469 | template=Standard c=0.99 n=42 | structure | yes | CANDIDATE |
| 4125 | body | EXTRA | `p` | `—` | `i` | 43 | 37 | 0.96 of 2469 | template=Standard c=0.97 n=39 | structure | — | CANDIDATE |
| 4126 | body | EXTRA | `div#body` | `—` | `div.row.supervisor` | 46 | 36 | 0.90 of 2469 | ptype=lesson c=0.91 n=39 | structure | yes | CANDIDATE |
| 4127 | body | EXTRA | `div.col-12.col-md-8` | `—` | `h5` | 43 | 36 | 0.99 of 2469 | subject=NCEA1 c=0.99 n=20 | structure | — | CANDIDATE |
| 4129 | body | MISSING | `div#body` | `div.inquiryPanel` | `—` | 39 | 36 | 0.02 of 2469 | template+ptype=Inquiry/overview c=0.62 n=34 | 0.92 | — | CANDIDATE |
| 4130 | body | EXTRA | `tr` | `—` | `th` | 38 | 35 | 0.99 of 2469 | template=Standard c=1.00 n=33 | structure | — | CANDIDATE |
| 4131 | body | EXTRA | `div.row` | `—` | `div.col-12.col-md-4.offset-md-0` | 34 | 34 | 0.80 of 2469 | template=Standard c=0.81 n=21 | structure | — | CANDIDATE |
| 4134 | body | EXTRA | `div.col-12.col-md-8` | `—` | `p>span.infoTrigger` | 37 | 33 | 0.87 of 2469 | template=Standard c=0.87 n=31 | structure | — | CANDIDATE |
| 4143 | body | EXTRA | `div.col-12.col-md-8` | `—` | `h4.goJournal` | 39 | 31 | 1.00 of 2469 | template=Standard c=1.00 n=38 | structure | — | CANDIDATE |
| 4145 | body | EXTRA | `div#body` | `—` | `div.fundamentalsPanel` | 38 | 31 | 0.98 of 2469 | era=Refresh c=0.98 n=38 | structure | yes | CANDIDATE |
| 4148 | body | SUBSTITUTED | `div.row` | `div.col-12.col-md-8` | `div.row` | 32 | 31 | 0.98 of 2469 | era=Refresh c=0.98 n=32 | structure | — | CANDIDATE |
| 4149 | body | EXTRA | `div#body` | `—` | `div.inquiryPanel` | 31 | 31 | 0.98 of 2469 | era=Refresh c=0.98 n=31 | structure | — | CANDIDATE |
| 4150 | body | EXTRA | `div.icon.ratio.ratio-16x9.videoSection` | `—` | `iframe` | 36 | 30 | 0.97 of 2469 | template=Standard c=0.98 n=31 | structure | yes | CANDIDATE |
| 4152 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.flipCardsContainer.row` | 34 | 30 | 0.93 of 2469 | template=Standard c=0.94 n=28 | structure | — | CANDIDATE |
| 4155 | body | EXTRA | `div.introduction` | `—` | `div.row` | 30 | 30 | 0.99 of 2469 | era=Refresh c=0.99 n=30 | structure | — | CANDIDATE |
| 4162 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.clickDropContent` | 32 | 27 | 0.94 of 2469 | template=Standard c=0.94 n=29 | structure | — | CANDIDATE |
| 4163 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `img.img-fluid` | 28 | 27 | 0.84 of 2469 | era=Refresh c=0.84 n=28 | structure | — | CANDIDATE |
| 4165 | body | EXTRA | `div.row` | `—` | `div.col-12.col-md-4` | 33 | 26 | 0.94 of 2469 | template=Standard c=0.95 n=26 | structure | — | CANDIDATE |
| 4166 | body | SUBSTITUTED | `div.row` | `div.col-12.col-md-8` | `div.col-12.col-md-6` | 33 | 26 | 0.98 of 2469 | ptype=lesson c=0.99 n=29 | structure | — | CANDIDATE |
| 4169 | body | EXTRA | `div.inquiryPanel.showing` | `—` | `div.row` | 28 | 26 | 0.99 of 2469 | era=Refresh c=0.99 n=28 | structure | yes | CANDIDATE |
| 4172 | body | EXTRA | `div.col-12.col-md-8` | `—` | `div.alert.solid` | 31 | 25 | 0.99 of 2469 | template=Standard c=0.99 n=25 | structure | yes | CANDIDATE |
| 4184 | body | EXTRA | `p>span.infoTrigger` | `—` | `span.infoTrigger` | 24 | 22 | 0.95 of 2469 | era=Refresh c=0.95 n=24 | structure | — | CANDIDATE |
| 4185 | body | EXTRA | `div.col-12.col-md-8` | `—` | `h2` | 23 | 22 | 0.98 of 2469 | era=Refresh c=0.98 n=23 | structure | — | CANDIDATE |
| 4186 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `h3` | 23 | 22 | 0.84 of 2469 | era=Refresh c=0.84 n=23 | structure | — | CANDIDATE |
| 4189 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `div.alert` | 29 | 21 | 0.84 of 2469 | era=Refresh c=0.84 n=29 | structure | — | CANDIDATE |
| 4197 | body | SUBSTITUTED | `div.col-12.col-md-8` | `p` | `div.activity.interactive[number=*]` | 23 | 21 | 0.84 of 2469 | era=Refresh c=0.84 n=23 | structure | yes | CANDIDATE |
| 4198 | body | SUBSTITUTED | `div.row` | `div.col-12.col-md-8` | `p` | 22 | 21 | 0.98 of 2469 | era=Refresh c=0.98 n=22 | structure | — | CANDIDATE |
| 4212 | body | EXTRA | `div.col-12.col-md-6` | `—` | `img.img-fluid` | 23 | 19 | 0.99 of 2469 | era=Refresh c=0.99 n=23 | structure | — | CANDIDATE |
| 4217 | body | EXTRA | `div.flipCardsContainer.row` | `—` | `div.col-12.col-md-4.paddingLR` | 20 | 19 | 0.97 of 2469 | era=Refresh c=0.97 n=20 | structure | — | CANDIDATE |
| 4229 | body | SUBSTITUTED | `div#body` | `div.row` | `div.table-responsive` | 23 | 17 | 0.94 of 2469 | ptype=lesson c=0.98 n=21 | structure | — | CANDIDATE |
| 4262 | body | EXTRA | `div.col-12.col-md-6` | `—` | `p` | 23 | 14 | 1.00 of 2469 | ptype=lesson c=1.00 n=21 | structure | — | CANDIDATE |
| 4338 | body | SUBSTITUTED | `div.row` | `div.col-12.col-md-8` | `div.button` | 23 | 10 | 0.98 of 2469 | ptype=lesson c=0.99 n=22 | structure | — | CANDIDATE |
| 9240 | root | EXTRA | `body.container-fluid` | `—` | `div.row` | 273 | 273 | 0.88 of 2476 | subject+ptype=1-10 Mathematics/overview c=0.97 n=33 | structure | — | CANDIDATE |
| 9244 | root | SUBSTITUTED | `#root` | `body` | `body.container-fluid` | 138 | 15 | 0.06 of 2476 | series=PWY10 c=1.00 n=44 | structure | yes | CANDIDATE |
