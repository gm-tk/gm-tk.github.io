#!/usr/bin/env python3
"""Session 27 Round 6 (r401 variant: reads the probe ON pages) — CLAUDE'S NOTE-ONLY ACTIVITY BOXES: every Claude top-level activity box whose whole content is red notes
...
for code in sorted(fam):
    ...
    for n, cp, hp in pairs(code):
        onp = os.path.join(OUTPUTS, "_s27_r401_on", code, os.path.basename(cp)); cp = onp if os.path.exists(onp) else cp
